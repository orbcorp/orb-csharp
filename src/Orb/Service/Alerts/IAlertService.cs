...
public interface IAlertService
{
    ...
    /// the current billing cycle surpasses predefined thresholds. `cost_exceeded`
    /// alerts do not include burndown of pre-purchase credits. Each subscription can
    /// have one `cost_exceeded` alert and one `usage_exceeded` alert per metric that
