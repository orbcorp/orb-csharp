...
public interface IBalanceTransactionService
{
    ...
    /// </summary>
    Tasks::Task<BalanceTransactions::BalanceTransactionCreateResponse> Create(
    ...
    /// webapp on the customer details page. You can use this balance to provide a
    /// fixed mid-period credit to the customer. Commonly, this is done due to system
    /// downtime/SLA violation, or an adhoc adjustment discussed with the customer.
    ///
    /// If the balance is a positive value at the time of invoicing, it represents that
    /// the customer has credit that should be used to offset the amount due on the
    ...
    /// </summary>
    Tasks::Task<BalanceTransactions::BalanceTransactionListPageResponse> List(
