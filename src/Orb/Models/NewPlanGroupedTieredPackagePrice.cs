        ...
        IFromRaw<NewPlanGroupedTieredPackagePrice>
{
    ...
    public required NewPlanGroupedTieredPackagePriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewPlanGroupedTieredPackagePriceProperties::Cadence>(
                    element,
    ...
    public required NewPlanGroupedTieredPackagePriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewPlanGroupedTieredPackagePriceProperties::ModelType>(
                    element,
                    ModelBase.SerializerOptions
    ...
    public NewPlanGroupedTieredPackagePriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewPlanGroupedTieredPackagePriceProperties::ConversionRateConfig?>(
                element,
                ModelBase.SerializerOptions
            );
        }
