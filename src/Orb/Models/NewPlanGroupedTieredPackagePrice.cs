...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<NewPlanGroupedTieredPackagePrice>))]
public sealed record class NewPlanGroupedTieredPackagePrice
    : Orb::ModelBase,
        Orb::IFromRaw<NewPlanGroupedTieredPackagePrice>
{
    /// <summary>
    /// The cadence to bill for this price on.
    /// </summary>
    public required NewPlanGroupedTieredPackagePriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewPlanGroupedTieredPackagePriceProperties::Cadence>(
                    element
    ...
    public required NewPlanGroupedTieredPackagePriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewPlanGroupedTieredPackagePriceProperties::ModelType>(
                    element
    ...
    /// </summary>
    public NewPlanGroupedTieredPackagePriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<NewPlanGroupedTieredPackagePriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
...
#pragma warning disable CS8618
    ...
    NewPlanGroupedTieredPackagePrice(Generic::Dictionary<string, Json::JsonElement> properties)
    {
