        ...
        IFromRaw<NewFloatingTieredWithMinimumPrice>
{
    ...
    public NewFloatingTieredWithMinimumPrice(IReadOnlyDictionary<string, JsonElement> properties)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    NewFloatingTieredWithMinimumPrice(FrozenDictionary<string, JsonElement> properties)
    {
        this._properties = [.. properties];
    }
...
public sealed record class TieredWithMinimumConfig : ModelBase, IFromRaw<TieredWithMinimumConfig>
{
    ...
    public required List<Tier6> Tiers
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<List<Tier6>>(element, ModelBase.SerializerOptions)
                ?? throw new OrbInvalidDataException(
                    "'tiers' cannot be null",
...
#pragma warning restore CS8618
    ...
    public static Tier6 FromRawUnchecked(IReadOnlyDictionary<string, JsonElement> properties)
    {
        return new(FrozenDictionary.ToFrozenDictionary(properties));
    }
}
