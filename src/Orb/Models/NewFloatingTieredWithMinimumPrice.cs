...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<NewFloatingTieredWithMinimumPrice>))]
public sealed record class NewFloatingTieredWithMinimumPrice
    : Orb::ModelBase,
        Orb::IFromRaw<NewFloatingTieredWithMinimumPrice>
{
    /// <summary>
    /// The cadence to bill for this price on.
    /// </summary>
    public required NewFloatingTieredWithMinimumPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewFloatingTieredWithMinimumPriceProperties::Cadence>(
                    element
    ...
    public required NewFloatingTieredWithMinimumPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewFloatingTieredWithMinimumPriceProperties::ModelType>(
                    element
    ...
    /// </summary>
    public NewFloatingTieredWithMinimumPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<NewFloatingTieredWithMinimumPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
...
#pragma warning disable CS8618
    ...
    NewFloatingTieredWithMinimumPrice(Generic::Dictionary<string, Json::JsonElement> properties)
    {
