        ...
        IFromRaw<NewFloatingTieredWithMinimumPrice>
{
    ...
    public required NewFloatingTieredWithMinimumPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewFloatingTieredWithMinimumPriceProperties::Cadence>(
                    element,
    ...
    public required NewFloatingTieredWithMinimumPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewFloatingTieredWithMinimumPriceProperties::ModelType>(
                    element,
                    ModelBase.SerializerOptions
    ...
    public NewFloatingTieredWithMinimumPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewFloatingTieredWithMinimumPriceProperties::ConversionRateConfig?>(
                element,
                ModelBase.SerializerOptions
            );
        }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    NewFloatingTieredWithMinimumPrice(Dictionary<string, JsonElement> properties)
    {
