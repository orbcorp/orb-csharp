...
public sealed record class NewPlanUnitPrice : ModelBase, IFromRaw<NewPlanUnitPrice>
{
    ...
    public required NewPlanUnitPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewPlanUnitPriceProperties::Cadence>(element)
    ...
    public required NewPlanUnitPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewPlanUnitPriceProperties::ModelType>(element)
    ...
    public NewPlanUnitPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewPlanUnitPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
