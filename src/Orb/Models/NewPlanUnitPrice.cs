...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<NewPlanUnitPrice>))]
public sealed record class NewPlanUnitPrice : Orb::ModelBase, Orb::IFromRaw<NewPlanUnitPrice>
{
    /// <summary>
    /// The cadence to bill for this price on.
    /// </summary>
    public required NewPlanUnitPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewPlanUnitPriceProperties::Cadence>(element)
    ...
    public required NewPlanUnitPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewPlanUnitPriceProperties::ModelType>(element)
    ...
    public required UnitConfig UnitConfig
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<UnitConfig>(element)
    ...
    /// </summary>
    public NewPlanUnitPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<NewPlanUnitPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
...
#pragma warning disable CS8618
    ...
    NewPlanUnitPrice(Generic::Dictionary<string, Json::JsonElement> properties)
    {
