...
/// </summary>
public record class TopUpListByExternalIDParams : ParamsBase
{
...
#pragma warning restore CS8618
    ...
    public static TopUpListByExternalIDParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(TopUpListByExternalIDParams? other)
    {
        if (other == null)
        {
            return false;
