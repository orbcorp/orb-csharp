...
using DataProperties = Orb.Models.Customers.Credits.TopUps.TopUpListByExternalIDPageResponseProperties.DataProperties;
...
namespace Orb.Models.Customers.Credits.TopUps.TopUpListByExternalIDPageResponseProperties;
...
public sealed record class Data : Orb::ModelBase, Orb::IFromRaw<Data>
{
    ...
    /// </summary>
    public required TopUps::TopUpInvoiceSettings InvoiceSettings
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<TopUps::TopUpInvoiceSettings>(element)
    ...
    /// </summary>
    public DataProperties::ExpiresAfterUnit? ExpiresAfterUnit
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<DataProperties::ExpiresAfterUnit?>(element);
        }
        set
        {
