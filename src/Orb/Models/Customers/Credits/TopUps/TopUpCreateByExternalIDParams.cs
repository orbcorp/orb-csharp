...
public sealed record class TopUpCreateByExternalIDParams : ParamsBase
{
    ...
    public required TopUpCreateByExternalIDParamsProperties::InvoiceSettings InvoiceSettings
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<TopUpCreateByExternalIDParamsProperties::InvoiceSettings>(
                    element,
    ...
    public TopUpCreateByExternalIDParamsProperties::ExpiresAfterUnit? ExpiresAfterUnit
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<TopUpCreateByExternalIDParamsProperties::ExpiresAfterUnit?>(
                element,
                ModelBase.SerializerOptions
            );
        }
