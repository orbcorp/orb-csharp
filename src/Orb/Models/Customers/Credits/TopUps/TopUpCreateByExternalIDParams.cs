...
/// Settings for invoices generated by triggered top-ups.
/// </summary>
[JsonConverter(typeof(ModelConverter<InvoiceSettingsModel, InvoiceSettingsModelFromRaw>))]
public sealed record class InvoiceSettingsModel : ModelBase
{
    /// <summary>
...
class InvoiceSettingsModelFromRaw : IFromRaw<InvoiceSettingsModel>
{
    public InvoiceSettingsModel FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => InvoiceSettingsModel.FromRawUnchecked(rawData);
}
