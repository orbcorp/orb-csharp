...
{
    public required List<global::Orb.Models.Customers.Credits.Ledger.Data> Data
    {
        get
        {
    ...
    public LedgerListPageResponse(IReadOnlyDictionary<string, JsonElement> properties)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    LedgerListPageResponse(FrozenDictionary<string, JsonElement> properties)
    {
        this._properties = [.. properties];
    }
...
public record class Data
{
    ...
    public static global::Orb.Models.Customers.Credits.Ledger.Data CreateUnknownVariant(
        JsonElement value
    )
    {
    ...
    public static implicit operator global::Orb.Models.Customers.Credits.Ledger.Data(
        IncrementLedgerEntry value
    ) => new(value);
...
{
    public override global::Orb.Models.Customers.Credits.Ledger.Data? Read(
            ...
            case "increment":
            {
                ...
                try
                {
                    ...
                    if (deserialized != null)
                    {
                        ...
                        return new global::Orb.Models.Customers.Credits.Ledger.Data(deserialized);
                    }
                }
    ...
    public override void Write(
        ...
        global::Orb.Models.Customers.Credits.Ledger.Data value,
        JsonSerializerOptions options
    )
    {
