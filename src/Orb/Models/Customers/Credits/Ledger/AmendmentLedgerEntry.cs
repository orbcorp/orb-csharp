...
public sealed record class AmendmentLedgerEntry : ModelBase, IFromRaw<AmendmentLedgerEntry>
{
    ...
    public required AmendmentLedgerEntryProperties::EntryStatus EntryStatus
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<AmendmentLedgerEntryProperties::EntryStatus>(element)
    ...
    public required AmendmentLedgerEntryProperties::EntryType EntryType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<AmendmentLedgerEntryProperties::EntryType>(element)
