...
public sealed record class AmendmentLedgerEntry : JsonModel
{
    ...
    public required ApiEnum<string, AmendmentLedgerEntryEntryStatus> EntryStatus
    {
        get
        {
            return JsonModel.GetNotNullClass<ApiEnum<string, AmendmentLedgerEntryEntryStatus>>(
                this.RawData,
                "entry_status"
            );
        }
    ...
    public required ApiEnum<string, AmendmentLedgerEntryEntryType> EntryType
    {
        get
        {
            return JsonModel.GetNotNullClass<ApiEnum<string, AmendmentLedgerEntryEntryType>>(
                this.RawData,
                "entry_type"
            );
        }
