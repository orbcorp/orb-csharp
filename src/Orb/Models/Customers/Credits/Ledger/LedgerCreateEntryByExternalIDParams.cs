...
/// </summary>
public sealed record class LedgerCreateEntryByExternalIDParams : Orb::ParamsBase
{
    ...
    public required LedgerCreateEntryByExternalIDParamsProperties::Body Body
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<LedgerCreateEntryByExternalIDParamsProperties::Body>(
                    element
