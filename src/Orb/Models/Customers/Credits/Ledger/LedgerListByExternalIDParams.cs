...
/// of credits.
/// </summary>
public sealed record class LedgerListByExternalIDParams : Orb::ParamsBase
{
    ...
    public LedgerListByExternalIDParamsProperties::EntryStatus? EntryStatus
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<LedgerListByExternalIDParamsProperties::EntryStatus?>(
                element
            );
        }
        set
    ...
    public LedgerListByExternalIDParamsProperties::EntryType? EntryType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<LedgerListByExternalIDParamsProperties::EntryType?>(
                element
            );
        }
