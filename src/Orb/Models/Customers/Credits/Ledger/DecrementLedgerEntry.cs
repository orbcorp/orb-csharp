...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<DecrementLedgerEntry>))]
public sealed record class DecrementLedgerEntry
    : Orb::ModelBase,
        Orb::IFromRaw<DecrementLedgerEntry>
{
    ...
    public required DecrementLedgerEntryProperties::EntryStatus EntryStatus
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<DecrementLedgerEntryProperties::EntryStatus>(
                    element
    ...
    public required DecrementLedgerEntryProperties::EntryType EntryType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<DecrementLedgerEntryProperties::EntryType>(
                    element
    ...
    public string? EventID
    {
        get
        {
            if (!this.Properties.TryGetValue("event_id", out Json::JsonElement element))
                return null;

            return Json::JsonSerializer.Deserialize<string?>(element);
        }
        set { this.Properties["event_id"] = Json::JsonSerializer.SerializeToElement(value); }
    }
...
#pragma warning disable CS8618
    ...
    DecrementLedgerEntry(Generic::Dictionary<string, Json::JsonElement> properties)
    {
