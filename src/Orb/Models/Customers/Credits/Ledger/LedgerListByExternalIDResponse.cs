...
public record class LedgerListByExternalIDResponse
{
    ...
    public LedgerListByExternalIDResponse(IncrementLedgerEntry value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public LedgerListByExternalIDResponse(DecrementLedgerEntry value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public LedgerListByExternalIDResponse(
    ...
    public LedgerListByExternalIDResponse(VoidLedgerEntry value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }
    ...
    public LedgerListByExternalIDResponse(AmendmentLedgerEntry value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public LedgerListByExternalIDResponse(JsonElement element)
    {
        this._element = element;
    }
        ...
        switch (this.Value)
        {
            ...
            default:
                throw new OrbInvalidDataException(
                    "Data did not match any variant of LedgerListByExternalIDResponse"
                );
        }
    }
    ...
    public static implicit operator LedgerListByExternalIDResponse(IncrementLedgerEntry value) =>
        new(value);

    public static implicit operator LedgerListByExternalIDResponse(DecrementLedgerEntry value) =>
        new(value);

    public static implicit operator LedgerListByExternalIDResponse(
        ExpirationChangeLedgerEntry value
    ) => new(value);
    ...
    public static implicit operator LedgerListByExternalIDResponse(VoidLedgerEntry value) =>
        new(value);
    ...
    public static implicit operator LedgerListByExternalIDResponse(AmendmentLedgerEntry value) =>
        new(value);
...
{
    public override LedgerListByExternalIDResponse? Read(
    ...
    )
    {
        ...
        switch (entryType)
        {
            ...
            default:
            {
                return new LedgerListByExternalIDResponse(element);
            }
        }
    }
    ...
    public override void Write(
        ...
        LedgerListByExternalIDResponse value,
        JsonSerializerOptions options
    )
    {
