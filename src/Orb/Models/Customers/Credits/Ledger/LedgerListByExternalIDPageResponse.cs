...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<LedgerListByExternalIDPageResponse>))]
public sealed record class LedgerListByExternalIDPageResponse
    : Orb::ModelBase,
        Orb::IFromRaw<LedgerListByExternalIDPageResponse>
{
    public required Generic::List<LedgerListByExternalIDPageResponseProperties::Data> Data
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<Generic::List<LedgerListByExternalIDPageResponseProperties::Data>>(
                    element
...
#pragma warning disable CS8618
    ...
    LedgerListByExternalIDPageResponse(Generic::Dictionary<string, Json::JsonElement> properties)
    {
