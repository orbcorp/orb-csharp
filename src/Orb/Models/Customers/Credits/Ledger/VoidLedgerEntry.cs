...
public sealed record class VoidLedgerEntry : ModelBase, IFromRaw<VoidLedgerEntry>
{
    ...
    public required VoidLedgerEntryProperties::EntryStatus EntryStatus
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<VoidLedgerEntryProperties::EntryStatus>(element)
    ...
    public required VoidLedgerEntryProperties::EntryType EntryType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<VoidLedgerEntryProperties::EntryType>(element)
