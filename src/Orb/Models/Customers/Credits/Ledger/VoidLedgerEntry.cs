...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<VoidLedgerEntry>))]
public sealed record class VoidLedgerEntry : Orb::ModelBase, Orb::IFromRaw<VoidLedgerEntry>
{
    ...
    public required VoidLedgerEntryProperties::EntryStatus EntryStatus
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<VoidLedgerEntryProperties::EntryStatus>(element)
    ...
    public required VoidLedgerEntryProperties::EntryType EntryType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<VoidLedgerEntryProperties::EntryType>(element)
...
#pragma warning disable CS8618
    ...
    VoidLedgerEntry(Generic::Dictionary<string, Json::JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static VoidLedgerEntry FromRawUnchecked(
