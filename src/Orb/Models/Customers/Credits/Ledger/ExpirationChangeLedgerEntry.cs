...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<ExpirationChangeLedgerEntry>))]
public sealed record class ExpirationChangeLedgerEntry
    : Orb::ModelBase,
        Orb::IFromRaw<ExpirationChangeLedgerEntry>
{
    ...
    public required ExpirationChangeLedgerEntryProperties::EntryStatus EntryStatus
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<ExpirationChangeLedgerEntryProperties::EntryStatus>(
                    element
    ...
    public required ExpirationChangeLedgerEntryProperties::EntryType EntryType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<ExpirationChangeLedgerEntryProperties::EntryType>(
                    element
...
#pragma warning disable CS8618
    ...
    ExpirationChangeLedgerEntry(Generic::Dictionary<string, Json::JsonElement> properties)
    {
