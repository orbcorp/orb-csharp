...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<CustomerListPageResponse>))]
public sealed record class CustomerListPageResponse
    : Orb::ModelBase,
        Orb::IFromRaw<CustomerListPageResponse>
{
    public required Generic::List<Customer> Data
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<Generic::List<Customer>>(element)
...
#pragma warning disable CS8618
    ...
    CustomerListPageResponse(Generic::Dictionary<string, Json::JsonElement> properties)
    {
