...
public record class CustomerUpdateParams : ParamsBase
{
    ...
    public CustomerUpdateParamsPaymentConfiguration? PaymentConfiguration
    {
        ...
        {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNullableClass<CustomerUpdateParamsPaymentConfiguration>(
    ...
    public CustomerUpdateParamsTaxConfiguration? TaxConfiguration
    {
        ...
        {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNullableClass<CustomerUpdateParamsTaxConfiguration>(
                "tax_configuration"
            );
        }
    ...
    public IReadOnlyList<CustomerUpdateParamsPaymentConfigurationPaymentProvider>? PaymentProviders
    {
        get
        {
            ...
            return this._rawData.GetNullableStruct<
                ImmutableArray<CustomerUpdateParamsPaymentConfigurationPaymentProvider>
            >("payment_providers");
        }
        init
        {
            ...
            this._rawData.Set<ImmutableArray<CustomerUpdateParamsPaymentConfigurationPaymentProvider>?>(
                "payment_providers",
                value == null ? null : ImmutableArray.ToImmutableArray(value)
            );
        }
