...
public sealed record class NewPlanTieredPrice : JsonModel
{
    ...
    public required ApiEnum<string, NewPlanTieredPriceCadence> Cadence
    {
        get
        {
            return JsonModel.GetNotNullClass<ApiEnum<string, NewPlanTieredPriceCadence>>(
                this.RawData,
                "cadence"
            );
        }
    ...
    public required ApiEnum<string, NewPlanTieredPriceModelType> ModelType
    {
        get
        {
            return JsonModel.GetNotNullClass<ApiEnum<string, NewPlanTieredPriceModelType>>(
                this.RawData,
                "model_type"
            );
        }
    ...
    public NewPlanTieredPriceConversionRateConfig? ConversionRateConfig
    {
        get
        {
            return JsonModel.GetNullableClass<NewPlanTieredPriceConversionRateConfig>(
                this.RawData,
