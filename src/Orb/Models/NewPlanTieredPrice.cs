...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<NewPlanTieredPrice>))]
public sealed record class NewPlanTieredPrice : Orb::ModelBase, Orb::IFromRaw<NewPlanTieredPrice>
{
    /// <summary>
    ...
    public required NewPlanTieredPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewPlanTieredPriceProperties::Cadence>(element)
    ...
    public required NewPlanTieredPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewPlanTieredPriceProperties::ModelType>(
                    element
    ...
    public NewPlanTieredPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewPlanTieredPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
...
#pragma warning disable CS8618
    ...
    NewPlanTieredPrice(Generic::Dictionary<string, Json::JsonElement> properties)
    {
