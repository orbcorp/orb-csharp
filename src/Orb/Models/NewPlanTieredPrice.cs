...
public sealed record class NewPlanTieredPrice : ModelBase, IFromRaw<NewPlanTieredPrice>
{
    ...
    public required NewPlanTieredPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewPlanTieredPriceProperties::Cadence>(element)
    ...
    public required NewPlanTieredPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewPlanTieredPriceProperties::ModelType>(element)
