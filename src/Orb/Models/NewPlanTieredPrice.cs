...
[JsonConverter(typeof(JsonModelConverter<NewPlanTieredPrice, NewPlanTieredPriceFromRaw>))]
public sealed record class NewPlanTieredPrice : JsonModel
{
    /// <summary>
    ...
    public required ApiEnum<string, NewPlanTieredPriceCadence> Cadence
    {
        get
        {
            ...
            return this._rawData.GetNotNullClass<ApiEnum<string, NewPlanTieredPriceCadence>>(
                "cadence"
            );
        }
    ...
    public required ApiEnum<string, NewPlanTieredPriceModelType> ModelType
    {
        ...
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<ApiEnum<string, NewPlanTieredPriceModelType>>(
                "model_type"
            );
        }
    ...
    public NewPlanTieredPriceConversionRateConfig? ConversionRateConfig
    {
        ...
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableClass<NewPlanTieredPriceConversionRateConfig>(
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    NewPlanTieredPrice(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="NewPlanTieredPriceFromRaw.FromRawUnchecked"/>
...
class NewPlanTieredPriceFromRaw : IFromRawJson<NewPlanTieredPrice>
{
    /// <inheritdoc/>
    public NewPlanTieredPrice FromRawUnchecked(IReadOnlyDictionary<string, JsonElement> rawData) =>
        NewPlanTieredPrice.FromRawUnchecked(rawData);
}
...
public record class NewPlanTieredPriceConversionRateConfig : ModelBase
{
    ...
    public NewPlanTieredPriceConversionRateConfig(
    ...
    public NewPlanTieredPriceConversionRateConfig(JsonElement element)
    {
        this._element = element;
    }
    ...
    public virtual bool Equals(NewPlanTieredPriceConversionRateConfig? other) =>
        other != null
    ...
    : JsonConverter<NewPlanTieredPriceConversionRateConfig>
{
    ...
    )
    {
        ...
        switch (conversionRateType)
        {
            ...
            default:
            {
                return new NewPlanTieredPriceConversionRateConfig(element);
            }
        }
    }
