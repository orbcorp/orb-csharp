...
[JsonConverter(typeof(ModelConverter<NewPlanTieredPrice, NewPlanTieredPriceFromRaw>))]
public sealed record class NewPlanTieredPrice : ModelBase
{
    /// <summary>
    ...
    public required ApiEnum<string, NewPlanTieredPriceCadence> Cadence
    {
        get
        {
            return ModelBase.GetNotNullClass<ApiEnum<string, NewPlanTieredPriceCadence>>(
                this.RawData,
                "cadence"
            );
        }
    ...
    public required ApiEnum<string, NewPlanTieredPriceModelType> ModelType
    {
        get
        {
            return ModelBase.GetNotNullClass<ApiEnum<string, NewPlanTieredPriceModelType>>(
                this.RawData,
                "model_type"
            );
        }
    ...
    public NewPlanTieredPriceConversionRateConfig? ConversionRateConfig
    {
        get
        {
            return ModelBase.GetNullableClass<NewPlanTieredPriceConversionRateConfig>(
                this.RawData,
...
class NewPlanTieredPriceFromRaw : IFromRaw<NewPlanTieredPrice>
{
    /// <inheritdoc/>
...
public record class NewPlanTieredPriceConversionRateConfig
{
    ...
    public NewPlanTieredPriceConversionRateConfig(JsonElement json)
    {
        this._json = json;
    }
    ...
    : JsonConverter<NewPlanTieredPriceConversionRateConfig>
{
    ...
    )
    {
        ...
        switch (conversionRateType)
        {
            ...
            default:
            {
                return new NewPlanTieredPriceConversionRateConfig(json);
            }
        }
    }
