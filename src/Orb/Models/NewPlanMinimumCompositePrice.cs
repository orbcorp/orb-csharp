...
[JsonConverter(
    typeof(JsonModelConverter<NewPlanMinimumCompositePrice, NewPlanMinimumCompositePriceFromRaw>)
)]
public sealed record class NewPlanMinimumCompositePrice : JsonModel
{
    /// <summary>
    ...
    public required ApiEnum<string, NewPlanMinimumCompositePriceCadence> Cadence
    {
        get
        {
            return JsonModel.GetNotNullClass<ApiEnum<string, NewPlanMinimumCompositePriceCadence>>(
                this.RawData,
                "cadence"
            );
        }
    ...
    public required NewPlanMinimumCompositePriceMinimumConfig MinimumConfig
    {
        get
        {
            return JsonModel.GetNotNullClass<NewPlanMinimumCompositePriceMinimumConfig>(
                this.RawData,
                "minimum_config"
            );
        }
    ...
    public NewPlanMinimumCompositePriceConversionRateConfig? ConversionRateConfig
    {
        get
        {
            return JsonModel.GetNullableClass<NewPlanMinimumCompositePriceConversionRateConfig>(
                this.RawData,
...
class NewPlanMinimumCompositePriceFromRaw : IFromRawJson<NewPlanMinimumCompositePrice>
{
    /// <inheritdoc/>
...
public record class NewPlanMinimumCompositePriceConversionRateConfig : ModelBase
{
    ...
    public NewPlanMinimumCompositePriceConversionRateConfig(JsonElement element)
    {
        this._element = element;
    }
    ...
    : JsonConverter<NewPlanMinimumCompositePriceConversionRateConfig>
{
    ...
    )
    {
        ...
        switch (conversionRateType)
        {
            ...
            default:
            {
                return new NewPlanMinimumCompositePriceConversionRateConfig(element);
            }
        }
    }
