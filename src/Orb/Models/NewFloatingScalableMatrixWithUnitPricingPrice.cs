        ...
        IFromRaw<NewFloatingScalableMatrixWithUnitPricingPrice>
{
    ...
    public required NewFloatingScalableMatrixWithUnitPricingPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewFloatingScalableMatrixWithUnitPricingPriceProperties::Cadence>(
                    element,
    ...
    public required NewFloatingScalableMatrixWithUnitPricingPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewFloatingScalableMatrixWithUnitPricingPriceProperties::ModelType>(
                    element,
                    ModelBase.SerializerOptions
    ...
    public NewFloatingScalableMatrixWithUnitPricingPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewFloatingScalableMatrixWithUnitPricingPriceProperties::ConversionRateConfig?>(
                element,
                ModelBase.SerializerOptions
            );
        }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    NewFloatingScalableMatrixWithUnitPricingPrice(Dictionary<string, JsonElement> properties)
    {
