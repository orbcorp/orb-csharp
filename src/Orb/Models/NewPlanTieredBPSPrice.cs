...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<NewPlanTieredBPSPrice>))]
public sealed record class NewPlanTieredBPSPrice
    : Orb::ModelBase,
        Orb::IFromRaw<NewPlanTieredBPSPrice>
{
    /// <summary>
    ...
    public required NewPlanTieredBPSPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewPlanTieredBPSPriceProperties::Cadence>(
                    element
    ...
    public required NewPlanTieredBPSPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewPlanTieredBPSPriceProperties::ModelType>(
                    element
    ...
    public NewPlanTieredBPSPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewPlanTieredBPSPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
...
#pragma warning disable CS8618
    ...
    NewPlanTieredBPSPrice(Generic::Dictionary<string, Json::JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static NewPlanTieredBPSPrice FromRawUnchecked(
