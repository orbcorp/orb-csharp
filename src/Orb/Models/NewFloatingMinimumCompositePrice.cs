...
public sealed record class NewFloatingMinimumCompositePrice : JsonModel
{
    ...
    {
        get { return this._rawData.GetNotNullClass<MinimumConfig>("minimum_config"); }
    ...
    public NewFloatingMinimumCompositePriceConversionRateConfig? ConversionRateConfig
    {
        get
        {
            return this._rawData.GetNullableClass<NewFloatingMinimumCompositePriceConversionRateConfig>(
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    NewFloatingMinimumCompositePrice(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="NewFloatingMinimumCompositePriceFromRaw.FromRawUnchecked"/>
