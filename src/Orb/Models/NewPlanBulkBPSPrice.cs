...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<NewPlanBulkBPSPrice>))]
public sealed record class NewPlanBulkBPSPrice : Orb::ModelBase, Orb::IFromRaw<NewPlanBulkBPSPrice>
{
    ...
    /// </summary>
    public required NewPlanBulkBPSPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewPlanBulkBPSPriceProperties::Cadence>(element)
    ...
    public required NewPlanBulkBPSPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewPlanBulkBPSPriceProperties::ModelType>(
                    element
    ...
    /// </summary>
    public NewPlanBulkBPSPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<NewPlanBulkBPSPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
    ...
    public NewPlanBulkBPSPrice() { }

#pragma warning disable CS8618
    [CodeAnalysis::SetsRequiredMembers]
    NewPlanBulkBPSPrice(Generic::Dictionary<string, Json::JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static NewPlanBulkBPSPrice FromRawUnchecked(
