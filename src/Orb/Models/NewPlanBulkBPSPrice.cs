...
[JsonConverter(typeof(ModelConverter<NewPlanBulkBPSPrice>))]
public sealed record class NewPlanBulkBPSPrice : ModelBase, IFromRaw<NewPlanBulkBPSPrice>
{
    ...
    public required NewPlanBulkBPSPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewPlanBulkBPSPriceProperties::Cadence>(
                    element,
    ...
    public required NewPlanBulkBPSPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewPlanBulkBPSPriceProperties::ModelType>(
                    element,
                    ModelBase.SerializerOptions
    ...
    public NewPlanBulkBPSPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewPlanBulkBPSPriceProperties::ConversionRateConfig?>(
                element,
                ModelBase.SerializerOptions
            );
        }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    NewPlanBulkBPSPrice(Dictionary<string, JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static NewPlanBulkBPSPrice FromRawUnchecked(Dictionary<string, JsonElement> properties)
    {
