...
using GroupedTieredPackageConfigProperties = Orb.Models.NewPlanGroupedTieredPackagePriceProperties.GroupedTieredPackageConfigProperties;

namespace Orb.Models.NewPlanGroupedTieredPackagePriceProperties;
