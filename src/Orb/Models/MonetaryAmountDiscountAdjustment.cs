...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<MonetaryAmountDiscountAdjustment>))]
public sealed record class MonetaryAmountDiscountAdjustment
    : Orb::ModelBase,
        Orb::IFromRaw<MonetaryAmountDiscountAdjustment>
{
    ...
    public required MonetaryAmountDiscountAdjustmentProperties::AdjustmentType AdjustmentType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<MonetaryAmountDiscountAdjustmentProperties::AdjustmentType>(
                    element
...
#pragma warning disable CS8618
    ...
    MonetaryAmountDiscountAdjustment(Generic::Dictionary<string, Json::JsonElement> properties)
    {
