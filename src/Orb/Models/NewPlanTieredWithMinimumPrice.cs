        ...
        IFromRaw<NewPlanTieredWithMinimumPrice>
{
    ...
    public required NewPlanTieredWithMinimumPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewPlanTieredWithMinimumPriceProperties::Cadence>(
                    element
    ...
    public required NewPlanTieredWithMinimumPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewPlanTieredWithMinimumPriceProperties::ModelType>(
                    element
    ...
    public NewPlanTieredWithMinimumPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewPlanTieredWithMinimumPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
