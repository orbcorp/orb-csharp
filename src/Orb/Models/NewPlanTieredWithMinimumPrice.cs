...
public sealed record class NewPlanTieredWithMinimumPrice : ModelBase
{
    ...
    public required ApiEnum<string, NewPlanTieredWithMinimumPriceCadence> Cadence
    {
        get
        {
            return ModelBase.GetNotNullClass<ApiEnum<string, NewPlanTieredWithMinimumPriceCadence>>(
                this.RawData,
                "cadence"
            );
        }
    ...
    public required NewPlanTieredWithMinimumPriceTieredWithMinimumConfig TieredWithMinimumConfig
    {
        get
        {
            return ModelBase.GetNotNullClass<NewPlanTieredWithMinimumPriceTieredWithMinimumConfig>(
                this.RawData,
    ...
    public NewPlanTieredWithMinimumPriceConversionRateConfig? ConversionRateConfig
    {
        get
        {
            return ModelBase.GetNullableClass<NewPlanTieredWithMinimumPriceConversionRateConfig>(
                this.RawData,
