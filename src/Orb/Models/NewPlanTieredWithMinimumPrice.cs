...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<NewPlanTieredWithMinimumPrice>))]
public sealed record class NewPlanTieredWithMinimumPrice
    : Orb::ModelBase,
        Orb::IFromRaw<NewPlanTieredWithMinimumPrice>
{
    /// <summary>
    /// The cadence to bill for this price on.
    /// </summary>
    public required NewPlanTieredWithMinimumPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewPlanTieredWithMinimumPriceProperties::Cadence>(
                    element
    ...
    public required NewPlanTieredWithMinimumPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewPlanTieredWithMinimumPriceProperties::ModelType>(
                    element
    ...
    /// </summary>
    public NewPlanTieredWithMinimumPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<NewPlanTieredWithMinimumPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
...
#pragma warning disable CS8618
    ...
    NewPlanTieredWithMinimumPrice(Generic::Dictionary<string, Json::JsonElement> properties)
    {
