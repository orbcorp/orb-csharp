...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<NewFloatingUnitPrice>))]
public sealed record class NewFloatingUnitPrice
    : Orb::ModelBase,
        Orb::IFromRaw<NewFloatingUnitPrice>
{
    /// <summary>
    ...
    public required NewFloatingUnitPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewFloatingUnitPriceProperties::Cadence>(
                    element
    ...
    public required NewFloatingUnitPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewFloatingUnitPriceProperties::ModelType>(
                    element
    ...
    public NewFloatingUnitPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewFloatingUnitPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
...
#pragma warning disable CS8618
    ...
    NewFloatingUnitPrice(Generic::Dictionary<string, Json::JsonElement> properties)
    {
