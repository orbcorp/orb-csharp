...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<NewFloatingTieredBPSPrice>))]
public sealed record class NewFloatingTieredBPSPrice
    : Orb::ModelBase,
        Orb::IFromRaw<NewFloatingTieredBPSPrice>
{
    /// <summary>
    /// The cadence to bill for this price on.
    /// </summary>
    public required NewFloatingTieredBPSPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewFloatingTieredBPSPriceProperties::Cadence>(
                    element
    ...
    public required NewFloatingTieredBPSPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewFloatingTieredBPSPriceProperties::ModelType>(
                    element
    ...
    public required TieredBPSConfig TieredBPSConfig
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<TieredBPSConfig>(element)
    ...
    /// </summary>
    public NewFloatingTieredBPSPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<NewFloatingTieredBPSPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
...
#pragma warning disable CS8618
    ...
    NewFloatingTieredBPSPrice(Generic::Dictionary<string, Json::JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static NewFloatingTieredBPSPrice FromRawUnchecked(
