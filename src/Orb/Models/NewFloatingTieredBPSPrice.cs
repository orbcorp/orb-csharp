...
[JsonConverter(typeof(ModelConverter<NewFloatingTieredBPSPrice>))]
public sealed record class NewFloatingTieredBPSPrice
    : ModelBase,
        IFromRaw<NewFloatingTieredBPSPrice>
{
    /// <summary>
    ...
    public required NewFloatingTieredBPSPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewFloatingTieredBPSPriceProperties::Cadence>(
                    element,
    ...
    public required NewFloatingTieredBPSPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewFloatingTieredBPSPriceProperties::ModelType>(
                    element,
                    ModelBase.SerializerOptions
    ...
    public NewFloatingTieredBPSPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewFloatingTieredBPSPriceProperties::ConversionRateConfig?>(
                element,
                ModelBase.SerializerOptions
            );
        }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    NewFloatingTieredBPSPrice(Dictionary<string, JsonElement> properties)
    {
