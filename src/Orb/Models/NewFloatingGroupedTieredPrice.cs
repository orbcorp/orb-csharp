...
public sealed record class NewFloatingGroupedTieredPrice : JsonModel
{
    ...
    {
        get { return this._rawData.GetNotNullClass<GroupedTieredConfig>("grouped_tiered_config"); }
    ...
    public NewFloatingGroupedTieredPriceConversionRateConfig? ConversionRateConfig
    {
        get
        {
            return this._rawData.GetNullableClass<NewFloatingGroupedTieredPriceConversionRateConfig>(
...
public record class NewFloatingGroupedTieredPriceConversionRateConfig : ModelBase
{
