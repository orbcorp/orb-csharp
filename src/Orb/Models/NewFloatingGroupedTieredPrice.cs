        ...
        IFromRaw<NewFloatingGroupedTieredPrice>
{
    ...
    /// </summary>
    public required NewFloatingGroupedTieredPriceProperties::Cadence Cadence
    {
        get
        {
    ...
    /// </summary>
    public NewFloatingGroupedTieredPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
