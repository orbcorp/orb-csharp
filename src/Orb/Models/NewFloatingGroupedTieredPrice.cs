...
public sealed record class NewFloatingGroupedTieredPrice : ModelBase
{
    ...
    public required ApiEnum<string, NewFloatingGroupedTieredPriceCadence> Cadence
    {
        get
        {
            return ModelBase.GetNotNullClass<ApiEnum<string, NewFloatingGroupedTieredPriceCadence>>(
                this.RawData,
                "cadence"
            );
        }
    ...
    public required GroupedTieredConfig GroupedTieredConfig
    {
        get
        {
            return ModelBase.GetNotNullClass<GroupedTieredConfig>(
                this.RawData,
    ...
    public NewFloatingGroupedTieredPriceConversionRateConfig? ConversionRateConfig
    {
        get
        {
            return ModelBase.GetNullableClass<NewFloatingGroupedTieredPriceConversionRateConfig>(
                this.RawData,
