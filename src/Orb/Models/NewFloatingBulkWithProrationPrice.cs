...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<NewFloatingBulkWithProrationPrice>))]
public sealed record class NewFloatingBulkWithProrationPrice
    : Orb::ModelBase,
        Orb::IFromRaw<NewFloatingBulkWithProrationPrice>
{
    ...
    /// </summary>
    public required NewFloatingBulkWithProrationPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewFloatingBulkWithProrationPriceProperties::Cadence>(
                    element
    ...
    public required NewFloatingBulkWithProrationPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewFloatingBulkWithProrationPriceProperties::ModelType>(
                    element
    ...
    /// </summary>
    public NewFloatingBulkWithProrationPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<NewFloatingBulkWithProrationPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
...
#pragma warning disable CS8618
    ...
    NewFloatingBulkWithProrationPrice(Generic::Dictionary<string, Json::JsonElement> properties)
    {
