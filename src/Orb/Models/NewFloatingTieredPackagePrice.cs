        ...
        IFromRaw<NewFloatingTieredPackagePrice>
{
    ...
    public required NewFloatingTieredPackagePriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewFloatingTieredPackagePriceProperties::Cadence>(
                    element,
    ...
    public required NewFloatingTieredPackagePriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewFloatingTieredPackagePriceProperties::ModelType>(
                    element,
                    ModelBase.SerializerOptions
    ...
    public NewFloatingTieredPackagePriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewFloatingTieredPackagePriceProperties::ConversionRateConfig?>(
                element,
                ModelBase.SerializerOptions
            );
        }
