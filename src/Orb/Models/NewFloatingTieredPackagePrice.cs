...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<NewFloatingTieredPackagePrice>))]
public sealed record class NewFloatingTieredPackagePrice
    : Orb::ModelBase,
        Orb::IFromRaw<NewFloatingTieredPackagePrice>
{
    /// <summary>
    /// The cadence to bill for this price on.
    /// </summary>
    public required NewFloatingTieredPackagePriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewFloatingTieredPackagePriceProperties::Cadence>(
                    element
    ...
    public required NewFloatingTieredPackagePriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewFloatingTieredPackagePriceProperties::ModelType>(
                    element
    ...
    /// </summary>
    public NewFloatingTieredPackagePriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<NewFloatingTieredPackagePriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
...
#pragma warning disable CS8618
    ...
    NewFloatingTieredPackagePrice(Generic::Dictionary<string, Json::JsonElement> properties)
    {
