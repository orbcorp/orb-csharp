...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<NewFloatingGroupedTieredPackagePrice>))]
public sealed record class NewFloatingGroupedTieredPackagePrice
    : Orb::ModelBase,
        Orb::IFromRaw<NewFloatingGroupedTieredPackagePrice>
{
    /// <summary>
    /// The cadence to bill for this price on.
    /// </summary>
    public required NewFloatingGroupedTieredPackagePriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewFloatingGroupedTieredPackagePriceProperties::Cadence>(
                    element
    ...
    public required NewFloatingGroupedTieredPackagePriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewFloatingGroupedTieredPackagePriceProperties::ModelType>(
                    element
    ...
    /// </summary>
    public NewFloatingGroupedTieredPackagePriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<NewFloatingGroupedTieredPackagePriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
...
#pragma warning disable CS8618
    ...
    NewFloatingGroupedTieredPackagePrice(Generic::Dictionary<string, Json::JsonElement> properties)
    {
