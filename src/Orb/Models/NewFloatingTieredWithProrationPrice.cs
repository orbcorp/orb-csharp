        ...
        IFromRaw<NewFloatingTieredWithProrationPrice>
{
    ...
    public required NewFloatingTieredWithProrationPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewFloatingTieredWithProrationPriceProperties::Cadence>(
                    element,
    ...
    public required NewFloatingTieredWithProrationPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewFloatingTieredWithProrationPriceProperties::ModelType>(
                    element,
                    ModelBase.SerializerOptions
    ...
    public NewFloatingTieredWithProrationPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewFloatingTieredWithProrationPriceProperties::ConversionRateConfig?>(
                element,
                ModelBase.SerializerOptions
            );
        }
