...
public record class NewFloatingTieredWithProrationPriceConversionRateConfig
{
    ...
    public NewFloatingTieredWithProrationPriceConversionRateConfig(JsonElement json)
    {
        this._json = json;
    }
    ...
    : JsonConverter<NewFloatingTieredWithProrationPriceConversionRateConfig>
{
    ...
    )
    {
        ...
        switch (conversionRateType)
        {
            ...
            default:
            {
                return new NewFloatingTieredWithProrationPriceConversionRateConfig(json);
            }
        }
    }
