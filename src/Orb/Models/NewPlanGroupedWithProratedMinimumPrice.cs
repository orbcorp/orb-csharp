        ...
        IFromRaw<NewPlanGroupedWithProratedMinimumPrice>
{
    ...
    public required NewPlanGroupedWithProratedMinimumPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewPlanGroupedWithProratedMinimumPriceProperties::Cadence>(
                    element
    ...
    public required NewPlanGroupedWithProratedMinimumPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewPlanGroupedWithProratedMinimumPriceProperties::ModelType>(
                    element
    ...
    public NewPlanGroupedWithProratedMinimumPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewPlanGroupedWithProratedMinimumPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
