...
public sealed record class NewFloatingGroupedAllocationPrice : JsonModel
{
    /// <summary>
    ...
    public NewFloatingGroupedAllocationPriceConversionRateConfig? ConversionRateConfig
    {
        ...
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableClass<NewFloatingGroupedAllocationPriceConversionRateConfig>(
...
#pragma warning restore CS8618
    ...
    /// <inheritdoc cref="NewFloatingGroupedAllocationPriceFromRaw.FromRawUnchecked"/>
...
class NewFloatingGroupedAllocationPriceFromRaw : IFromRawJson<NewFloatingGroupedAllocationPrice>
{
    /// <inheritdoc/>
...
public record class NewFloatingGroupedAllocationPriceConversionRateConfig : ModelBase
{
    ...
    public NewFloatingGroupedAllocationPriceConversionRateConfig(JsonElement element)
    {
        this._element = element;
    }
    ...
    : JsonConverter<NewFloatingGroupedAllocationPriceConversionRateConfig>
{
    ...
    )
    {
        ...
        switch (conversionRateType)
        {
            ...
            default:
            {
                return new NewFloatingGroupedAllocationPriceConversionRateConfig(element);
            }
        }
    }
