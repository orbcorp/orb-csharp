...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<NewFloatingGroupedAllocationPrice>))]
public sealed record class NewFloatingGroupedAllocationPrice
    : Orb::ModelBase,
        Orb::IFromRaw<NewFloatingGroupedAllocationPrice>
{
    /// <summary>
    /// The cadence to bill for this price on.
    /// </summary>
    public required NewFloatingGroupedAllocationPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewFloatingGroupedAllocationPriceProperties::Cadence>(
                    element
    ...
    public required NewFloatingGroupedAllocationPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewFloatingGroupedAllocationPriceProperties::ModelType>(
                    element
    ...
    /// </summary>
    public NewFloatingGroupedAllocationPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<NewFloatingGroupedAllocationPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
...
#pragma warning disable CS8618
    ...
    NewFloatingGroupedAllocationPrice(Generic::Dictionary<string, Json::JsonElement> properties)
    {
