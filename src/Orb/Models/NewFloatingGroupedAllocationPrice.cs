        ...
        IFromRaw<NewFloatingGroupedAllocationPrice>
{
    ...
    public required NewFloatingGroupedAllocationPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewFloatingGroupedAllocationPriceProperties::Cadence>(
                    element,
    ...
    public required NewFloatingGroupedAllocationPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewFloatingGroupedAllocationPriceProperties::ModelType>(
                    element,
                    ModelBase.SerializerOptions
    ...
    public NewFloatingGroupedAllocationPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewFloatingGroupedAllocationPriceProperties::ConversionRateConfig?>(
                element,
                ModelBase.SerializerOptions
            );
        }
