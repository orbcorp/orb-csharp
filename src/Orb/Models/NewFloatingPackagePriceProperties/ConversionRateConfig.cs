...
using ConversionRateConfigVariants = Orb.Models.NewFloatingPackagePriceProperties.ConversionRateConfigVariants;

namespace Orb.Models.NewFloatingPackagePriceProperties;
