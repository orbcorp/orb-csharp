...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<NewFloatingUnitWithProrationPrice>))]
public sealed record class NewFloatingUnitWithProrationPrice
    : Orb::ModelBase,
        Orb::IFromRaw<NewFloatingUnitWithProrationPrice>
{
    /// <summary>
    /// The cadence to bill for this price on.
    /// </summary>
    public required NewFloatingUnitWithProrationPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewFloatingUnitWithProrationPriceProperties::Cadence>(
                    element
    ...
    public required NewFloatingUnitWithProrationPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewFloatingUnitWithProrationPriceProperties::ModelType>(
                    element
    ...
    public required Generic::Dictionary<string, Json::JsonElement> UnitWithProrationConfig
    {
        get
        {
            if (
        ...
        set
        {
            this.Properties["unit_with_proration_config"] = Json::JsonSerializer.SerializeToElement(
                value
            );
        }
    }
    ...
    /// </summary>
    public NewFloatingUnitWithProrationPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<NewFloatingUnitWithProrationPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
...
#pragma warning disable CS8618
    ...
    NewFloatingUnitWithProrationPrice(Generic::Dictionary<string, Json::JsonElement> properties)
    {
