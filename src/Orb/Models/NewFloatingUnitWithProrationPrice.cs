        ...
        IFromRaw<NewFloatingUnitWithProrationPrice>
{
    ...
    public required NewFloatingUnitWithProrationPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewFloatingUnitWithProrationPriceProperties::Cadence>(
                    element,
    ...
    public required NewFloatingUnitWithProrationPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewFloatingUnitWithProrationPriceProperties::ModelType>(
                    element,
                    ModelBase.SerializerOptions
    ...
    public NewFloatingUnitWithProrationPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewFloatingUnitWithProrationPriceProperties::ConversionRateConfig?>(
                element,
                ModelBase.SerializerOptions
            );
        }
