...
public sealed record class NewFloatingUnitWithProrationPrice : JsonModel
{
    /// <summary>
    ...
    public required UnitWithProrationConfig UnitWithProrationConfig
    {
        get
        {
            return JsonModel.GetNotNullClass<UnitWithProrationConfig>(
                this.RawData,
    ...
    public NewFloatingUnitWithProrationPriceConversionRateConfig? ConversionRateConfig
    {
        get
        {
            return JsonModel.GetNullableClass<NewFloatingUnitWithProrationPriceConversionRateConfig>(
                this.RawData,
...
#pragma warning restore CS8618
    ...
    /// <inheritdoc cref="NewFloatingUnitWithProrationPriceFromRaw.FromRawUnchecked"/>
...
class NewFloatingUnitWithProrationPriceFromRaw : IFromRawJson<NewFloatingUnitWithProrationPrice>
{
    /// <inheritdoc/>
...
public record class NewFloatingUnitWithProrationPriceConversionRateConfig : ModelBase
{
    ...
    public NewFloatingUnitWithProrationPriceConversionRateConfig(JsonElement element)
    {
        this._element = element;
    }
    ...
    : JsonConverter<NewFloatingUnitWithProrationPriceConversionRateConfig>
{
    ...
    )
    {
        ...
        switch (conversionRateType)
        {
            ...
            default:
            {
                return new NewFloatingUnitWithProrationPriceConversionRateConfig(element);
            }
        }
    }
