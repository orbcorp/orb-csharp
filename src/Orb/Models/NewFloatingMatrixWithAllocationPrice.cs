...
public sealed record class NewFloatingMatrixWithAllocationPrice : ModelBase
{
    /// <summary>
    ...
    public NewFloatingMatrixWithAllocationPriceConversionRateConfig? ConversionRateConfig
    {
        get
        {
            return ModelBase.GetNullableClass<NewFloatingMatrixWithAllocationPriceConversionRateConfig>(
                this.RawData,
...
class NewFloatingMatrixWithAllocationPriceFromRaw : IFromRaw<NewFloatingMatrixWithAllocationPrice>
{
    /// <inheritdoc/>
...
public record class NewFloatingMatrixWithAllocationPriceConversionRateConfig
{
    ...
    public NewFloatingMatrixWithAllocationPriceConversionRateConfig(JsonElement json)
    {
        this._json = json;
    }
    ...
    : JsonConverter<NewFloatingMatrixWithAllocationPriceConversionRateConfig>
{
    ...
    )
    {
        ...
        switch (conversionRateType)
        {
            ...
            default:
            {
                return new NewFloatingMatrixWithAllocationPriceConversionRateConfig(json);
            }
        }
    }
