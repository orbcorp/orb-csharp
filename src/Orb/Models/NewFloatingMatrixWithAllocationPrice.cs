        ...
        IFromRaw<NewFloatingMatrixWithAllocationPrice>
{
    ...
    public required NewFloatingMatrixWithAllocationPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewFloatingMatrixWithAllocationPriceProperties::Cadence>(
                    element
    ...
    public required NewFloatingMatrixWithAllocationPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewFloatingMatrixWithAllocationPriceProperties::ModelType>(
                    element
    ...
    public NewFloatingMatrixWithAllocationPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewFloatingMatrixWithAllocationPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    NewFloatingMatrixWithAllocationPrice(Dictionary<string, JsonElement> properties)
    {
