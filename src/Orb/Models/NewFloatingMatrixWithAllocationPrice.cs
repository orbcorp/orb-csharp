...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<NewFloatingMatrixWithAllocationPrice>))]
public sealed record class NewFloatingMatrixWithAllocationPrice
    : Orb::ModelBase,
        Orb::IFromRaw<NewFloatingMatrixWithAllocationPrice>
{
    /// <summary>
    /// The cadence to bill for this price on.
    /// </summary>
    public required NewFloatingMatrixWithAllocationPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewFloatingMatrixWithAllocationPriceProperties::Cadence>(
                    element
    ...
    public required NewFloatingMatrixWithAllocationPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewFloatingMatrixWithAllocationPriceProperties::ModelType>(
                    element
    ...
    /// </summary>
    public NewFloatingMatrixWithAllocationPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<NewFloatingMatrixWithAllocationPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
...
#pragma warning disable CS8618
    ...
    NewFloatingMatrixWithAllocationPrice(Generic::Dictionary<string, Json::JsonElement> properties)
    {
