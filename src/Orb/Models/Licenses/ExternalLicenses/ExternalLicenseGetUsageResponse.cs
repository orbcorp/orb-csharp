...
[JsonConverter(
    typeof(JsonModelConverter<
        ...
        ExternalLicenseGetUsageResponseFromRaw
    >)
)]
public sealed record class ExternalLicenseGetUsageResponse : JsonModel
{
    ...
    public ExternalLicenseGetUsageResponse() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ExternalLicenseGetUsageResponse(
        ExternalLicenseGetUsageResponse externalLicenseGetUsageResponse
    )
        : base(externalLicenseGetUsageResponse) { }
#pragma warning restore CS8618

    public ExternalLicenseGetUsageResponse(IReadOnlyDictionary<string, JsonElement> rawData)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    ExternalLicenseGetUsageResponse(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="ExternalLicenseGetUsageResponseFromRaw.FromRawUnchecked"/>
    public static ExternalLicenseGetUsageResponse FromRawUnchecked(
...
class ExternalLicenseGetUsageResponseFromRaw : IFromRawJson<ExternalLicenseGetUsageResponse>
{
    /// <inheritdoc/>
    public ExternalLicenseGetUsageResponse FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => ExternalLicenseGetUsageResponse.FromRawUnchecked(rawData);
}
