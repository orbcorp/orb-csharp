...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<DimensionalPriceGroups>))]
public sealed record class DimensionalPriceGroups
    : Orb::ModelBase,
        Orb::IFromRaw<DimensionalPriceGroups>
{
    public required Generic::List<DimensionalPriceGroup> Data
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<Generic::List<DimensionalPriceGroup>>(element)
...
#pragma warning disable CS8618
    ...
    DimensionalPriceGroups(Generic::Dictionary<string, Json::JsonElement> properties)
    {
