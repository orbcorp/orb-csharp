        ...
        IFromRaw<NewPlanGroupedAllocationPrice>
{
    ...
    public required NewPlanGroupedAllocationPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewPlanGroupedAllocationPriceProperties::Cadence>(
                    element,
    ...
    public required NewPlanGroupedAllocationPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewPlanGroupedAllocationPriceProperties::ModelType>(
                    element,
                    ModelBase.SerializerOptions
    ...
    public NewPlanGroupedAllocationPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewPlanGroupedAllocationPriceProperties::ConversionRateConfig?>(
                element,
                ModelBase.SerializerOptions
            );
        }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    NewPlanGroupedAllocationPrice(Dictionary<string, JsonElement> properties)
    {
