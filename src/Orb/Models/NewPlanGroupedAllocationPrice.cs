...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<NewPlanGroupedAllocationPrice>))]
public sealed record class NewPlanGroupedAllocationPrice
    : Orb::ModelBase,
        Orb::IFromRaw<NewPlanGroupedAllocationPrice>
{
    /// <summary>
    /// The cadence to bill for this price on.
    /// </summary>
    public required NewPlanGroupedAllocationPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewPlanGroupedAllocationPriceProperties::Cadence>(
                    element
    ...
    public required NewPlanGroupedAllocationPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewPlanGroupedAllocationPriceProperties::ModelType>(
                    element
    ...
    /// </summary>
    public NewPlanGroupedAllocationPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<NewPlanGroupedAllocationPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
...
#pragma warning disable CS8618
    ...
    NewPlanGroupedAllocationPrice(Generic::Dictionary<string, Json::JsonElement> properties)
    {
