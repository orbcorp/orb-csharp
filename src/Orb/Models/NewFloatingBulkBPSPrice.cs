...
[JsonConverter(typeof(ModelConverter<NewFloatingBulkBPSPrice>))]
public sealed record class NewFloatingBulkBPSPrice : ModelBase, IFromRaw<NewFloatingBulkBPSPrice>
{
    public required BulkBPSConfig BulkBPSConfig
    {
        get
        {
            if (!this.Properties.TryGetValue("bulk_bps_config", out JsonElement element))
                throw new System::ArgumentOutOfRangeException(
                    "bulk_bps_config",
                    "Missing required argument"
                );

            return JsonSerializer.Deserialize<BulkBPSConfig>(element, ModelBase.SerializerOptions)
    ...
    public required NewFloatingBulkBPSPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewFloatingBulkBPSPriceProperties::Cadence>(
                    element,
    ...
    public required NewFloatingBulkBPSPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewFloatingBulkBPSPriceProperties::ModelType>(
                    element,
                    ModelBase.SerializerOptions
    ...
    public NewFloatingBulkBPSPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewFloatingBulkBPSPriceProperties::ConversionRateConfig?>(
                element,
                ModelBase.SerializerOptions
            );
        }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    NewFloatingBulkBPSPrice(Dictionary<string, JsonElement> properties)
    {
