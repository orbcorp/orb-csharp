...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<NewFloatingBulkBPSPrice>))]
public sealed record class NewFloatingBulkBPSPrice
    : Orb::ModelBase,
        Orb::IFromRaw<NewFloatingBulkBPSPrice>
{
    public required BulkBPSConfig BulkBPSConfig
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<BulkBPSConfig>(element)
    ...
    /// </summary>
    public required NewFloatingBulkBPSPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewFloatingBulkBPSPriceProperties::Cadence>(
                    element
    ...
    public required NewFloatingBulkBPSPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewFloatingBulkBPSPriceProperties::ModelType>(
                    element
    ...
    /// </summary>
    public NewFloatingBulkBPSPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<NewFloatingBulkBPSPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
...
#pragma warning disable CS8618
    ...
    NewFloatingBulkBPSPrice(Generic::Dictionary<string, Json::JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static NewFloatingBulkBPSPrice FromRawUnchecked(
