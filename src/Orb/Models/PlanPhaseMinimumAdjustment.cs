...
public sealed record class Filter21 : ModelBase, IFromRaw<Filter21>
{
    ...
    public required ApiEnum<string, Filter21Field> Field
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<ApiEnum<string, Filter21Field>>(
                element,
                ModelBase.SerializerOptions
            );
        }
    ...
    public required ApiEnum<string, Filter21Operator> Operator
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<ApiEnum<string, Filter21Operator>>(
                element,
                ModelBase.SerializerOptions
            );
        }
    ...
    public Filter21(IReadOnlyDictionary<string, JsonElement> properties)
    {
        this._properties = [.. properties];
    }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    Filter21(FrozenDictionary<string, JsonElement> properties)
    {
        this._properties = [.. properties];
    }
#pragma warning restore CS8618

    public static Filter21 FromRawUnchecked(IReadOnlyDictionary<string, JsonElement> properties)
    {
        return new(FrozenDictionary.ToFrozenDictionary(properties));
    }
}
