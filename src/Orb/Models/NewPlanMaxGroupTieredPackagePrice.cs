...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<NewPlanMaxGroupTieredPackagePrice>))]
public sealed record class NewPlanMaxGroupTieredPackagePrice
    : Orb::ModelBase,
        Orb::IFromRaw<NewPlanMaxGroupTieredPackagePrice>
{
    /// <summary>
    /// The cadence to bill for this price on.
    /// </summary>
    public required NewPlanMaxGroupTieredPackagePriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewPlanMaxGroupTieredPackagePriceProperties::Cadence>(
                    element
    ...
    public required NewPlanMaxGroupTieredPackagePriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewPlanMaxGroupTieredPackagePriceProperties::ModelType>(
                    element
    ...
    /// </summary>
    public NewPlanMaxGroupTieredPackagePriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<NewPlanMaxGroupTieredPackagePriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
...
#pragma warning disable CS8618
    ...
    NewPlanMaxGroupTieredPackagePrice(Generic::Dictionary<string, Json::JsonElement> properties)
    {
