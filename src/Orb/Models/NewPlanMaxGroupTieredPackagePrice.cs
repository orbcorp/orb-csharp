...
public sealed record class NewPlanMaxGroupTieredPackagePrice : ModelBase
{
    ...
    public required NewPlanMaxGroupTieredPackagePriceMaxGroupTieredPackageConfig MaxGroupTieredPackageConfig
    {
        get
        {
            return ModelBase.GetNotNullClass<NewPlanMaxGroupTieredPackagePriceMaxGroupTieredPackageConfig>(
                this.RawData,
    ...
    public NewPlanMaxGroupTieredPackagePriceConversionRateConfig? ConversionRateConfig
    {
        get
        {
            return ModelBase.GetNullableClass<NewPlanMaxGroupTieredPackagePriceConversionRateConfig>(
                this.RawData,
...
public sealed record class NewPlanMaxGroupTieredPackagePriceMaxGroupTieredPackageConfig : ModelBase
{
    ...
    /// </summary>
    public required IReadOnlyList<Tier11> Tiers
    {
        get { return ModelBase.GetNotNullClass<List<Tier11>>(this.RawData, "tiers"); }
...
#pragma warning restore CS8618
    ...
    public static Tier11 FromRawUnchecked(IReadOnlyDictionary<string, JsonElement> rawData)
    {
        return new(FrozenDictionary.ToFrozenDictionary(rawData));
    }
}
