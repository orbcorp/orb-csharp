...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<NewPlanTieredPackageWithMinimumPrice>))]
public sealed record class NewPlanTieredPackageWithMinimumPrice
    : Orb::ModelBase,
        Orb::IFromRaw<NewPlanTieredPackageWithMinimumPrice>
{
    /// <summary>
    /// The cadence to bill for this price on.
    /// </summary>
    public required NewPlanTieredPackageWithMinimumPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewPlanTieredPackageWithMinimumPriceProperties::Cadence>(
                    element
    ...
    public required NewPlanTieredPackageWithMinimumPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewPlanTieredPackageWithMinimumPriceProperties::ModelType>(
                    element
    ...
    /// </summary>
    public NewPlanTieredPackageWithMinimumPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<NewPlanTieredPackageWithMinimumPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
...
#pragma warning disable CS8618
    ...
    NewPlanTieredPackageWithMinimumPrice(Generic::Dictionary<string, Json::JsonElement> properties)
    {
