        ...
        IFromRaw<NewPlanTieredPackageWithMinimumPrice>
{
    ...
    public required NewPlanTieredPackageWithMinimumPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewPlanTieredPackageWithMinimumPriceProperties::Cadence>(
                    element
    ...
    public required NewPlanTieredPackageWithMinimumPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewPlanTieredPackageWithMinimumPriceProperties::ModelType>(
                    element
    ...
    public required Dictionary<string, JsonElement> TieredPackageWithMinimumConfig
    {
        get
        {
            if (
    ...
    public NewPlanTieredPackageWithMinimumPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewPlanTieredPackageWithMinimumPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
