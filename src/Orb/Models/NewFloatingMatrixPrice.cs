...
public sealed record class NewFloatingMatrixPrice : ModelBase, IFromRaw<NewFloatingMatrixPrice>
{
    ...
    public required NewFloatingMatrixPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewFloatingMatrixPriceProperties::Cadence>(element)
    ...
    public required MatrixConfig MatrixConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<MatrixConfig>(element)
    ...
    public required NewFloatingMatrixPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewFloatingMatrixPriceProperties::ModelType>(element)
    ...
    public NewFloatingMatrixPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewFloatingMatrixPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
