...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<NewFloatingMatrixPrice>))]
public sealed record class NewFloatingMatrixPrice
    : Orb::ModelBase,
        Orb::IFromRaw<NewFloatingMatrixPrice>
{
    /// <summary>
    /// The cadence to bill for this price on.
    /// </summary>
    public required NewFloatingMatrixPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewFloatingMatrixPriceProperties::Cadence>(
                    element
    ...
    public required MatrixConfig MatrixConfig
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<MatrixConfig>(element)
    ...
    public required NewFloatingMatrixPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewFloatingMatrixPriceProperties::ModelType>(
                    element
    ...
    /// </summary>
    public NewFloatingMatrixPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<NewFloatingMatrixPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
...
#pragma warning disable CS8618
    ...
    NewFloatingMatrixPrice(Generic::Dictionary<string, Json::JsonElement> properties)
    {
