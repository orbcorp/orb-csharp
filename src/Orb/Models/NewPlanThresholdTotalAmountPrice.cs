        ...
        IFromRaw<NewPlanThresholdTotalAmountPrice>
{
    ...
    public required NewPlanThresholdTotalAmountPriceThresholdTotalAmountConfig ThresholdTotalAmountConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewPlanThresholdTotalAmountPriceThresholdTotalAmountConfig>(
                    element,
                    ModelBase.SerializerOptions
                )
                ?? throw new OrbInvalidDataException(
        ...
        init
        {
            this._properties["threshold_total_amount_config"] = JsonSerializer.SerializeToElement(
                value,
                ModelBase.SerializerOptions
            );
        }
    ...
    public NewPlanThresholdTotalAmountPriceConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewPlanThresholdTotalAmountPriceConversionRateConfig?>(
                element,
                ModelBase.SerializerOptions
            );
        }
    ...
    public NewPlanThresholdTotalAmountPrice(IReadOnlyDictionary<string, JsonElement> properties)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    NewPlanThresholdTotalAmountPrice(FrozenDictionary<string, JsonElement> properties)
    {
        this._properties = [.. properties];
    }
        ...
        IFromRaw<NewPlanThresholdTotalAmountPriceThresholdTotalAmountConfig>
{
    ...
    public required List<ConsumptionTableModel> ConsumptionTable
    {
        get
        {
            if (!this._properties.TryGetValue("consumption_table", out JsonElement element))
                throw new OrbInvalidDataException(
        ...
        init
        {
            this._properties["consumption_table"] = JsonSerializer.SerializeToElement(
                value,
                ModelBase.SerializerOptions
            );
        }
...
public sealed record class ConsumptionTableModel : ModelBase, IFromRaw<ConsumptionTableModel>
{
    ...
    public ConsumptionTableModel(IReadOnlyDictionary<string, JsonElement> properties)
    {
        this._properties = [.. properties];
    }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    ConsumptionTableModel(FrozenDictionary<string, JsonElement> properties)
    {
        this._properties = [.. properties];
    }
#pragma warning restore CS8618
...
public record class NewPlanThresholdTotalAmountPriceConversionRateConfig
{
    ...
    NewPlanThresholdTotalAmountPriceConversionRateConfig(UnknownVariant value)
    {
        Value = value;
    }

    public static NewPlanThresholdTotalAmountPriceConversionRateConfig CreateUnknownVariant(
        JsonElement value
    )
    {
            ...
            case "unit":
            {
                ...
                try
                {
                    ...
                    if (deserialized != null)
                    {
                        ...
                        return new NewPlanThresholdTotalAmountPriceConversionRateConfig(
                            deserialized
                        );
                    }
                }
