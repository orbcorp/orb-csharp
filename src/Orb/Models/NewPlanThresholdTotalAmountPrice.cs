...
public sealed record class NewPlanThresholdTotalAmountPrice : ModelBase
{
    ...
    public required NewPlanThresholdTotalAmountPriceThresholdTotalAmountConfig ThresholdTotalAmountConfig
    {
        get
        {
            return ModelBase.GetNotNullClass<NewPlanThresholdTotalAmountPriceThresholdTotalAmountConfig>(
                this.RawData,
    ...
    public NewPlanThresholdTotalAmountPriceConversionRateConfig? ConversionRateConfig
    {
        get
        {
            return ModelBase.GetNullableClass<NewPlanThresholdTotalAmountPriceConversionRateConfig>(
                this.RawData,
