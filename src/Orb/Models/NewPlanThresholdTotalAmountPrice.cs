        ...
        IFromRaw<NewPlanThresholdTotalAmountPrice>
{
    ...
    public required NewPlanThresholdTotalAmountPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewPlanThresholdTotalAmountPriceProperties::Cadence>(
                    element
    ...
    public required NewPlanThresholdTotalAmountPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewPlanThresholdTotalAmountPriceProperties::ModelType>(
                    element
    ...
    public NewPlanThresholdTotalAmountPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewPlanThresholdTotalAmountPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
