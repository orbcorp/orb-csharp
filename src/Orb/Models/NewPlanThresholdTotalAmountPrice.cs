...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<NewPlanThresholdTotalAmountPrice>))]
public sealed record class NewPlanThresholdTotalAmountPrice
    : Orb::ModelBase,
        Orb::IFromRaw<NewPlanThresholdTotalAmountPrice>
{
    /// <summary>
    /// The cadence to bill for this price on.
    /// </summary>
    public required NewPlanThresholdTotalAmountPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewPlanThresholdTotalAmountPriceProperties::Cadence>(
                    element
    ...
    public required NewPlanThresholdTotalAmountPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewPlanThresholdTotalAmountPriceProperties::ModelType>(
                    element
    ...
    /// </summary>
    public NewPlanThresholdTotalAmountPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<NewPlanThresholdTotalAmountPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
...
#pragma warning disable CS8618
    ...
    NewPlanThresholdTotalAmountPrice(Generic::Dictionary<string, Json::JsonElement> properties)
    {
