...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<NewPlanPackagePrice>))]
public sealed record class NewPlanPackagePrice : Orb::ModelBase, Orb::IFromRaw<NewPlanPackagePrice>
{
    /// <summary>
    /// The cadence to bill for this price on.
    /// </summary>
    public required NewPlanPackagePriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewPlanPackagePriceProperties::Cadence>(element)
    ...
    public required NewPlanPackagePriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewPlanPackagePriceProperties::ModelType>(
                    element
    ...
    /// </summary>
    public NewPlanPackagePriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<NewPlanPackagePriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
...
#pragma warning disable CS8618
    ...
    NewPlanPackagePrice(Generic::Dictionary<string, Json::JsonElement> properties)
    {
