...
public sealed record class NewPlanPackagePrice : ModelBase, IFromRaw<NewPlanPackagePrice>
{
    ...
    public required PackageConfig PackageConfig
    {
        ...
        set
        {
            this.Properties["package_config"] = JsonSerializer.SerializeToElement(
                value,
                ModelBase.SerializerOptions
            );
        }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    NewPlanPackagePrice(Dictionary<string, JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static NewPlanPackagePrice FromRawUnchecked(Dictionary<string, JsonElement> properties)
    {
