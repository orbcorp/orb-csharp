...
public sealed record class NewPlanPackagePrice : ModelBase, IFromRaw<NewPlanPackagePrice>
{
    ...
    public required NewPlanPackagePriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewPlanPackagePriceProperties::Cadence>(element)
    ...
    public required NewPlanPackagePriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewPlanPackagePriceProperties::ModelType>(element)
    ...
    public NewPlanPackagePriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewPlanPackagePriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
