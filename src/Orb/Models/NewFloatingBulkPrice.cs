...
public sealed record class NewFloatingBulkPrice : ModelBase, IFromRaw<NewFloatingBulkPrice>
{
    ...
    public required NewFloatingBulkPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewFloatingBulkPriceProperties::Cadence>(element)
    ...
    public required NewFloatingBulkPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewFloatingBulkPriceProperties::ModelType>(element)
    ...
    public NewFloatingBulkPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewFloatingBulkPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    NewFloatingBulkPrice(Dictionary<string, JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static NewFloatingBulkPrice FromRawUnchecked(Dictionary<string, JsonElement> properties)
    {
