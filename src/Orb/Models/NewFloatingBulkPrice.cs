...
public sealed record class NewFloatingBulkPrice : ModelBase
{
    ...
    public required ApiEnum<string, NewFloatingBulkPriceCadence> Cadence
    {
        get
        {
            return ModelBase.GetNotNullClass<ApiEnum<string, NewFloatingBulkPriceCadence>>(
                this.RawData,
                "cadence"
            );
        }
    ...
    public required ApiEnum<string, ModelType> ModelType
    {
        get
        {
            return ModelBase.GetNotNullClass<ApiEnum<string, ModelType>>(
                this.RawData,
                "model_type"
            );
        }
    ...
    public ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            return ModelBase.GetNullableClass<ConversionRateConfig>(
                this.RawData,
