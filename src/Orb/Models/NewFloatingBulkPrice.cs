...
[JsonConverter(typeof(JsonModelConverter<NewFloatingBulkPrice, NewFloatingBulkPriceFromRaw>))]
public sealed record class NewFloatingBulkPrice : JsonModel
{
    /// <summary>
    ...
    public required ApiEnum<string, NewFloatingBulkPriceCadence> Cadence
    {
        get
        {
            return this._rawData.GetNotNullClass<ApiEnum<string, NewFloatingBulkPriceCadence>>(
                "cadence"
            );
        }
    ...
    {
        get { return this._rawData.GetNotNullClass<ApiEnum<string, ModelType>>("model_type"); }
    ...
    public NewFloatingBulkPrice(NewFloatingBulkPrice newFloatingBulkPrice)
        : base(newFloatingBulkPrice) { }
...
#pragma warning restore CS8618
    ...
    /// <inheritdoc cref="NewFloatingBulkPriceFromRaw.FromRawUnchecked"/>
...
class NewFloatingBulkPriceFromRaw : IFromRawJson<NewFloatingBulkPrice>
{
    /// <inheritdoc/>
