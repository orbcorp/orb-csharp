...
public sealed record class NewFloatingBulkPrice : JsonModel
{
    ...
    public required ApiEnum<string, NewFloatingBulkPriceCadence> Cadence
    {
        get
        {
            return JsonModel.GetNotNullClass<ApiEnum<string, NewFloatingBulkPriceCadence>>(
                this.RawData,
                "cadence"
            );
        }
    ...
    public required ApiEnum<string, ModelType> ModelType
    {
        get
        {
            return JsonModel.GetNotNullClass<ApiEnum<string, ModelType>>(
                this.RawData,
                "model_type"
            );
        }
    ...
    public ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            return JsonModel.GetNullableClass<ConversionRateConfig>(
                this.RawData,
