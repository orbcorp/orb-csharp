...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<NewFloatingBulkPrice>))]
public sealed record class NewFloatingBulkPrice
    : Orb::ModelBase,
        Orb::IFromRaw<NewFloatingBulkPrice>
{
    ...
    /// </summary>
    public required NewFloatingBulkPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewFloatingBulkPriceProperties::Cadence>(
                    element
    ...
    public required NewFloatingBulkPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewFloatingBulkPriceProperties::ModelType>(
                    element
    ...
    /// </summary>
    public NewFloatingBulkPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<NewFloatingBulkPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
...
#pragma warning disable CS8618
    ...
    NewFloatingBulkPrice(Generic::Dictionary<string, Json::JsonElement> properties)
    {
