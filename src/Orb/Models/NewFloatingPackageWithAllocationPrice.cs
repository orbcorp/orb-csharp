        ...
        IFromRaw<NewFloatingPackageWithAllocationPrice>
{
    ...
    public required NewFloatingPackageWithAllocationPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewFloatingPackageWithAllocationPriceProperties::Cadence>(
                    element,
    ...
    public required NewFloatingPackageWithAllocationPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewFloatingPackageWithAllocationPriceProperties::ModelType>(
                    element,
                    ModelBase.SerializerOptions
    ...
    public NewFloatingPackageWithAllocationPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewFloatingPackageWithAllocationPriceProperties::ConversionRateConfig?>(
                element,
                ModelBase.SerializerOptions
            );
        }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    NewFloatingPackageWithAllocationPrice(Dictionary<string, JsonElement> properties)
    {
