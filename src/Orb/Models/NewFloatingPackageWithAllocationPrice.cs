...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<NewFloatingPackageWithAllocationPrice>))]
public sealed record class NewFloatingPackageWithAllocationPrice
    : Orb::ModelBase,
        Orb::IFromRaw<NewFloatingPackageWithAllocationPrice>
{
    /// <summary>
    /// The cadence to bill for this price on.
    /// </summary>
    public required NewFloatingPackageWithAllocationPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewFloatingPackageWithAllocationPriceProperties::Cadence>(
                    element
    ...
    public required NewFloatingPackageWithAllocationPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewFloatingPackageWithAllocationPriceProperties::ModelType>(
                    element
    ...
    public required Generic::Dictionary<string, Json::JsonElement> PackageWithAllocationConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<Generic::Dictionary<string, Json::JsonElement>>(
                    element
                ) ?? throw new System::ArgumentNullException("package_with_allocation_config");
        }
        set
        {
            this.Properties["package_with_allocation_config"] =
    ...
    /// </summary>
    public NewFloatingPackageWithAllocationPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<NewFloatingPackageWithAllocationPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
...
#pragma warning disable CS8618
    ...
    NewFloatingPackageWithAllocationPrice(Generic::Dictionary<string, Json::JsonElement> properties)
    {
