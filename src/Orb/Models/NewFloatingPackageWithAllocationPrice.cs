...
public sealed record class NewFloatingPackageWithAllocationPrice : ModelBase
{
    ...
    public required PackageWithAllocationConfig PackageWithAllocationConfig
    {
        get
        {
            return ModelBase.GetNotNullClass<PackageWithAllocationConfig>(
                this.RawData,
    ...
    public NewFloatingPackageWithAllocationPriceConversionRateConfig? ConversionRateConfig
    {
        get
        {
            return ModelBase.GetNullableClass<NewFloatingPackageWithAllocationPriceConversionRateConfig>(
                this.RawData,
...
public record class NewFloatingPackageWithAllocationPriceConversionRateConfig
{
    ...
    public NewFloatingPackageWithAllocationPriceConversionRateConfig(JsonElement json)
    {
        this._json = json;
    }
    ...
    : JsonConverter<NewFloatingPackageWithAllocationPriceConversionRateConfig>
{
    ...
    )
    {
        ...
        switch (conversionRateType)
        {
            ...
            default:
            {
                return new NewFloatingPackageWithAllocationPriceConversionRateConfig(json);
            }
        }
    }
