...
public sealed record class NewPlanUnitWithProrationPrice : ModelBase
{
    ...
    public required ApiEnum<string, NewPlanUnitWithProrationPriceCadence> Cadence
    {
        get
        {
            return ModelBase.GetNotNullClass<ApiEnum<string, NewPlanUnitWithProrationPriceCadence>>(
                this.RawData,
                "cadence"
            );
        }
    ...
    public required NewPlanUnitWithProrationPriceUnitWithProrationConfig UnitWithProrationConfig
    {
        get
        {
            return ModelBase.GetNotNullClass<NewPlanUnitWithProrationPriceUnitWithProrationConfig>(
                this.RawData,
    ...
    public NewPlanUnitWithProrationPriceConversionRateConfig? ConversionRateConfig
    {
        get
        {
            return ModelBase.GetNullableClass<NewPlanUnitWithProrationPriceConversionRateConfig>(
                this.RawData,
