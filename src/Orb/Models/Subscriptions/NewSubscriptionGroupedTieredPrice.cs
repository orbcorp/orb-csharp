...
public sealed record class NewSubscriptionGroupedTieredPrice : JsonModel
{
    ...
    public required global::Orb.Models.Subscriptions.GroupedTieredConfig GroupedTieredConfig
    {
        get
        {
            return JsonModel.GetNotNullClass<global::Orb.Models.Subscriptions.GroupedTieredConfig>(
                this.RawData,
    ...
    public NewSubscriptionGroupedTieredPriceConversionRateConfig? ConversionRateConfig
    {
        get
        {
            return JsonModel.GetNullableClass<NewSubscriptionGroupedTieredPriceConversionRateConfig>(
                this.RawData,
