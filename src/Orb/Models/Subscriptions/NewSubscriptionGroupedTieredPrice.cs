...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<NewSubscriptionGroupedTieredPrice>))]
public sealed record class NewSubscriptionGroupedTieredPrice
    : Orb::ModelBase,
        Orb::IFromRaw<NewSubscriptionGroupedTieredPrice>
{
    /// <summary>
    /// The cadence to bill for this price on.
    /// </summary>
    public required NewSubscriptionGroupedTieredPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewSubscriptionGroupedTieredPriceProperties::Cadence>(
                    element
    ...
    public required NewSubscriptionGroupedTieredPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewSubscriptionGroupedTieredPriceProperties::ModelType>(
                    element
    ...
    /// </summary>
    public NewSubscriptionGroupedTieredPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<NewSubscriptionGroupedTieredPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
...
#pragma warning disable CS8618
    ...
    NewSubscriptionGroupedTieredPrice(Generic::Dictionary<string, Json::JsonElement> properties)
    {
