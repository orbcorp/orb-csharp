        ...
        IFromRaw<NewSubscriptionGroupedTieredPrice>
{
    ...
    public required NewSubscriptionGroupedTieredPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewSubscriptionGroupedTieredPriceProperties::Cadence>(
                    element,
    ...
    public required NewSubscriptionGroupedTieredPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewSubscriptionGroupedTieredPriceProperties::ModelType>(
                    element,
                    ModelBase.SerializerOptions
    ...
    public NewSubscriptionGroupedTieredPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewSubscriptionGroupedTieredPriceProperties::ConversionRateConfig?>(
                element,
                ModelBase.SerializerOptions
            );
        }
