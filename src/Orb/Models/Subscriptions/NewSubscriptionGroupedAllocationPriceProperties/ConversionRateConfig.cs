...
using ConversionRateConfigVariants = Orb.Models.Subscriptions.NewSubscriptionGroupedAllocationPriceProperties.ConversionRateConfigVariants;

namespace Orb.Models.Subscriptions.NewSubscriptionGroupedAllocationPriceProperties;
