...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<NewSubscriptionPackagePrice>))]
public sealed record class NewSubscriptionPackagePrice
    : Orb::ModelBase,
        Orb::IFromRaw<NewSubscriptionPackagePrice>
{
    /// <summary>
    /// The cadence to bill for this price on.
    /// </summary>
    public required NewSubscriptionPackagePriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewSubscriptionPackagePriceProperties::Cadence>(
                    element
    ...
    public required NewSubscriptionPackagePriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewSubscriptionPackagePriceProperties::ModelType>(
                    element
    ...
    public required Models::PackageConfig PackageConfig
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<Models::PackageConfig>(element)
    ...
    /// </summary>
    public NewSubscriptionPackagePriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<NewSubscriptionPackagePriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
...
#pragma warning disable CS8618
    ...
    NewSubscriptionPackagePrice(Generic::Dictionary<string, Json::JsonElement> properties)
    {
