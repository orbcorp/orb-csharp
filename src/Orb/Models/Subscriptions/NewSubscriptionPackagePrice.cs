        ...
        IFromRaw<NewSubscriptionPackagePrice>
{
    ...
    public required NewSubscriptionPackagePriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewSubscriptionPackagePriceProperties::Cadence>(
                    element
    ...
    public required NewSubscriptionPackagePriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewSubscriptionPackagePriceProperties::ModelType>(
                    element
    ...
    public NewSubscriptionPackagePriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewSubscriptionPackagePriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    NewSubscriptionPackagePrice(Dictionary<string, JsonElement> properties)
    {
