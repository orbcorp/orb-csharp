...
using ConversionRateConfigVariants = Orb.Models.Subscriptions.NewSubscriptionPackagePriceProperties.ConversionRateConfigVariants;

namespace Orb.Models.Subscriptions.NewSubscriptionPackagePriceProperties;
