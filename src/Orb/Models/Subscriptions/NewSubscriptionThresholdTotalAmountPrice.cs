...
[Serialization::JsonConverter(
    typeof(Orb::ModelConverter<NewSubscriptionThresholdTotalAmountPrice>)
)]
public sealed record class NewSubscriptionThresholdTotalAmountPrice
    : Orb::ModelBase,
        Orb::IFromRaw<NewSubscriptionThresholdTotalAmountPrice>
{
    /// <summary>
    /// The cadence to bill for this price on.
    /// </summary>
    public required NewSubscriptionThresholdTotalAmountPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewSubscriptionThresholdTotalAmountPriceProperties::Cadence>(
                    element
    ...
    public required NewSubscriptionThresholdTotalAmountPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewSubscriptionThresholdTotalAmountPriceProperties::ModelType>(
                    element
    ...
    /// </summary>
    public NewSubscriptionThresholdTotalAmountPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<NewSubscriptionThresholdTotalAmountPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
