        ...
        IFromRaw<NewSubscriptionThresholdTotalAmountPrice>
{
    ...
    public required NewSubscriptionThresholdTotalAmountPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewSubscriptionThresholdTotalAmountPriceProperties::Cadence>(
                    element,
    ...
    public required NewSubscriptionThresholdTotalAmountPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewSubscriptionThresholdTotalAmountPriceProperties::ModelType>(
                    element,
                    ModelBase.SerializerOptions
    ...
    public NewSubscriptionThresholdTotalAmountPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewSubscriptionThresholdTotalAmountPriceProperties::ConversionRateConfig?>(
                element,
                ModelBase.SerializerOptions
            );
        }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    NewSubscriptionThresholdTotalAmountPrice(Dictionary<string, JsonElement> properties)
    {
