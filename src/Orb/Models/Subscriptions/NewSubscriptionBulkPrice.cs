...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<NewSubscriptionBulkPrice>))]
public sealed record class NewSubscriptionBulkPrice
    : Orb::ModelBase,
        Orb::IFromRaw<NewSubscriptionBulkPrice>
{
    ...
    public required NewSubscriptionBulkPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewSubscriptionBulkPriceProperties::Cadence>(
                    element
    ...
    public required NewSubscriptionBulkPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewSubscriptionBulkPriceProperties::ModelType>(
                    element
    ...
    public NewSubscriptionBulkPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewSubscriptionBulkPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
...
#pragma warning disable CS8618
    ...
    NewSubscriptionBulkPrice(Generic::Dictionary<string, Json::JsonElement> properties)
    {
