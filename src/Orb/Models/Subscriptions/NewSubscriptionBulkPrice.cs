...
[JsonConverter(
    typeof(JsonModelConverter<NewSubscriptionBulkPrice, NewSubscriptionBulkPriceFromRaw>)
)]
public sealed record class NewSubscriptionBulkPrice : JsonModel
{
    /// <summary>
    ...
    public required ApiEnum<string, NewSubscriptionBulkPriceCadence> Cadence
    {
        get
        {
            return this._rawData.GetNotNullClass<ApiEnum<string, NewSubscriptionBulkPriceCadence>>(
                "cadence"
            );
        }
    ...
    public NewSubscriptionBulkPriceConversionRateConfig? ConversionRateConfig
    {
        get
        {
            return this._rawData.GetNullableClass<NewSubscriptionBulkPriceConversionRateConfig>(
...
#pragma warning restore CS8618
    ...
    /// <inheritdoc cref="NewSubscriptionBulkPriceFromRaw.FromRawUnchecked"/>
...
class NewSubscriptionBulkPriceFromRaw : IFromRawJson<NewSubscriptionBulkPrice>
{
    /// <inheritdoc/>
...
public record class NewSubscriptionBulkPriceConversionRateConfig : ModelBase
{
    ...
    public NewSubscriptionBulkPriceConversionRateConfig(JsonElement element)
    {
        this._element = element;
    }
    ...
    : JsonConverter<NewSubscriptionBulkPriceConversionRateConfig>
{
    ...
    )
    {
        ...
        switch (conversionRateType)
        {
            ...
            default:
            {
                return new NewSubscriptionBulkPriceConversionRateConfig(element);
            }
        }
    }
