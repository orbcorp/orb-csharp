...
public sealed record class NewSubscriptionScalableMatrixWithUnitPricingPrice : JsonModel
{
    ...
    public NewSubscriptionScalableMatrixWithUnitPricingPriceConversionRateConfig? ConversionRateConfig
    {
        get
        {
            return this._rawData.GetNullableClass<NewSubscriptionScalableMatrixWithUnitPricingPriceConversionRateConfig>(
...
public sealed record class ScalableMatrixWithUnitPricingConfig : JsonModel
{
    ...
    {
        get { return this._rawData.GetNotNullClass<string>("unit_price"); }
