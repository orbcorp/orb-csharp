        ...
        IFromRaw<NewSubscriptionScalableMatrixWithUnitPricingPrice>
{
    ...
    public required NewSubscriptionScalableMatrixWithUnitPricingPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewSubscriptionScalableMatrixWithUnitPricingPriceProperties::Cadence>(
                    element
    ...
    public required NewSubscriptionScalableMatrixWithUnitPricingPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewSubscriptionScalableMatrixWithUnitPricingPriceProperties::ModelType>(
                    element
    ...
    public NewSubscriptionScalableMatrixWithUnitPricingPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewSubscriptionScalableMatrixWithUnitPricingPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
