...
[Serialization::JsonConverter(
    typeof(Orb::ModelConverter<NewSubscriptionScalableMatrixWithUnitPricingPrice>)
)]
public sealed record class NewSubscriptionScalableMatrixWithUnitPricingPrice
    : Orb::ModelBase,
        Orb::IFromRaw<NewSubscriptionScalableMatrixWithUnitPricingPrice>
{
    /// <summary>
    /// The cadence to bill for this price on.
    /// </summary>
    public required NewSubscriptionScalableMatrixWithUnitPricingPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewSubscriptionScalableMatrixWithUnitPricingPriceProperties::Cadence>(
                    element
    ...
    public required NewSubscriptionScalableMatrixWithUnitPricingPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewSubscriptionScalableMatrixWithUnitPricingPriceProperties::ModelType>(
                    element
    ...
    /// </summary>
    public NewSubscriptionScalableMatrixWithUnitPricingPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<NewSubscriptionScalableMatrixWithUnitPricingPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
