        ...
        IFromRaw<NewSubscriptionGroupedWithProratedMinimumPrice>
{
    ...
    public required NewSubscriptionGroupedWithProratedMinimumPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewSubscriptionGroupedWithProratedMinimumPriceProperties::Cadence>(
                    element,
    ...
    public required NewSubscriptionGroupedWithProratedMinimumPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewSubscriptionGroupedWithProratedMinimumPriceProperties::ModelType>(
                    element,
                    ModelBase.SerializerOptions
    ...
    public NewSubscriptionGroupedWithProratedMinimumPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewSubscriptionGroupedWithProratedMinimumPriceProperties::ConversionRateConfig?>(
                element,
                ModelBase.SerializerOptions
            );
        }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    NewSubscriptionGroupedWithProratedMinimumPrice(Dictionary<string, JsonElement> properties)
    {
