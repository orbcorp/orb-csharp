...
[Serialization::JsonConverter(
    typeof(Orb::ModelConverter<NewSubscriptionGroupedWithProratedMinimumPrice>)
)]
public sealed record class NewSubscriptionGroupedWithProratedMinimumPrice
    : Orb::ModelBase,
        Orb::IFromRaw<NewSubscriptionGroupedWithProratedMinimumPrice>
{
    /// <summary>
    /// The cadence to bill for this price on.
    /// </summary>
    public required NewSubscriptionGroupedWithProratedMinimumPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewSubscriptionGroupedWithProratedMinimumPriceProperties::Cadence>(
                    element
    ...
    public required NewSubscriptionGroupedWithProratedMinimumPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewSubscriptionGroupedWithProratedMinimumPriceProperties::ModelType>(
                    element
    ...
    /// </summary>
    public NewSubscriptionGroupedWithProratedMinimumPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<NewSubscriptionGroupedWithProratedMinimumPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
