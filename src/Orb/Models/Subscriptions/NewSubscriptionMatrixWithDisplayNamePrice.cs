        ...
        IFromRaw<NewSubscriptionMatrixWithDisplayNamePrice>
{
    ...
    public required NewSubscriptionMatrixWithDisplayNamePriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewSubscriptionMatrixWithDisplayNamePriceProperties::Cadence>(
                    element,
    ...
    public required NewSubscriptionMatrixWithDisplayNamePriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewSubscriptionMatrixWithDisplayNamePriceProperties::ModelType>(
                    element,
                    ModelBase.SerializerOptions
    ...
    public NewSubscriptionMatrixWithDisplayNamePriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewSubscriptionMatrixWithDisplayNamePriceProperties::ConversionRateConfig?>(
                element,
                ModelBase.SerializerOptions
            );
        }
