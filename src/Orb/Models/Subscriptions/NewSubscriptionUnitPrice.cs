...
public sealed record class NewSubscriptionUnitPrice : ModelBase, IFromRaw<NewSubscriptionUnitPrice>
{
    ...
    public required NewSubscriptionUnitPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewSubscriptionUnitPriceProperties::Cadence>(element)
    ...
    public required NewSubscriptionUnitPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewSubscriptionUnitPriceProperties::ModelType>(
                    element
    ...
    public NewSubscriptionUnitPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewSubscriptionUnitPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
