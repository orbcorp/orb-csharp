...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<NewSubscriptionUnitPrice>))]
public sealed record class NewSubscriptionUnitPrice
    : Orb::ModelBase,
        Orb::IFromRaw<NewSubscriptionUnitPrice>
{
    /// <summary>
    /// The cadence to bill for this price on.
    /// </summary>
    public required NewSubscriptionUnitPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewSubscriptionUnitPriceProperties::Cadence>(
                    element
    ...
    public required NewSubscriptionUnitPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewSubscriptionUnitPriceProperties::ModelType>(
                    element
    ...
    /// </summary>
    public NewSubscriptionUnitPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<NewSubscriptionUnitPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
...
#pragma warning disable CS8618
    ...
    NewSubscriptionUnitPrice(Generic::Dictionary<string, Json::JsonElement> properties)
    {
