...
using ConversionRateConfigVariants = Orb.Models.Subscriptions.NewSubscriptionTieredPriceProperties.ConversionRateConfigVariants;

namespace Orb.Models.Subscriptions.NewSubscriptionTieredPriceProperties;
