...
using SubscriptionFetchSchedulePageResponseProperties = Orb.Models.Subscriptions.SubscriptionFetchSchedulePageResponseProperties;
using System = System;

namespace Orb.Models.Subscriptions;

[Serialization::JsonConverter(typeof(Orb::ModelConverter<SubscriptionFetchSchedulePageResponse>))]
public sealed record class SubscriptionFetchSchedulePageResponse
    : Orb::ModelBase,
        Orb::IFromRaw<SubscriptionFetchSchedulePageResponse>
{
    public required Generic::List<SubscriptionFetchSchedulePageResponseProperties::Data> Data
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<Generic::List<SubscriptionFetchSchedulePageResponseProperties::Data>>(
                    element
...
#pragma warning disable CS8618
    ...
    SubscriptionFetchSchedulePageResponse(Generic::Dictionary<string, Json::JsonElement> properties)
    {
