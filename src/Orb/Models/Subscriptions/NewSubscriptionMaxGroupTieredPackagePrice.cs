...
[Serialization::JsonConverter(
    typeof(Orb::ModelConverter<NewSubscriptionMaxGroupTieredPackagePrice>)
)]
public sealed record class NewSubscriptionMaxGroupTieredPackagePrice
    : Orb::ModelBase,
        Orb::IFromRaw<NewSubscriptionMaxGroupTieredPackagePrice>
{
    /// <summary>
    /// The cadence to bill for this price on.
    /// </summary>
    public required NewSubscriptionMaxGroupTieredPackagePriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewSubscriptionMaxGroupTieredPackagePriceProperties::Cadence>(
                    element
    ...
    public required NewSubscriptionMaxGroupTieredPackagePriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewSubscriptionMaxGroupTieredPackagePriceProperties::ModelType>(
                    element
    ...
    /// </summary>
    public NewSubscriptionMaxGroupTieredPackagePriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<NewSubscriptionMaxGroupTieredPackagePriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
