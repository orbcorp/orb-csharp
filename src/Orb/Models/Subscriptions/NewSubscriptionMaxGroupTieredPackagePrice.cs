        ...
        IFromRaw<NewSubscriptionMaxGroupTieredPackagePrice>
{
    ...
    public required NewSubscriptionMaxGroupTieredPackagePriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewSubscriptionMaxGroupTieredPackagePriceProperties::Cadence>(
                    element,
    ...
    public required NewSubscriptionMaxGroupTieredPackagePriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewSubscriptionMaxGroupTieredPackagePriceProperties::ModelType>(
                    element,
                    ModelBase.SerializerOptions
    ...
    public NewSubscriptionMaxGroupTieredPackagePriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewSubscriptionMaxGroupTieredPackagePriceProperties::ConversionRateConfig?>(
                element,
                ModelBase.SerializerOptions
            );
        }
