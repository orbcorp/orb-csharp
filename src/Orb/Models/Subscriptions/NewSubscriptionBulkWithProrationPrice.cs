        ...
        IFromRaw<NewSubscriptionBulkWithProrationPrice>
{
    ...
    public required NewSubscriptionBulkWithProrationPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewSubscriptionBulkWithProrationPriceProperties::Cadence>(
                    element,
                    ModelBase.SerializerOptions
    ...
    public required NewSubscriptionBulkWithProrationPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewSubscriptionBulkWithProrationPriceProperties::ModelType>(
                    element,
                    ModelBase.SerializerOptions
    ...
    public NewSubscriptionBulkWithProrationPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewSubscriptionBulkWithProrationPriceProperties::ConversionRateConfig?>(
                element,
                ModelBase.SerializerOptions
            );
        }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    NewSubscriptionBulkWithProrationPrice(Dictionary<string, JsonElement> properties)
    {
