...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<NewSubscriptionBulkWithProrationPrice>))]
public sealed record class NewSubscriptionBulkWithProrationPrice
    : Orb::ModelBase,
        Orb::IFromRaw<NewSubscriptionBulkWithProrationPrice>
{
    ...
    /// </summary>
    public required NewSubscriptionBulkWithProrationPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewSubscriptionBulkWithProrationPriceProperties::Cadence>(
                    element
    ...
    public required NewSubscriptionBulkWithProrationPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewSubscriptionBulkWithProrationPriceProperties::ModelType>(
                    element
    ...
    /// </summary>
    public NewSubscriptionBulkWithProrationPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<NewSubscriptionBulkWithProrationPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
...
#pragma warning disable CS8618
    ...
    NewSubscriptionBulkWithProrationPrice(Generic::Dictionary<string, Json::JsonElement> properties)
    {
