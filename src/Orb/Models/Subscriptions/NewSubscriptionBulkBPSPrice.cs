...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<NewSubscriptionBulkBPSPrice>))]
public sealed record class NewSubscriptionBulkBPSPrice
    : Orb::ModelBase,
        Orb::IFromRaw<NewSubscriptionBulkBPSPrice>
{
    public required Models::BulkBPSConfig BulkBPSConfig
    {
        get
        {
            if (!this.Properties.TryGetValue("bulk_bps_config", out Json::JsonElement element))
                throw new System::ArgumentOutOfRangeException(
                    "bulk_bps_config",
                    "Missing required argument"
                );

            return Json::JsonSerializer.Deserialize<Models::BulkBPSConfig>(element)
                ?? throw new System::ArgumentNullException("bulk_bps_config");
        }
        set { this.Properties["bulk_bps_config"] = Json::JsonSerializer.SerializeToElement(value); }
    }

    /// <summary>
    /// The cadence to bill for this price on.
    /// </summary>
    public required NewSubscriptionBulkBPSPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewSubscriptionBulkBPSPriceProperties::Cadence>(
                    element
    ...
    public required NewSubscriptionBulkBPSPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewSubscriptionBulkBPSPriceProperties::ModelType>(
                    element
    ...
    /// </summary>
    public NewSubscriptionBulkBPSPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<NewSubscriptionBulkBPSPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
    ...
    public NewSubscriptionBulkBPSPrice() { }

#pragma warning disable CS8618
    [CodeAnalysis::SetsRequiredMembers]
    NewSubscriptionBulkBPSPrice(Generic::Dictionary<string, Json::JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static NewSubscriptionBulkBPSPrice FromRawUnchecked(
