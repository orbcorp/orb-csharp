...
[JsonConverter(typeof(ModelConverter<NewSubscriptionBulkBPSPrice>))]
public sealed record class NewSubscriptionBulkBPSPrice
    : ModelBase,
        IFromRaw<NewSubscriptionBulkBPSPrice>
{
    ...
    public required NewSubscriptionBulkBPSPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewSubscriptionBulkBPSPriceProperties::Cadence>(
                    element,
                    ModelBase.SerializerOptions
    ...
    public required NewSubscriptionBulkBPSPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewSubscriptionBulkBPSPriceProperties::ModelType>(
                    element,
                    ModelBase.SerializerOptions
    ...
    public NewSubscriptionBulkBPSPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewSubscriptionBulkBPSPriceProperties::ConversionRateConfig?>(
                element,
                ModelBase.SerializerOptions
            );
        }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    NewSubscriptionBulkBPSPrice(Dictionary<string, JsonElement> properties)
    {
