        ...
        IFromRaw<NewSubscriptionUnitWithPercentPrice>
{
    ...
    public required NewSubscriptionUnitWithPercentPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewSubscriptionUnitWithPercentPriceProperties::Cadence>(
                    element
    ...
    public required NewSubscriptionUnitWithPercentPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewSubscriptionUnitWithPercentPriceProperties::ModelType>(
                    element
    ...
    public NewSubscriptionUnitWithPercentPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewSubscriptionUnitWithPercentPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
