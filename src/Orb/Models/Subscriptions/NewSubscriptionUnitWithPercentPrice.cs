...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<NewSubscriptionUnitWithPercentPrice>))]
public sealed record class NewSubscriptionUnitWithPercentPrice
    : Orb::ModelBase,
        Orb::IFromRaw<NewSubscriptionUnitWithPercentPrice>
{
    /// <summary>
    /// The cadence to bill for this price on.
    /// </summary>
    public required NewSubscriptionUnitWithPercentPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewSubscriptionUnitWithPercentPriceProperties::Cadence>(
                    element
    ...
    public required NewSubscriptionUnitWithPercentPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewSubscriptionUnitWithPercentPriceProperties::ModelType>(
                    element
    ...
    public required Generic::Dictionary<string, Json::JsonElement> UnitWithPercentConfig
    {
        get
        {
            if (
        ...
        set
        {
            this.Properties["unit_with_percent_config"] = Json::JsonSerializer.SerializeToElement(
                value
            );
        }
    }
    ...
    /// </summary>
    public NewSubscriptionUnitWithPercentPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<NewSubscriptionUnitWithPercentPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
...
#pragma warning disable CS8618
    ...
    NewSubscriptionUnitWithPercentPrice(Generic::Dictionary<string, Json::JsonElement> properties)
    {
