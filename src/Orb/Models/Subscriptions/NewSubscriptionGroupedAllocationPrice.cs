...
public sealed record class NewSubscriptionGroupedAllocationPrice : JsonModel
{
    /// <summary>
    ...
    public required global::Orb.Models.Subscriptions.GroupedAllocationConfig GroupedAllocationConfig
    {
        get
        {
            return JsonModel.GetNotNullClass<global::Orb.Models.Subscriptions.GroupedAllocationConfig>(
                this.RawData,
    ...
    public NewSubscriptionGroupedAllocationPriceConversionRateConfig? ConversionRateConfig
    {
        get
        {
            return JsonModel.GetNullableClass<NewSubscriptionGroupedAllocationPriceConversionRateConfig>(
                this.RawData,
...
#pragma warning restore CS8618
    ...
    /// <inheritdoc cref="NewSubscriptionGroupedAllocationPriceFromRaw.FromRawUnchecked"/>
...
class NewSubscriptionGroupedAllocationPriceFromRaw
    : IFromRawJson<NewSubscriptionGroupedAllocationPrice>
{
    /// <inheritdoc/>
...
public record class NewSubscriptionGroupedAllocationPriceConversionRateConfig : ModelBase
{
    ...
    public NewSubscriptionGroupedAllocationPriceConversionRateConfig(JsonElement element)
    {
        this._element = element;
    }
    ...
    : JsonConverter<NewSubscriptionGroupedAllocationPriceConversionRateConfig>
{
    ...
    )
    {
        ...
        switch (conversionRateType)
        {
            ...
            default:
            {
                return new NewSubscriptionGroupedAllocationPriceConversionRateConfig(element);
            }
        }
    }
