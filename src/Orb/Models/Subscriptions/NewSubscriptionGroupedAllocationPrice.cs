...
public sealed record class NewSubscriptionGroupedAllocationPrice : JsonModel
{
    ...
    public NewSubscriptionGroupedAllocationPriceConversionRateConfig? ConversionRateConfig
    {
        ...
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableClass<NewSubscriptionGroupedAllocationPriceConversionRateConfig>(
...
public sealed record class GroupedAllocationConfig : JsonModel
{
    ...
    public required string OverageUnitRate
    {
        ...
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<string>("overage_unit_rate");
        }
