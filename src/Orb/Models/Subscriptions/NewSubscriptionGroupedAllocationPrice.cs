        ...
        IFromRaw<NewSubscriptionGroupedAllocationPrice>
{
    ...
    public required NewSubscriptionGroupedAllocationPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewSubscriptionGroupedAllocationPriceProperties::Cadence>(
                    element
    ...
    public required Dictionary<string, JsonElement> GroupedAllocationConfig
    {
        ...
        set
        {
            this.Properties["grouped_allocation_config"] = JsonSerializer.SerializeToElement(value);
        }
    }
    ...
    public required NewSubscriptionGroupedAllocationPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewSubscriptionGroupedAllocationPriceProperties::ModelType>(
                    element
    ...
    public NewSubscriptionGroupedAllocationPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewSubscriptionGroupedAllocationPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
