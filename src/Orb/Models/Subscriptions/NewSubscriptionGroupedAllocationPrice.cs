...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<NewSubscriptionGroupedAllocationPrice>))]
public sealed record class NewSubscriptionGroupedAllocationPrice
    : Orb::ModelBase,
        Orb::IFromRaw<NewSubscriptionGroupedAllocationPrice>
{
    /// <summary>
    /// The cadence to bill for this price on.
    /// </summary>
    public required NewSubscriptionGroupedAllocationPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewSubscriptionGroupedAllocationPriceProperties::Cadence>(
                    element
    ...
    public required Generic::Dictionary<string, Json::JsonElement> GroupedAllocationConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<Generic::Dictionary<string, Json::JsonElement>>(
                    element
                ) ?? throw new System::ArgumentNullException("grouped_allocation_config");
        }
        set
        {
            this.Properties["grouped_allocation_config"] = Json::JsonSerializer.SerializeToElement(
                value
            );
        }
    }
    ...
    public required NewSubscriptionGroupedAllocationPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewSubscriptionGroupedAllocationPriceProperties::ModelType>(
                    element
    ...
    /// </summary>
    public NewSubscriptionGroupedAllocationPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<NewSubscriptionGroupedAllocationPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
...
#pragma warning disable CS8618
    ...
    NewSubscriptionGroupedAllocationPrice(Generic::Dictionary<string, Json::JsonElement> properties)
    {
