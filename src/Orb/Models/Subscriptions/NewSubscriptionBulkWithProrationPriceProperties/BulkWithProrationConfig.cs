...
using BulkWithProrationConfigProperties = Orb.Models.Subscriptions.NewSubscriptionBulkWithProrationPriceProperties.BulkWithProrationConfigProperties;

namespace Orb.Models.Subscriptions.NewSubscriptionBulkWithProrationPriceProperties;
