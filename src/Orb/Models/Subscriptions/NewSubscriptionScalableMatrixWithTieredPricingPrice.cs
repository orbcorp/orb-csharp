        ...
        IFromRaw<NewSubscriptionScalableMatrixWithTieredPricingPrice>
{
    ...
    public required NewSubscriptionScalableMatrixWithTieredPricingPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewSubscriptionScalableMatrixWithTieredPricingPriceProperties::Cadence>(
                    element,
    ...
    public required NewSubscriptionScalableMatrixWithTieredPricingPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewSubscriptionScalableMatrixWithTieredPricingPriceProperties::ModelType>(
                    element,
                    ModelBase.SerializerOptions
    ...
    public NewSubscriptionScalableMatrixWithTieredPricingPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewSubscriptionScalableMatrixWithTieredPricingPriceProperties::ConversionRateConfig?>(
                element,
                ModelBase.SerializerOptions
            );
        }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    NewSubscriptionScalableMatrixWithTieredPricingPrice(Dictionary<string, JsonElement> properties)
    {
