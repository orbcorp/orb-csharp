...
using ConversionRateConfigVariants = Orb.Models.Subscriptions.NewSubscriptionUnitPriceProperties.ConversionRateConfigVariants;

namespace Orb.Models.Subscriptions.NewSubscriptionUnitPriceProperties;
