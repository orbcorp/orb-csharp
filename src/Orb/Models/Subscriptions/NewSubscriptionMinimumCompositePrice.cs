...
public sealed record class NewSubscriptionMinimumCompositePrice : ModelBase
{
    ...
    public required global::Orb.Models.Subscriptions.MinimumConfig MinimumConfig
    {
        get
        {
            return ModelBase.GetNotNullClass<global::Orb.Models.Subscriptions.MinimumConfig>(
                this.RawData,
                "minimum_config"
            );
        }
    ...
    public NewSubscriptionMinimumCompositePriceConversionRateConfig? ConversionRateConfig
    {
        get
        {
            return ModelBase.GetNullableClass<NewSubscriptionMinimumCompositePriceConversionRateConfig>(
                this.RawData,
