...
public sealed record class NewSubscriptionMinimumCompositePrice : JsonModel
{
    ...
    public required global::Orb.Models.Subscriptions.MinimumConfig MinimumConfig
    {
        get
        {
            return JsonModel.GetNotNullClass<global::Orb.Models.Subscriptions.MinimumConfig>(
                this.RawData,
                "minimum_config"
            );
        }
    ...
    public NewSubscriptionMinimumCompositePriceConversionRateConfig? ConversionRateConfig
    {
        get
        {
            return JsonModel.GetNullableClass<NewSubscriptionMinimumCompositePriceConversionRateConfig>(
                this.RawData,
