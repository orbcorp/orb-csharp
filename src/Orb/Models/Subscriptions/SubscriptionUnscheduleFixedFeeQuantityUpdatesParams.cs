...
/// </summary>
public record class SubscriptionUnscheduleFixedFeeQuantityUpdatesParams : ParamsBase
{
...
#pragma warning restore CS8618
    ...
    public virtual bool Equals(SubscriptionUnscheduleFixedFeeQuantityUpdatesParams? other)
    {
        if (other == null)
        {
            return false;
