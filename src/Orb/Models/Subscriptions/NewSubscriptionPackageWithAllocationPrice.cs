...
public sealed record class NewSubscriptionPackageWithAllocationPrice : JsonModel
{
    /// <summary>
    ...
    public required global::Orb.Models.Subscriptions.PackageWithAllocationConfig PackageWithAllocationConfig
    {
        get
        {
            return JsonModel.GetNotNullClass<global::Orb.Models.Subscriptions.PackageWithAllocationConfig>(
                this.RawData,
    ...
    public NewSubscriptionPackageWithAllocationPriceConversionRateConfig? ConversionRateConfig
    {
        get
        {
            return JsonModel.GetNullableClass<NewSubscriptionPackageWithAllocationPriceConversionRateConfig>(
                this.RawData,
...
#pragma warning restore CS8618
    ...
    /// <inheritdoc cref="NewSubscriptionPackageWithAllocationPriceFromRaw.FromRawUnchecked"/>
...
class NewSubscriptionPackageWithAllocationPriceFromRaw
    : IFromRawJson<NewSubscriptionPackageWithAllocationPrice>
{
    /// <inheritdoc/>
...
public record class NewSubscriptionPackageWithAllocationPriceConversionRateConfig : ModelBase
{
    ...
    public NewSubscriptionPackageWithAllocationPriceConversionRateConfig(JsonElement element)
    {
        this._element = element;
    }
    ...
    : JsonConverter<NewSubscriptionPackageWithAllocationPriceConversionRateConfig>
{
    ...
    )
    {
        ...
        switch (conversionRateType)
        {
            ...
            default:
            {
                return new NewSubscriptionPackageWithAllocationPriceConversionRateConfig(element);
            }
        }
    }
