        ...
        IFromRaw<NewSubscriptionPackageWithAllocationPrice>
{
    ...
    public required NewSubscriptionPackageWithAllocationPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewSubscriptionPackageWithAllocationPriceProperties::Cadence>(
                    element
    ...
    public required NewSubscriptionPackageWithAllocationPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewSubscriptionPackageWithAllocationPriceProperties::ModelType>(
                    element
    ...
    public NewSubscriptionPackageWithAllocationPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewSubscriptionPackageWithAllocationPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    NewSubscriptionPackageWithAllocationPrice(Dictionary<string, JsonElement> properties)
    {
