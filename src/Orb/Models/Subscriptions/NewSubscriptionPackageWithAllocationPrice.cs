...
public sealed record class NewSubscriptionPackageWithAllocationPrice : JsonModel
{
    ...
    public NewSubscriptionPackageWithAllocationPriceConversionRateConfig? ConversionRateConfig
    {
        ...
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableClass<NewSubscriptionPackageWithAllocationPriceConversionRateConfig>(
...
public record class NewSubscriptionPackageWithAllocationPriceConversionRateConfig : ModelBase
{
    ...
    public virtual bool Equals(
        NewSubscriptionPackageWithAllocationPriceConversionRateConfig? other
    ) =>
        other != null
