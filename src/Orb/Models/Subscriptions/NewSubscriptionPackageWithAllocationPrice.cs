...
[Serialization::JsonConverter(
    typeof(Orb::ModelConverter<NewSubscriptionPackageWithAllocationPrice>)
)]
public sealed record class NewSubscriptionPackageWithAllocationPrice
    : Orb::ModelBase,
        Orb::IFromRaw<NewSubscriptionPackageWithAllocationPrice>
{
    /// <summary>
    /// The cadence to bill for this price on.
    /// </summary>
    public required NewSubscriptionPackageWithAllocationPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewSubscriptionPackageWithAllocationPriceProperties::Cadence>(
                    element
    ...
    public required NewSubscriptionPackageWithAllocationPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewSubscriptionPackageWithAllocationPriceProperties::ModelType>(
                    element
    ...
    /// </summary>
    public NewSubscriptionPackageWithAllocationPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<NewSubscriptionPackageWithAllocationPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
