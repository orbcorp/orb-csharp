        ...
        IFromRaw<NewSubscriptionCumulativeGroupedBulkPrice>
{
    ...
    public required NewSubscriptionCumulativeGroupedBulkPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewSubscriptionCumulativeGroupedBulkPriceProperties::Cadence>(
                    element
    ...
    public required NewSubscriptionCumulativeGroupedBulkPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewSubscriptionCumulativeGroupedBulkPriceProperties::ModelType>(
                    element
    ...
    public NewSubscriptionCumulativeGroupedBulkPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewSubscriptionCumulativeGroupedBulkPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
