...
[Serialization::JsonConverter(
    typeof(Orb::ModelConverter<NewSubscriptionCumulativeGroupedBulkPrice>)
)]
public sealed record class NewSubscriptionCumulativeGroupedBulkPrice
    : Orb::ModelBase,
        Orb::IFromRaw<NewSubscriptionCumulativeGroupedBulkPrice>
{
    /// <summary>
    /// The cadence to bill for this price on.
    /// </summary>
    public required NewSubscriptionCumulativeGroupedBulkPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewSubscriptionCumulativeGroupedBulkPriceProperties::Cadence>(
                    element
    ...
    public required NewSubscriptionCumulativeGroupedBulkPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewSubscriptionCumulativeGroupedBulkPriceProperties::ModelType>(
                    element
    ...
    /// </summary>
    public NewSubscriptionCumulativeGroupedBulkPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<NewSubscriptionCumulativeGroupedBulkPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
