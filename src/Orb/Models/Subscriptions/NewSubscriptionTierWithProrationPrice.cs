...
[JsonConverter(typeof(ModelConverter<NewSubscriptionTierWithProrationPrice>))]
public sealed record class NewSubscriptionTierWithProrationPrice
    : ModelBase,
        IFromRaw<NewSubscriptionTierWithProrationPrice>
{
    /// <summary>
    ...
    public required NewSubscriptionTierWithProrationPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewSubscriptionTierWithProrationPriceProperties::Cadence>(
                    element
    ...
    public required NewSubscriptionTierWithProrationPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewSubscriptionTierWithProrationPriceProperties::ModelType>(
                    element
    ...
    public NewSubscriptionTierWithProrationPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewSubscriptionTierWithProrationPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    NewSubscriptionTierWithProrationPrice(Dictionary<string, JsonElement> properties)
    {
