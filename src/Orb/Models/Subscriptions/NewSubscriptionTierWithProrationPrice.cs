...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<NewSubscriptionTierWithProrationPrice>))]
public sealed record class NewSubscriptionTierWithProrationPrice
    : Orb::ModelBase,
        Orb::IFromRaw<NewSubscriptionTierWithProrationPrice>
{
    /// <summary>
    /// The cadence to bill for this price on.
    /// </summary>
    public required NewSubscriptionTierWithProrationPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewSubscriptionTierWithProrationPriceProperties::Cadence>(
                    element
    ...
    public required NewSubscriptionTierWithProrationPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewSubscriptionTierWithProrationPriceProperties::ModelType>(
                    element
    ...
    public required Generic::Dictionary<string, Json::JsonElement> TieredWithProrationConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<Generic::Dictionary<string, Json::JsonElement>>(
                    element
                ) ?? throw new System::ArgumentNullException("tiered_with_proration_config");
        }
        set
        {
            this.Properties["tiered_with_proration_config"] =
    ...
    /// </summary>
    public NewSubscriptionTierWithProrationPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<NewSubscriptionTierWithProrationPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
    ...
    public NewSubscriptionTierWithProrationPrice() { }

#pragma warning disable CS8618
    [CodeAnalysis::SetsRequiredMembers]
    NewSubscriptionTierWithProrationPrice(Generic::Dictionary<string, Json::JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static NewSubscriptionTierWithProrationPrice FromRawUnchecked(
