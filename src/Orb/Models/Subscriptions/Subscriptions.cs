...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<Subscriptions>))]
public sealed record class Subscriptions : Orb::ModelBase, Orb::IFromRaw<Subscriptions>
{
    public required Generic::List<Subscription> Data
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<Generic::List<Subscription>>(element)
...
#pragma warning disable CS8618
    ...
    Subscriptions(Generic::Dictionary<string, Json::JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static Subscriptions FromRawUnchecked(
