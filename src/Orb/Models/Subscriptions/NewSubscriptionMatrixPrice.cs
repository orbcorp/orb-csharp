...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<NewSubscriptionMatrixPrice>))]
public sealed record class NewSubscriptionMatrixPrice
    : Orb::ModelBase,
        Orb::IFromRaw<NewSubscriptionMatrixPrice>
{
    /// <summary>
    /// The cadence to bill for this price on.
    /// </summary>
    public required NewSubscriptionMatrixPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewSubscriptionMatrixPriceProperties::Cadence>(
                    element
    ...
    public required Models::MatrixConfig MatrixConfig
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<Models::MatrixConfig>(element)
    ...
    public required NewSubscriptionMatrixPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewSubscriptionMatrixPriceProperties::ModelType>(
                    element
    ...
    /// </summary>
    public NewSubscriptionMatrixPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<NewSubscriptionMatrixPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
...
#pragma warning disable CS8618
    ...
    NewSubscriptionMatrixPrice(Generic::Dictionary<string, Json::JsonElement> properties)
    {
