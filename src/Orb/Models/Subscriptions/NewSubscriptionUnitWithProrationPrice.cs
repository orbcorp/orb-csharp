...
public sealed record class NewSubscriptionUnitWithProrationPrice : JsonModel
{
    /// <summary>
    ...
    public required global::Orb.Models.Subscriptions.UnitWithProrationConfig UnitWithProrationConfig
    {
        get
        {
            return JsonModel.GetNotNullClass<global::Orb.Models.Subscriptions.UnitWithProrationConfig>(
                this.RawData,
    ...
    public NewSubscriptionUnitWithProrationPriceConversionRateConfig? ConversionRateConfig
    {
        get
        {
            return JsonModel.GetNullableClass<NewSubscriptionUnitWithProrationPriceConversionRateConfig>(
                this.RawData,
...
#pragma warning restore CS8618
    ...
    /// <inheritdoc cref="NewSubscriptionUnitWithProrationPriceFromRaw.FromRawUnchecked"/>
...
class NewSubscriptionUnitWithProrationPriceFromRaw
    : IFromRawJson<NewSubscriptionUnitWithProrationPrice>
{
    /// <inheritdoc/>
...
public record class NewSubscriptionUnitWithProrationPriceConversionRateConfig : ModelBase
{
    ...
    public NewSubscriptionUnitWithProrationPriceConversionRateConfig(JsonElement element)
    {
        this._element = element;
    }
    ...
    : JsonConverter<NewSubscriptionUnitWithProrationPriceConversionRateConfig>
{
    ...
    )
    {
        ...
        switch (conversionRateType)
        {
            ...
            default:
            {
                return new NewSubscriptionUnitWithProrationPriceConversionRateConfig(element);
            }
        }
    }
