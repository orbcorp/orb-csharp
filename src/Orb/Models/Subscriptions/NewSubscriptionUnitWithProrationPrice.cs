...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<NewSubscriptionUnitWithProrationPrice>))]
public sealed record class NewSubscriptionUnitWithProrationPrice
    : Orb::ModelBase,
        Orb::IFromRaw<NewSubscriptionUnitWithProrationPrice>
{
    /// <summary>
    ...
    public required NewSubscriptionUnitWithProrationPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewSubscriptionUnitWithProrationPriceProperties::Cadence>(
                    element
    ...
    public required NewSubscriptionUnitWithProrationPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewSubscriptionUnitWithProrationPriceProperties::ModelType>(
                    element
    ...
    public NewSubscriptionUnitWithProrationPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewSubscriptionUnitWithProrationPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
...
#pragma warning disable CS8618
    ...
    NewSubscriptionUnitWithProrationPrice(Generic::Dictionary<string, Json::JsonElement> properties)
    {
