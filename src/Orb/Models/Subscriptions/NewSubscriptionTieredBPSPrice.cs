...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<NewSubscriptionTieredBPSPrice>))]
public sealed record class NewSubscriptionTieredBPSPrice
    : Orb::ModelBase,
        Orb::IFromRaw<NewSubscriptionTieredBPSPrice>
{
    /// <summary>
    /// The cadence to bill for this price on.
    /// </summary>
    public required NewSubscriptionTieredBPSPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewSubscriptionTieredBPSPriceProperties::Cadence>(
                    element
    ...
    public required NewSubscriptionTieredBPSPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewSubscriptionTieredBPSPriceProperties::ModelType>(
                    element
    ...
    public required Models::TieredBPSConfig TieredBPSConfig
    {
        get
        {
            if (!this.Properties.TryGetValue("tiered_bps_config", out Json::JsonElement element))
                throw new System::ArgumentOutOfRangeException(
                    "tiered_bps_config",
                    "Missing required argument"
                );

            return Json::JsonSerializer.Deserialize<Models::TieredBPSConfig>(element)
                ?? throw new System::ArgumentNullException("tiered_bps_config");
        }
        set
        {
            this.Properties["tiered_bps_config"] = Json::JsonSerializer.SerializeToElement(value);
        }
    }
    ...
    /// </summary>
    public NewSubscriptionTieredBPSPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<NewSubscriptionTieredBPSPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
...
#pragma warning disable CS8618
    ...
    NewSubscriptionTieredBPSPrice(Generic::Dictionary<string, Json::JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static NewSubscriptionTieredBPSPrice FromRawUnchecked(
