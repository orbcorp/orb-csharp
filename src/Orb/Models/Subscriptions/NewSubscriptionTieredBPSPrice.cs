...
[JsonConverter(typeof(ModelConverter<NewSubscriptionTieredBPSPrice>))]
public sealed record class NewSubscriptionTieredBPSPrice
    : ModelBase,
        IFromRaw<NewSubscriptionTieredBPSPrice>
{
    /// <summary>
    ...
    public required NewSubscriptionTieredBPSPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewSubscriptionTieredBPSPriceProperties::Cadence>(
                    element
    ...
    public required NewSubscriptionTieredBPSPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewSubscriptionTieredBPSPriceProperties::ModelType>(
                    element
    ...
    public required Models::TieredBPSConfig TieredBPSConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<Models::TieredBPSConfig>(element)
    ...
    public NewSubscriptionTieredBPSPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewSubscriptionTieredBPSPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    NewSubscriptionTieredBPSPrice(Dictionary<string, JsonElement> properties)
    {
