...
public sealed record class NewSubscriptionMatrixWithAllocationPrice : ModelBase
{
    /// <summary>
    ...
    public NewSubscriptionMatrixWithAllocationPriceConversionRateConfig? ConversionRateConfig
    {
        get
        {
            return ModelBase.GetNullableClass<NewSubscriptionMatrixWithAllocationPriceConversionRateConfig>(
                this.RawData,
