...
[JsonConverter(
    typeof(JsonModelConverter<
        ...
        NewSubscriptionMatrixWithAllocationPriceFromRaw
    >)
)]
public sealed record class NewSubscriptionMatrixWithAllocationPrice : JsonModel
{
    /// <summary>
    ...
    public NewSubscriptionMatrixWithAllocationPriceConversionRateConfig? ConversionRateConfig
    {
        ...
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableClass<NewSubscriptionMatrixWithAllocationPriceConversionRateConfig>(
...
#pragma warning restore CS8618
    ...
    /// <inheritdoc cref="NewSubscriptionMatrixWithAllocationPriceFromRaw.FromRawUnchecked"/>
...
class NewSubscriptionMatrixWithAllocationPriceFromRaw
    : IFromRawJson<NewSubscriptionMatrixWithAllocationPrice>
{
    /// <inheritdoc/>
    public NewSubscriptionMatrixWithAllocationPrice FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => NewSubscriptionMatrixWithAllocationPrice.FromRawUnchecked(rawData);
}
...
public record class NewSubscriptionMatrixWithAllocationPriceConversionRateConfig : ModelBase
{
    ...
    public NewSubscriptionMatrixWithAllocationPriceConversionRateConfig(JsonElement element)
    {
        this._element = element;
    }
    ...
    public virtual bool Equals(
        NewSubscriptionMatrixWithAllocationPriceConversionRateConfig? other
    ) =>
        other != null
    ...
    : JsonConverter<NewSubscriptionMatrixWithAllocationPriceConversionRateConfig>
{
    ...
    )
    {
        ...
        switch (conversionRateType)
        {
            ...
            default:
            {
                return new NewSubscriptionMatrixWithAllocationPriceConversionRateConfig(element);
            }
        }
    }
