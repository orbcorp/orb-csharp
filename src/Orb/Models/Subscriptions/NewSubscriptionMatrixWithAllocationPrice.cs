...
[Serialization::JsonConverter(
    typeof(Orb::ModelConverter<NewSubscriptionMatrixWithAllocationPrice>)
)]
public sealed record class NewSubscriptionMatrixWithAllocationPrice
    : Orb::ModelBase,
        Orb::IFromRaw<NewSubscriptionMatrixWithAllocationPrice>
{
    /// <summary>
    /// The cadence to bill for this price on.
    /// </summary>
    public required NewSubscriptionMatrixWithAllocationPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewSubscriptionMatrixWithAllocationPriceProperties::Cadence>(
                    element
    ...
    public required Models::MatrixWithAllocationConfig MatrixWithAllocationConfig
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<Models::MatrixWithAllocationConfig>(element)
    ...
    public required NewSubscriptionMatrixWithAllocationPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewSubscriptionMatrixWithAllocationPriceProperties::ModelType>(
                    element
    ...
    /// </summary>
    public NewSubscriptionMatrixWithAllocationPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<NewSubscriptionMatrixWithAllocationPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
