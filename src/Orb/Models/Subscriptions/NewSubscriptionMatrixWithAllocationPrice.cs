        ...
        IFromRaw<NewSubscriptionMatrixWithAllocationPrice>
{
    ...
    public required MatrixWithAllocationConfig MatrixWithAllocationConfig
    {
        ...
        set
        {
            this.Properties["matrix_with_allocation_config"] = JsonSerializer.SerializeToElement(
                value,
                ModelBase.SerializerOptions
            );
        }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    NewSubscriptionMatrixWithAllocationPrice(Dictionary<string, JsonElement> properties)
    {
