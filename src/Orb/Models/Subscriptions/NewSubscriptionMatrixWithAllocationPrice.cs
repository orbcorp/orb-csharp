        ...
        IFromRaw<NewSubscriptionMatrixWithAllocationPrice>
{
    ...
    public required NewSubscriptionMatrixWithAllocationPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewSubscriptionMatrixWithAllocationPriceProperties::Cadence>(
                    element
    ...
    public required Models::MatrixWithAllocationConfig MatrixWithAllocationConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<Models::MatrixWithAllocationConfig>(element)
    ...
    public required NewSubscriptionMatrixWithAllocationPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewSubscriptionMatrixWithAllocationPriceProperties::ModelType>(
                    element
    ...
    public NewSubscriptionMatrixWithAllocationPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewSubscriptionMatrixWithAllocationPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
