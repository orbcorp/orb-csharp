...
public sealed record class NewSubscriptionTieredPackageWithMinimumPrice : JsonModel
{
    ...
    public required global::Orb.Models.Subscriptions.TieredPackageWithMinimumConfig TieredPackageWithMinimumConfig
    {
        get
        {
            return JsonModel.GetNotNullClass<global::Orb.Models.Subscriptions.TieredPackageWithMinimumConfig>(
                this.RawData,
    ...
    public NewSubscriptionTieredPackageWithMinimumPriceConversionRateConfig? ConversionRateConfig
    {
        get
        {
            return JsonModel.GetNullableClass<NewSubscriptionTieredPackageWithMinimumPriceConversionRateConfig>(
                this.RawData,
