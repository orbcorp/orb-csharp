...
[Serialization::JsonConverter(
    typeof(Orb::ModelConverter<NewSubscriptionTieredPackageWithMinimumPrice>)
)]
public sealed record class NewSubscriptionTieredPackageWithMinimumPrice
    : Orb::ModelBase,
        Orb::IFromRaw<NewSubscriptionTieredPackageWithMinimumPrice>
{
    /// <summary>
    /// The cadence to bill for this price on.
    /// </summary>
    public required NewSubscriptionTieredPackageWithMinimumPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewSubscriptionTieredPackageWithMinimumPriceProperties::Cadence>(
                    element
    ...
    public required NewSubscriptionTieredPackageWithMinimumPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewSubscriptionTieredPackageWithMinimumPriceProperties::ModelType>(
                    element
    ...
    /// </summary>
    public NewSubscriptionTieredPackageWithMinimumPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<NewSubscriptionTieredPackageWithMinimumPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
