        ...
        IFromRaw<NewSubscriptionGroupedTieredPackagePrice>
{
    ...
    /// </summary>
    public required NewSubscriptionGroupedTieredPackagePriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewSubscriptionGroupedTieredPackagePriceProperties::Cadence>(
                    element,
    ...
    public required NewSubscriptionGroupedTieredPackagePriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewSubscriptionGroupedTieredPackagePriceProperties::ModelType>(
                    element,
                    ModelBase.SerializerOptions
    ...
    /// </summary>
    public NewSubscriptionGroupedTieredPackagePriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewSubscriptionGroupedTieredPackagePriceProperties::ConversionRateConfig?>(
                element,
                ModelBase.SerializerOptions
            );
        }
