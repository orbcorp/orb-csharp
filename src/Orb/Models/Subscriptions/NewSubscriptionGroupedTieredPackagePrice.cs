...
[Serialization::JsonConverter(
    typeof(Orb::ModelConverter<NewSubscriptionGroupedTieredPackagePrice>)
)]
public sealed record class NewSubscriptionGroupedTieredPackagePrice
    : Orb::ModelBase,
        Orb::IFromRaw<NewSubscriptionGroupedTieredPackagePrice>
{
    /// <summary>
    ...
    public required NewSubscriptionGroupedTieredPackagePriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewSubscriptionGroupedTieredPackagePriceProperties::Cadence>(
                    element
    ...
    public required Generic::Dictionary<string, Json::JsonElement> GroupedTieredPackageConfig
    {
        get
        {
            if (
        ...
        set
        {
            this.Properties["grouped_tiered_package_config"] =
    ...
    public required NewSubscriptionGroupedTieredPackagePriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewSubscriptionGroupedTieredPackagePriceProperties::ModelType>(
                    element
    ...
    public NewSubscriptionGroupedTieredPackagePriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewSubscriptionGroupedTieredPackagePriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
