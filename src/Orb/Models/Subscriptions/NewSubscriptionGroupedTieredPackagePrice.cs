...
public sealed record class NewSubscriptionGroupedTieredPackagePrice : JsonModel
{
    /// <summary>
    ...
    public required global::Orb.Models.Subscriptions.GroupedTieredPackageConfig GroupedTieredPackageConfig
    {
        get
        {
            return JsonModel.GetNotNullClass<global::Orb.Models.Subscriptions.GroupedTieredPackageConfig>(
                this.RawData,
    ...
    public NewSubscriptionGroupedTieredPackagePriceConversionRateConfig? ConversionRateConfig
    {
        get
        {
            return JsonModel.GetNullableClass<NewSubscriptionGroupedTieredPackagePriceConversionRateConfig>(
                this.RawData,
    ...
    public NewSubscriptionGroupedTieredPackagePrice(
        ...
        : base(newSubscriptionGroupedTieredPackagePrice) { }
...
#pragma warning restore CS8618
    ...
    /// <inheritdoc cref="NewSubscriptionGroupedTieredPackagePriceFromRaw.FromRawUnchecked"/>
...
class NewSubscriptionGroupedTieredPackagePriceFromRaw
    : IFromRawJson<NewSubscriptionGroupedTieredPackagePrice>
{
    /// <inheritdoc/>
...
public sealed record class GroupedTieredPackageConfig : JsonModel
{
    ...
    public required IReadOnlyList<global::Orb.Models.Subscriptions.GroupedTieredPackageConfigTier> Tiers
    {
        ...
        {
            return JsonModel.GetNotNullClass<
                List<global::Orb.Models.Subscriptions.GroupedTieredPackageConfigTier>
            >(this.RawData, "tiers");
        }
...
public record class NewSubscriptionGroupedTieredPackagePriceConversionRateConfig : ModelBase
{
    ...
    public NewSubscriptionGroupedTieredPackagePriceConversionRateConfig(JsonElement element)
    {
        this._element = element;
    }
    ...
    : JsonConverter<NewSubscriptionGroupedTieredPackagePriceConversionRateConfig>
{
    ...
    )
    {
        ...
        switch (conversionRateType)
        {
            ...
            default:
            {
                return new NewSubscriptionGroupedTieredPackagePriceConversionRateConfig(element);
            }
        }
    }
