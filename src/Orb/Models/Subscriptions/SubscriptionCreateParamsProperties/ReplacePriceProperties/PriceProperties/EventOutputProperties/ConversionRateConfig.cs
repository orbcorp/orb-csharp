...
using ConversionRateConfigVariants = Orb.Models.Subscriptions.SubscriptionCreateParamsProperties.ReplacePriceProperties.PriceProperties.EventOutputProperties.ConversionRateConfigVariants;
