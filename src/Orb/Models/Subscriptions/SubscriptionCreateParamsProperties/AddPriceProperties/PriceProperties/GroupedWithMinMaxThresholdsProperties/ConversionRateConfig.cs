...
using ConversionRateConfigVariants = Orb.Models.Subscriptions.SubscriptionCreateParamsProperties.AddPriceProperties.PriceProperties.GroupedWithMinMaxThresholdsProperties.ConversionRateConfigVariants;
