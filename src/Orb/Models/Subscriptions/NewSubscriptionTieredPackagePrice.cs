        ...
        IFromRaw<NewSubscriptionTieredPackagePrice>
{
    ...
    public required NewSubscriptionTieredPackagePriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewSubscriptionTieredPackagePriceProperties::Cadence>(
                    element
    ...
    public required NewSubscriptionTieredPackagePriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewSubscriptionTieredPackagePriceProperties::ModelType>(
                    element
    ...
    public required Dictionary<string, JsonElement> TieredPackageConfig
    {
        ...
        set { this.Properties["tiered_package_config"] = JsonSerializer.SerializeToElement(value); }
    }
    ...
    public NewSubscriptionTieredPackagePriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewSubscriptionTieredPackagePriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
