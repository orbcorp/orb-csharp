...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<NewSubscriptionTieredPackagePrice>))]
public sealed record class NewSubscriptionTieredPackagePrice
    : Orb::ModelBase,
        Orb::IFromRaw<NewSubscriptionTieredPackagePrice>
{
    /// <summary>
    /// The cadence to bill for this price on.
    /// </summary>
    public required NewSubscriptionTieredPackagePriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewSubscriptionTieredPackagePriceProperties::Cadence>(
                    element
    ...
    public required NewSubscriptionTieredPackagePriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewSubscriptionTieredPackagePriceProperties::ModelType>(
                    element
    ...
    /// </summary>
    public NewSubscriptionTieredPackagePriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<NewSubscriptionTieredPackagePriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
...
#pragma warning disable CS8618
    ...
    NewSubscriptionTieredPackagePrice(Generic::Dictionary<string, Json::JsonElement> properties)
    {
