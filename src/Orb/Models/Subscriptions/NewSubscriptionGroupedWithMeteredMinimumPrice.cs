        ...
        IFromRaw<NewSubscriptionGroupedWithMeteredMinimumPrice>
{
    ...
    public required global::Orb.Models.Subscriptions.GroupedWithMeteredMinimumConfig GroupedWithMeteredMinimumConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<global::Orb.Models.Subscriptions.GroupedWithMeteredMinimumConfig>(
                    element,
                    ModelBase.SerializerOptions
                )
                ?? throw new OrbInvalidDataException(
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    NewSubscriptionGroupedWithMeteredMinimumPrice(FrozenDictionary<string, JsonElement> properties)
    {
        this._properties = [.. properties];
    }
        ...
        IFromRaw<global::Orb.Models.Subscriptions.GroupedWithMeteredMinimumConfig>
{
    ...
    public required List<global::Orb.Models.Subscriptions.ScalingFactor> ScalingFactors
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<List<global::Orb.Models.Subscriptions.ScalingFactor>>(
                    element,
                    ModelBase.SerializerOptions
                )
                ?? throw new OrbInvalidDataException(
    ...
    public required List<global::Orb.Models.Subscriptions.UnitAmount> UnitAmounts
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<List<global::Orb.Models.Subscriptions.UnitAmount>>(
                    element,
                    ModelBase.SerializerOptions
                )
                ?? throw new OrbInvalidDataException(
