        ...
        IFromRaw<NewSubscriptionGroupedWithMeteredMinimumPrice>
{
    ...
    public required NewSubscriptionGroupedWithMeteredMinimumPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewSubscriptionGroupedWithMeteredMinimumPriceProperties::Cadence>(
                    element
    ...
    public required NewSubscriptionGroupedWithMeteredMinimumPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewSubscriptionGroupedWithMeteredMinimumPriceProperties::ModelType>(
                    element
    ...
    public NewSubscriptionGroupedWithMeteredMinimumPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewSubscriptionGroupedWithMeteredMinimumPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    NewSubscriptionGroupedWithMeteredMinimumPrice(Dictionary<string, JsonElement> properties)
    {
