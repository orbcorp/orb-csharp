...
/// short by the cancellation are extended to infinity (original end dates are lost),
/// and future intervals or phases scheduled after the cancellation time are permanently
/// deleted. For complex subscriptions with phases or scheduled plan changes, consider
/// creating a new plan change instead of uncancelling.</para>
///
