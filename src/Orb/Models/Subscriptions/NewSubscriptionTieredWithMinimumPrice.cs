        ...
        IFromRaw<NewSubscriptionTieredWithMinimumPrice>
{
    ...
    public required global::Orb.Models.Subscriptions.TieredWithMinimumConfig TieredWithMinimumConfig
    {
        get
        {
            if (!this.Properties.TryGetValue("tiered_with_minimum_config", out JsonElement element))
                throw new OrbInvalidDataException(
        ...
        set
        {
            this.Properties["tiered_with_minimum_config"] = JsonSerializer.SerializeToElement(
                value,
                ModelBase.SerializerOptions
            );
        }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    NewSubscriptionTieredWithMinimumPrice(Dictionary<string, JsonElement> properties)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    Tier15(Dictionary<string, JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618
