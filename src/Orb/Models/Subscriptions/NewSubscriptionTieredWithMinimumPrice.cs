        ...
        IFromRaw<NewSubscriptionTieredWithMinimumPrice>
{
    ...
    public required NewSubscriptionTieredWithMinimumPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewSubscriptionTieredWithMinimumPriceProperties::Cadence>(
                    element,
    ...
    public required NewSubscriptionTieredWithMinimumPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewSubscriptionTieredWithMinimumPriceProperties::ModelType>(
                    element,
                    ModelBase.SerializerOptions
    ...
    public NewSubscriptionTieredWithMinimumPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewSubscriptionTieredWithMinimumPriceProperties::ConversionRateConfig?>(
                element,
                ModelBase.SerializerOptions
            );
        }
