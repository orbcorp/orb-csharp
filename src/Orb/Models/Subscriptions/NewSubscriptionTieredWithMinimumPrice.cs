...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<NewSubscriptionTieredWithMinimumPrice>))]
public sealed record class NewSubscriptionTieredWithMinimumPrice
    : Orb::ModelBase,
        Orb::IFromRaw<NewSubscriptionTieredWithMinimumPrice>
{
    /// <summary>
    /// The cadence to bill for this price on.
    /// </summary>
    public required NewSubscriptionTieredWithMinimumPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewSubscriptionTieredWithMinimumPriceProperties::Cadence>(
                    element
    ...
    public required NewSubscriptionTieredWithMinimumPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewSubscriptionTieredWithMinimumPriceProperties::ModelType>(
                    element
    ...
    public required Generic::Dictionary<string, Json::JsonElement> TieredWithMinimumConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<Generic::Dictionary<string, Json::JsonElement>>(
                    element
                ) ?? throw new System::ArgumentNullException("tiered_with_minimum_config");
        }
        set
        {
            this.Properties["tiered_with_minimum_config"] = Json::JsonSerializer.SerializeToElement(
                value
            );
        }
    }
    ...
    /// </summary>
    public NewSubscriptionTieredWithMinimumPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<NewSubscriptionTieredWithMinimumPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
...
#pragma warning disable CS8618
    ...
    NewSubscriptionTieredWithMinimumPrice(Generic::Dictionary<string, Json::JsonElement> properties)
    {
