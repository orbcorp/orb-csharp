...
namespace Orb.Models.Subscriptions.SubscriptionPriceIntervalsParamsProperties.EditAdjustmentProperties.StartDateVariants;
...
) : StartDate, IVariant<BillingCycleRelativeDate, ApiEnum<string, Models::BillingCycleRelativeDate>>
{
