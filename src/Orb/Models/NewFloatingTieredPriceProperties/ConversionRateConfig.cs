...
using ConversionRateConfigVariants = Orb.Models.NewFloatingTieredPriceProperties.ConversionRateConfigVariants;

namespace Orb.Models.NewFloatingTieredPriceProperties;
