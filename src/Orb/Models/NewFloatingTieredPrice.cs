...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<NewFloatingTieredPrice>))]
public sealed record class NewFloatingTieredPrice
    : Orb::ModelBase,
        Orb::IFromRaw<NewFloatingTieredPrice>
{
    /// <summary>
    /// The cadence to bill for this price on.
    /// </summary>
    public required NewFloatingTieredPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewFloatingTieredPriceProperties::Cadence>(
                    element
    ...
    public required NewFloatingTieredPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewFloatingTieredPriceProperties::ModelType>(
                    element
    ...
    public required TieredConfig TieredConfig
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<TieredConfig>(element)
    ...
    /// </summary>
    public NewFloatingTieredPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<NewFloatingTieredPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
...
#pragma warning disable CS8618
    ...
    NewFloatingTieredPrice(Generic::Dictionary<string, Json::JsonElement> properties)
    {
