...
public sealed record class NewFloatingTieredPrice : ModelBase, IFromRaw<NewFloatingTieredPrice>
{
    ...
    public required NewFloatingTieredPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewFloatingTieredPriceProperties::Cadence>(element)
    ...
    public required NewFloatingTieredPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewFloatingTieredPriceProperties::ModelType>(element)
    ...
    public required TieredConfig TieredConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<TieredConfig>(element)
    ...
    public NewFloatingTieredPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewFloatingTieredPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    NewFloatingTieredPrice(Dictionary<string, JsonElement> properties)
    {
