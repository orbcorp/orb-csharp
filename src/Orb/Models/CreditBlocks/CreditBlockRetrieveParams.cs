...
/// </summary>
public record class CreditBlockRetrieveParams : ParamsBase
{
...
#pragma warning restore CS8618
    ...
    public static CreditBlockRetrieveParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(CreditBlockRetrieveParams? other)
    {
        if (other == null)
        {
            return false;
