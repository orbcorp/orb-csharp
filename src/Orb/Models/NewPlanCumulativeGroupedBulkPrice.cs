        ...
        IFromRaw<NewPlanCumulativeGroupedBulkPrice>
{
    ...
    public required NewPlanCumulativeGroupedBulkPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewPlanCumulativeGroupedBulkPriceProperties::Cadence>(
                    element,
    ...
    public required NewPlanCumulativeGroupedBulkPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewPlanCumulativeGroupedBulkPriceProperties::ModelType>(
                    element,
                    ModelBase.SerializerOptions
    ...
    public NewPlanCumulativeGroupedBulkPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewPlanCumulativeGroupedBulkPriceProperties::ConversionRateConfig?>(
                element,
                ModelBase.SerializerOptions
            );
        }
