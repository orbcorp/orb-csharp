...
using ConversionRateConfigVariants = Orb.Models.NewPlanPackageWithAllocationPriceProperties.ConversionRateConfigVariants;

namespace Orb.Models.NewPlanPackageWithAllocationPriceProperties;
