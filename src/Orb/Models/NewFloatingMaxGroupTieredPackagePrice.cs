...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<NewFloatingMaxGroupTieredPackagePrice>))]
public sealed record class NewFloatingMaxGroupTieredPackagePrice
    : Orb::ModelBase,
        Orb::IFromRaw<NewFloatingMaxGroupTieredPackagePrice>
{
    /// <summary>
    /// The cadence to bill for this price on.
    /// </summary>
    public required NewFloatingMaxGroupTieredPackagePriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewFloatingMaxGroupTieredPackagePriceProperties::Cadence>(
                    element
    ...
    public required Generic::Dictionary<string, Json::JsonElement> MaxGroupTieredPackageConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<Generic::Dictionary<string, Json::JsonElement>>(
                    element
                ) ?? throw new System::ArgumentNullException("max_group_tiered_package_config");
        }
        set
        {
            this.Properties["max_group_tiered_package_config"] =
                Json::JsonSerializer.SerializeToElement(value);
        }
    }

    public required NewFloatingMaxGroupTieredPackagePriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewFloatingMaxGroupTieredPackagePriceProperties::ModelType>(
                    element
    ...
    /// </summary>
    public NewFloatingMaxGroupTieredPackagePriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<NewFloatingMaxGroupTieredPackagePriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
...
#pragma warning disable CS8618
    ...
    NewFloatingMaxGroupTieredPackagePrice(Generic::Dictionary<string, Json::JsonElement> properties)
    {
