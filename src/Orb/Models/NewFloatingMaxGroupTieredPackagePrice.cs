        ...
        IFromRaw<NewFloatingMaxGroupTieredPackagePrice>
{
    ...
    public required NewFloatingMaxGroupTieredPackagePriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewFloatingMaxGroupTieredPackagePriceProperties::Cadence>(
                    element,
    ...
    public required NewFloatingMaxGroupTieredPackagePriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewFloatingMaxGroupTieredPackagePriceProperties::ModelType>(
                    element,
                    ModelBase.SerializerOptions
    ...
    public NewFloatingMaxGroupTieredPackagePriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewFloatingMaxGroupTieredPackagePriceProperties::ConversionRateConfig?>(
                element,
                ModelBase.SerializerOptions
            );
        }
