...
public sealed record class NewFloatingMaxGroupTieredPackagePrice : ModelBase
{
    /// <summary>
    ...
    public required MaxGroupTieredPackageConfig MaxGroupTieredPackageConfig
    {
        get
        {
            return ModelBase.GetNotNullClass<MaxGroupTieredPackageConfig>(
                this.RawData,
    ...
    public NewFloatingMaxGroupTieredPackagePriceConversionRateConfig? ConversionRateConfig
    {
        get
        {
            return ModelBase.GetNullableClass<NewFloatingMaxGroupTieredPackagePriceConversionRateConfig>(
                this.RawData,
...
class NewFloatingMaxGroupTieredPackagePriceFromRaw : IFromRaw<NewFloatingMaxGroupTieredPackagePrice>
{
...
/// </summary>
[JsonConverter(
    typeof(ModelConverter<MaxGroupTieredPackageConfig, MaxGroupTieredPackageConfigFromRaw>)
)]
...
class MaxGroupTieredPackageConfigFromRaw : IFromRaw<MaxGroupTieredPackageConfig>
{
...
public record class NewFloatingMaxGroupTieredPackagePriceConversionRateConfig
{
    ...
    public NewFloatingMaxGroupTieredPackagePriceConversionRateConfig(JsonElement json)
    {
        this._json = json;
    }
    ...
    : JsonConverter<NewFloatingMaxGroupTieredPackagePriceConversionRateConfig>
{
    ...
    )
    {
        ...
        switch (conversionRateType)
        {
            ...
            default:
            {
                return new NewFloatingMaxGroupTieredPackagePriceConversionRateConfig(json);
            }
        }
    }
