        ...
        IFromRaw<NewPlanMatrixWithDisplayNamePrice>
{
    ...
    public required NewPlanMatrixWithDisplayNamePriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewPlanMatrixWithDisplayNamePriceProperties::Cadence>(
                    element,
    ...
    public required NewPlanMatrixWithDisplayNamePriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewPlanMatrixWithDisplayNamePriceProperties::ModelType>(
                    element,
                    ModelBase.SerializerOptions
    ...
    public NewPlanMatrixWithDisplayNamePriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewPlanMatrixWithDisplayNamePriceProperties::ConversionRateConfig?>(
                element,
                ModelBase.SerializerOptions
            );
        }
