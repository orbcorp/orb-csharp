...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<NewPlanMatrixWithDisplayNamePrice>))]
public sealed record class NewPlanMatrixWithDisplayNamePrice
    : Orb::ModelBase,
        Orb::IFromRaw<NewPlanMatrixWithDisplayNamePrice>
{
    /// <summary>
    /// The cadence to bill for this price on.
    /// </summary>
    public required NewPlanMatrixWithDisplayNamePriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewPlanMatrixWithDisplayNamePriceProperties::Cadence>(
                    element
    ...
    public required NewPlanMatrixWithDisplayNamePriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewPlanMatrixWithDisplayNamePriceProperties::ModelType>(
                    element
    ...
    /// </summary>
    public NewPlanMatrixWithDisplayNamePriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<NewPlanMatrixWithDisplayNamePriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
...
#pragma warning disable CS8618
    ...
    NewPlanMatrixWithDisplayNamePrice(Generic::Dictionary<string, Json::JsonElement> properties)
    {
