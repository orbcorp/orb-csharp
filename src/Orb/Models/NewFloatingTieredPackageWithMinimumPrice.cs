...
public sealed record class NewFloatingTieredPackageWithMinimumPrice : JsonModel
{
    ...
    public NewFloatingTieredPackageWithMinimumPriceConversionRateConfig? ConversionRateConfig
    {
        ...
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableClass<NewFloatingTieredPackageWithMinimumPriceConversionRateConfig>(
...
public record class NewFloatingTieredPackageWithMinimumPriceConversionRateConfig : ModelBase
{
    ...
    public virtual bool Equals(
        NewFloatingTieredPackageWithMinimumPriceConversionRateConfig? other
    ) =>
        other != null
