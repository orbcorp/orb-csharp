...
using ConversionRateConfigVariants = Orb.Models.NewFloatingMinimumCompositePriceProperties.ConversionRateConfigVariants;

namespace Orb.Models.NewFloatingMinimumCompositePriceProperties;
