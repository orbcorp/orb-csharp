...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<NewFloatingUnitWithPercentPrice>))]
public sealed record class NewFloatingUnitWithPercentPrice
    : Orb::ModelBase,
        Orb::IFromRaw<NewFloatingUnitWithPercentPrice>
{
    /// <summary>
    /// The cadence to bill for this price on.
    /// </summary>
    public required NewFloatingUnitWithPercentPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewFloatingUnitWithPercentPriceProperties::Cadence>(
                    element
    ...
    public required NewFloatingUnitWithPercentPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewFloatingUnitWithPercentPriceProperties::ModelType>(
                    element
    ...
    /// </summary>
    public NewFloatingUnitWithPercentPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<NewFloatingUnitWithPercentPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
...
#pragma warning disable CS8618
    ...
    NewFloatingUnitWithPercentPrice(Generic::Dictionary<string, Json::JsonElement> properties)
    {
