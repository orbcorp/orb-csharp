        ...
        IFromRaw<NewFloatingUnitWithPercentPrice>
{
    ...
    public required NewFloatingUnitWithPercentPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewFloatingUnitWithPercentPriceProperties::Cadence>(
                    element
    ...
    public required NewFloatingUnitWithPercentPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewFloatingUnitWithPercentPriceProperties::ModelType>(
                    element
    ...
    public NewFloatingUnitWithPercentPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewFloatingUnitWithPercentPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
