...
using ConversionRateConfigVariants = Orb.Models.NewFloatingBulkPriceProperties.ConversionRateConfigVariants;

namespace Orb.Models.NewFloatingBulkPriceProperties;
