...
///
/// <para>This is a lighter-weight alternative to the issue invoice endpoint, returning
/// an invoice summary without any line item details.</para>
///
/// <para>NOTE: Do not inherit from this type outside the SDK unless you're okay with
/// breaking changes in non-major versions. We may add new methods in the future that
/// cause existing derived classes to break.</para>
/// </summary>
public record class InvoiceIssueSummaryParams : ParamsBase
{
    ...
    public InvoiceIssueSummaryParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public InvoiceIssueSummaryParams(InvoiceIssueSummaryParams invoiceIssueSummaryParams)
        : base(invoiceIssueSummaryParams)
    {
        this.InvoiceID = invoiceIssueSummaryParams.InvoiceID;

        this._rawBodyData = new(invoiceIssueSummaryParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static InvoiceIssueSummaryParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData
    )
    ...
    public virtual bool Equals(InvoiceIssueSummaryParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/')
                + string.Format("/invoices/summary/{0}/issue", this.InvoiceID)
        )
        {
