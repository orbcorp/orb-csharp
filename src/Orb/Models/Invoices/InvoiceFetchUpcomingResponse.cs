        ...
        IFromRaw<InvoiceFetchUpcomingResponse>
{
    ...
    public required Models::Address? BillingAddress
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<Models::Address?>(
                element,
                ModelBase.SerializerOptions
            );
        }
    ...
    public required Models::CustomerMinified Customer
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<Models::CustomerMinified>(
                    element,
                    ModelBase.SerializerOptions
    ...
    public required Models::CustomerTaxID? CustomerTaxID
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<Models::CustomerTaxID?>(
                element,
                ModelBase.SerializerOptions
            );
        }
    ...
    public required List<Models::InvoiceLevelDiscount> Discounts
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<List<Models::InvoiceLevelDiscount>>(
                    element,
                    ModelBase.SerializerOptions
    ...
    public required Models::SubscriptionMinified? Subscription
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<Models::SubscriptionMinified?>(
                element,
                ModelBase.SerializerOptions
            );
        }
