...
public sealed record class InvoiceFetchUpcomingResponse : JsonModel
{
    ...
    public required global::Orb.Models.Invoices.AutoCollection AutoCollection
    {
        get
        {
            return JsonModel.GetNotNullClass<global::Orb.Models.Invoices.AutoCollection>(
                this.RawData,
                "auto_collection"
            );
        }
    ...
    public required IReadOnlyList<global::Orb.Models.Invoices.CreditNote> CreditNotes
    {
        get
        {
            return JsonModel.GetNotNullClass<List<global::Orb.Models.Invoices.CreditNote>>(
                this.RawData,
                "credit_notes"
            );
        }
    ...
    public required IReadOnlyList<InvoiceFetchUpcomingResponseLineItem> LineItems
    {
        get
        {
            return JsonModel.GetNotNullClass<List<InvoiceFetchUpcomingResponseLineItem>>(
                this.RawData,
                "line_items"
            );
        }
    ...
    public required IReadOnlyList<global::Orb.Models.Invoices.PaymentAttempt> PaymentAttempts
    {
        get
        {
            return JsonModel.GetNotNullClass<List<global::Orb.Models.Invoices.PaymentAttempt>>(
                this.RawData,
                "payment_attempts"
            );
        }
    ...
    public required ApiEnum<string, InvoiceFetchUpcomingResponseStatus> Status
    {
        get
        {
            return JsonModel.GetNotNullClass<ApiEnum<string, InvoiceFetchUpcomingResponseStatus>>(
                this.RawData,
                "status"
            );
        }
    ...
    public required System::DateTimeOffset TargetDate
    {
        get
        {
            return JsonModel.GetNotNullStruct<System::DateTimeOffset>(this.RawData, "target_date");
        }
        init { JsonModel.Set(this._rawData, "target_date", value); }
    }
...
public sealed record class CustomerBalanceTransaction : JsonModel
{
    ...
    public required ApiEnum<string, global::Orb.Models.Invoices.Action> Action
    {
        get
        {
            return JsonModel.GetNotNullClass<ApiEnum<string, global::Orb.Models.Invoices.Action>>(
                this.RawData,
                "action"
            );
        }
    ...
    public required ApiEnum<string, global::Orb.Models.Invoices.Type> Type
    {
        get
        {
            return JsonModel.GetNotNullClass<ApiEnum<string, global::Orb.Models.Invoices.Type>>(
                this.RawData,
                "type"
            );
        }
...
public sealed record class InvoiceFetchUpcomingResponseLineItem : JsonModel
{
    ...
    public required IReadOnlyList<global::Orb.Models.Invoices.Adjustment> Adjustments
    {
        get
        {
            return JsonModel.GetNotNullClass<List<global::Orb.Models.Invoices.Adjustment>>(
                this.RawData,
                "adjustments"
            );
        }
    ...
    public required IReadOnlyList<global::Orb.Models.Invoices.SubLineItem> SubLineItems
    {
        get
        {
            return JsonModel.GetNotNullClass<List<global::Orb.Models.Invoices.SubLineItem>>(
                this.RawData,
                "sub_line_items"
            );
        }
