...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<PriceListPageResponse>))]
public sealed record class PriceListPageResponse
    : Orb::ModelBase,
        Orb::IFromRaw<PriceListPageResponse>
{
    public required Generic::List<Models::Price> Data
    {
        get
        {
...
#pragma warning disable CS8618
    ...
    PriceListPageResponse(Generic::Dictionary<string, Json::JsonElement> properties)
    {
