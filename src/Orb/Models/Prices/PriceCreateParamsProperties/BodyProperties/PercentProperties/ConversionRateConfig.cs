...
using ConversionRateConfigVariants = Orb.Models.Prices.PriceCreateParamsProperties.BodyProperties.PercentProperties.ConversionRateConfigVariants;

namespace Orb.Models.Prices.PriceCreateParamsProperties.BodyProperties.PercentProperties;
