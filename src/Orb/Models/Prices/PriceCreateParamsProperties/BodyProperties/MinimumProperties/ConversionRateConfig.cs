...
using ConversionRateConfigVariants = Orb.Models.Prices.PriceCreateParamsProperties.BodyProperties.MinimumProperties.ConversionRateConfigVariants;

namespace Orb.Models.Prices.PriceCreateParamsProperties.BodyProperties.MinimumProperties;
