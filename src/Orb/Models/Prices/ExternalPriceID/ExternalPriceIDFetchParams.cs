...
/// </summary>
public record class ExternalPriceIDFetchParams : ParamsBase
{
...
#pragma warning disable CS8618
    ...
    {
        this.ExternalPriceID = externalPriceIDFetchParams.ExternalPriceID;
    }
...
#pragma warning restore CS8618
    ...
    public static ExternalPriceIDFetchParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(ExternalPriceIDFetchParams? other)
    {
        if (other == null)
        {
            return false;
