...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<NewPlanBulkPrice>))]
public sealed record class NewPlanBulkPrice : Orb::ModelBase, Orb::IFromRaw<NewPlanBulkPrice>
{
    public required BulkConfig BulkConfig
    {
        get
        {
            if (!this.Properties.TryGetValue("bulk_config", out Json::JsonElement element))
                throw new System::ArgumentOutOfRangeException(
                    "bulk_config",
                    "Missing required argument"
                );

            return Json::JsonSerializer.Deserialize<BulkConfig>(element)
                ?? throw new System::ArgumentNullException("bulk_config");
        }
        set { this.Properties["bulk_config"] = Json::JsonSerializer.SerializeToElement(value); }
    }

    /// <summary>
    /// The cadence to bill for this price on.
    /// </summary>
    public required NewPlanBulkPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewPlanBulkPriceProperties::Cadence>(element)
    ...
    public required NewPlanBulkPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewPlanBulkPriceProperties::ModelType>(element)
    ...
    /// </summary>
    public NewPlanBulkPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<NewPlanBulkPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
...
#pragma warning disable CS8618
    ...
    NewPlanBulkPrice(Generic::Dictionary<string, Json::JsonElement> properties)
    {
