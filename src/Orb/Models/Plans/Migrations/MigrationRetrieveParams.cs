...
/// </summary>
public record class MigrationRetrieveParams : ParamsBase
{
...
#pragma warning restore CS8618
    ...
    public static MigrationRetrieveParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string planID,
        string migrationID
    ...
    public virtual bool Equals(MigrationRetrieveParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/')
                + string.Format("/plans/{0}/migrations/{1}", this.PlanID, this.MigrationID)
        )
        {
