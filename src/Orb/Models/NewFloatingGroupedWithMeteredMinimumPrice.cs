        ...
        IFromRaw<NewFloatingGroupedWithMeteredMinimumPrice>
{
    ...
    public required NewFloatingGroupedWithMeteredMinimumPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewFloatingGroupedWithMeteredMinimumPriceProperties::Cadence>(
                    element
    ...
    public required NewFloatingGroupedWithMeteredMinimumPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewFloatingGroupedWithMeteredMinimumPriceProperties::ModelType>(
                    element
    ...
    public NewFloatingGroupedWithMeteredMinimumPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewFloatingGroupedWithMeteredMinimumPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
