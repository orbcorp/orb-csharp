...
using BulkWithProrationConfigProperties = Orb.Models.NewPlanBulkWithProrationPriceProperties.BulkWithProrationConfigProperties;

namespace Orb.Models.NewPlanBulkWithProrationPriceProperties;
