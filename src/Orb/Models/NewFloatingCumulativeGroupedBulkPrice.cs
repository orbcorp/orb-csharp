...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    NewFloatingCumulativeGroupedBulkPrice(FrozenDictionary<string, JsonElement> properties)
    {
        this._properties = [.. properties];
    }
        ...
        IFromRaw<CumulativeGroupedBulkConfig>
{
    ...
    public CumulativeGroupedBulkConfig(IReadOnlyDictionary<string, JsonElement> properties)
    {
        this._properties = [.. properties];
    }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    CumulativeGroupedBulkConfig(FrozenDictionary<string, JsonElement> properties)
    {
        this._properties = [.. properties];
    }
#pragma warning restore CS8618
...
public sealed record class DimensionValue : ModelBase, IFromRaw<DimensionValue>
{
    ...
    public DimensionValue(IReadOnlyDictionary<string, JsonElement> properties)
    {
        this._properties = [.. properties];
    }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    DimensionValue(FrozenDictionary<string, JsonElement> properties)
    {
        this._properties = [.. properties];
    }
#pragma warning restore CS8618

    public static DimensionValue FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> properties
    )
    {
        return new(FrozenDictionary.ToFrozenDictionary(properties));
...
public record class NewFloatingCumulativeGroupedBulkPriceConversionRateConfig
{
    ...
    public NewFloatingCumulativeGroupedBulkPriceConversionRateConfig(JsonElement json)
    {
        this._json = json;
    }
    ...
    : JsonConverter<NewFloatingCumulativeGroupedBulkPriceConversionRateConfig>
{
    ...
    )
    {
        ...
        switch (conversionRateType)
        {
            ...
            default:
            {
                return new NewFloatingCumulativeGroupedBulkPriceConversionRateConfig(json);
            }
        }
    }
