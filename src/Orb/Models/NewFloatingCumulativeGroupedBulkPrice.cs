...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<NewFloatingCumulativeGroupedBulkPrice>))]
public sealed record class NewFloatingCumulativeGroupedBulkPrice
    : Orb::ModelBase,
        Orb::IFromRaw<NewFloatingCumulativeGroupedBulkPrice>
{
    /// <summary>
    /// The cadence to bill for this price on.
    /// </summary>
    public required NewFloatingCumulativeGroupedBulkPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewFloatingCumulativeGroupedBulkPriceProperties::Cadence>(
                    element
    ...
    public required Generic::Dictionary<string, Json::JsonElement> CumulativeGroupedBulkConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<Generic::Dictionary<string, Json::JsonElement>>(
                    element
                ) ?? throw new System::ArgumentNullException("cumulative_grouped_bulk_config");
        }
        set
        {
            this.Properties["cumulative_grouped_bulk_config"] =
    ...
    public required NewFloatingCumulativeGroupedBulkPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewFloatingCumulativeGroupedBulkPriceProperties::ModelType>(
                    element
    ...
    /// </summary>
    public NewFloatingCumulativeGroupedBulkPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<NewFloatingCumulativeGroupedBulkPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
...
#pragma warning disable CS8618
    ...
    NewFloatingCumulativeGroupedBulkPrice(Generic::Dictionary<string, Json::JsonElement> properties)
    {
