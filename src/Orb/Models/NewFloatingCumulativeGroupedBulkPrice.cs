        ...
        IFromRaw<NewFloatingCumulativeGroupedBulkPrice>
{
    ...
    public required NewFloatingCumulativeGroupedBulkPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewFloatingCumulativeGroupedBulkPriceProperties::Cadence>(
                    element,
    ...
    public required NewFloatingCumulativeGroupedBulkPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewFloatingCumulativeGroupedBulkPriceProperties::ModelType>(
                    element,
                    ModelBase.SerializerOptions
    ...
    public NewFloatingCumulativeGroupedBulkPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewFloatingCumulativeGroupedBulkPriceProperties::ConversionRateConfig?>(
                element,
                ModelBase.SerializerOptions
            );
        }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    NewFloatingCumulativeGroupedBulkPrice(Dictionary<string, JsonElement> properties)
    {
