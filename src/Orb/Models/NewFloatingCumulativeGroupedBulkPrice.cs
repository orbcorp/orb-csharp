...
public sealed record class NewFloatingCumulativeGroupedBulkPrice : JsonModel
{
    ...
    public NewFloatingCumulativeGroupedBulkPriceConversionRateConfig? ConversionRateConfig
    {
        ...
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableClass<NewFloatingCumulativeGroupedBulkPriceConversionRateConfig>(
...
public record class NewFloatingCumulativeGroupedBulkPriceConversionRateConfig : ModelBase
{
