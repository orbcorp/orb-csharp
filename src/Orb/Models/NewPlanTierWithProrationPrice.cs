...
[JsonConverter(typeof(ModelConverter<NewPlanTierWithProrationPrice>))]
public sealed record class NewPlanTierWithProrationPrice
    : ModelBase,
        IFromRaw<NewPlanTierWithProrationPrice>
{
    /// <summary>
    ...
    public required NewPlanTierWithProrationPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewPlanTierWithProrationPriceProperties::Cadence>(
                    element,
    ...
    public required NewPlanTierWithProrationPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewPlanTierWithProrationPriceProperties::ModelType>(
                    element,
                    ModelBase.SerializerOptions
    ...
    public NewPlanTierWithProrationPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewPlanTierWithProrationPriceProperties::ConversionRateConfig?>(
                element,
                ModelBase.SerializerOptions
            );
        }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    NewPlanTierWithProrationPrice(Dictionary<string, JsonElement> properties)
    {
