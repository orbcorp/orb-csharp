...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<NewPlanTierWithProrationPrice>))]
public sealed record class NewPlanTierWithProrationPrice
    : Orb::ModelBase,
        Orb::IFromRaw<NewPlanTierWithProrationPrice>
{
    /// <summary>
    /// The cadence to bill for this price on.
    /// </summary>
    public required NewPlanTierWithProrationPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewPlanTierWithProrationPriceProperties::Cadence>(
                    element
    ...
    public required NewPlanTierWithProrationPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewPlanTierWithProrationPriceProperties::ModelType>(
                    element
    ...
    /// </summary>
    public NewPlanTierWithProrationPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<NewPlanTierWithProrationPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
...
#pragma warning disable CS8618
    ...
    NewPlanTierWithProrationPrice(Generic::Dictionary<string, Json::JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static NewPlanTierWithProrationPrice FromRawUnchecked(
