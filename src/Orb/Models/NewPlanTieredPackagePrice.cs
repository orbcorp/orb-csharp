        ...
        IFromRaw<NewPlanTieredPackagePrice>
{
    ...
    public required NewPlanTieredPackagePriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewPlanTieredPackagePriceProperties::Cadence>(element)
    ...
    public required NewPlanTieredPackagePriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewPlanTieredPackagePriceProperties::ModelType>(
                    element
    ...
    public NewPlanTieredPackagePriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewPlanTieredPackagePriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    NewPlanTieredPackagePrice(Dictionary<string, JsonElement> properties)
    {
