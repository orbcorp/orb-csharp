...
public sealed record class NewPlanTieredPackagePrice : JsonModel
{
    ...
    public required ApiEnum<string, NewPlanTieredPackagePriceCadence> Cadence
    {
        get
        {
            ...
            return this._rawData.GetNotNullClass<ApiEnum<string, NewPlanTieredPackagePriceCadence>>(
                "cadence"
            );
        }
    ...
    public required NewPlanTieredPackagePriceTieredPackageConfig TieredPackageConfig
    {
        ...
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<NewPlanTieredPackagePriceTieredPackageConfig>(
    ...
    public NewPlanTieredPackagePriceConversionRateConfig? ConversionRateConfig
    {
        ...
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableClass<NewPlanTieredPackagePriceConversionRateConfig>(
    ...
    public required IReadOnlyList<NewPlanTieredPackagePriceTieredPackageConfigTier> Tiers
    {
        get
        {
            ...
            return this._rawData.GetNotNullStruct<
                ImmutableArray<NewPlanTieredPackagePriceTieredPackageConfigTier>
            >("tiers");
        }
        init
        {
            this._rawData.Set<ImmutableArray<NewPlanTieredPackagePriceTieredPackageConfigTier>>(
                "tiers",
...
public record class NewPlanTieredPackagePriceConversionRateConfig : ModelBase
{
