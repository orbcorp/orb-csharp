...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<NewPlanTieredPackagePrice>))]
public sealed record class NewPlanTieredPackagePrice
    : Orb::ModelBase,
        Orb::IFromRaw<NewPlanTieredPackagePrice>
{
    /// <summary>
    /// The cadence to bill for this price on.
    /// </summary>
    public required NewPlanTieredPackagePriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewPlanTieredPackagePriceProperties::Cadence>(
                    element
    ...
    public required NewPlanTieredPackagePriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewPlanTieredPackagePriceProperties::ModelType>(
                    element
    ...
    /// </summary>
    public NewPlanTieredPackagePriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<NewPlanTieredPackagePriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
...
#pragma warning disable CS8618
    ...
    NewPlanTieredPackagePrice(Generic::Dictionary<string, Json::JsonElement> properties)
    {
