using ConversionRateConfigVariants = Orb.Models.NewPlanThresholdTotalAmountPriceProperties.ConversionRateConfigVariants;
using Models = Orb.Models;
using Orb = Orb;
using Serialization = System.Text.Json.Serialization;

namespace Orb.Models.NewPlanThresholdTotalAmountPriceProperties;
