        ...
        IFromRaw<NewPlanGroupedWithMeteredMinimumPrice>
{
    ...
    public required NewPlanGroupedWithMeteredMinimumPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewPlanGroupedWithMeteredMinimumPriceProperties::Cadence>(
                    element
    ...
    public required NewPlanGroupedWithMeteredMinimumPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewPlanGroupedWithMeteredMinimumPriceProperties::ModelType>(
                    element
    ...
    public NewPlanGroupedWithMeteredMinimumPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewPlanGroupedWithMeteredMinimumPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
