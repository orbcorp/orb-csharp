...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<CouponListPageResponse>))]
public sealed record class CouponListPageResponse
    : Orb::ModelBase,
        Orb::IFromRaw<CouponListPageResponse>
{
    public required Generic::List<Coupon> Data
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<Generic::List<Coupon>>(element)
...
#pragma warning disable CS8618
    ...
    CouponListPageResponse(Generic::Dictionary<string, Json::JsonElement> properties)
    {
