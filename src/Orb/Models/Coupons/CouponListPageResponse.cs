...
public sealed record class CouponListPageResponse : ModelBase, IFromRaw<CouponListPageResponse>
{
    public required List<Coupon> Data
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<List<Coupon>>(element, ModelBase.SerializerOptions)
                ?? throw new OrbInvalidDataException(
                    "'data' cannot be null",
    ...
    public CouponListPageResponse(IReadOnlyDictionary<string, JsonElement> properties)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    CouponListPageResponse(FrozenDictionary<string, JsonElement> properties)
    {
        this._properties = [.. properties];
    }
