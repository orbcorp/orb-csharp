...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<NewPlanUnitWithPercentPrice>))]
public sealed record class NewPlanUnitWithPercentPrice
    : Orb::ModelBase,
        Orb::IFromRaw<NewPlanUnitWithPercentPrice>
{
    /// <summary>
    ...
    public required NewPlanUnitWithPercentPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewPlanUnitWithPercentPriceProperties::Cadence>(
                    element
    ...
    public required NewPlanUnitWithPercentPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewPlanUnitWithPercentPriceProperties::ModelType>(
                    element
    ...
    public NewPlanUnitWithPercentPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewPlanUnitWithPercentPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
...
#pragma warning disable CS8618
    ...
    NewPlanUnitWithPercentPrice(Generic::Dictionary<string, Json::JsonElement> properties)
    {
