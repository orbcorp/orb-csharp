...
public sealed record class NewPlanUnitWithPercentPrice : ModelBase
{
    ...
    public required ApiEnum<string, NewPlanUnitWithPercentPriceCadence> Cadence
    {
        get
        {
            return ModelBase.GetNotNullClass<ApiEnum<string, NewPlanUnitWithPercentPriceCadence>>(
                this.RawData,
                "cadence"
            );
        }
    ...
    public required ApiEnum<string, NewPlanUnitWithPercentPriceModelType> ModelType
    {
        get
        {
            return ModelBase.GetNotNullClass<ApiEnum<string, NewPlanUnitWithPercentPriceModelType>>(
                this.RawData,
                "model_type"
            );
        }
    ...
    public required NewPlanUnitWithPercentPriceUnitWithPercentConfig UnitWithPercentConfig
    {
        get
        {
            return ModelBase.GetNotNullClass<NewPlanUnitWithPercentPriceUnitWithPercentConfig>(
                this.RawData,
    ...
    public NewPlanUnitWithPercentPriceConversionRateConfig? ConversionRateConfig
    {
        get
        {
            return ModelBase.GetNullableClass<NewPlanUnitWithPercentPriceConversionRateConfig>(
                this.RawData,
...
public record class NewPlanUnitWithPercentPriceConversionRateConfig
{
    ...
    public NewPlanUnitWithPercentPriceConversionRateConfig(JsonElement json)
    {
        this._json = json;
    }
    ...
    : JsonConverter<NewPlanUnitWithPercentPriceConversionRateConfig>
{
    ...
    )
    {
        ...
        switch (conversionRateType)
        {
            ...
            default:
            {
                return new NewPlanUnitWithPercentPriceConversionRateConfig(json);
            }
        }
    }
