...
[JsonConverter(
    typeof(JsonModelConverter<NewPlanUnitWithPercentPrice, NewPlanUnitWithPercentPriceFromRaw>)
)]
public sealed record class NewPlanUnitWithPercentPrice : JsonModel
{
    /// <summary>
    ...
    public required ApiEnum<string, NewPlanUnitWithPercentPriceCadence> Cadence
    {
        get
        {
            return JsonModel.GetNotNullClass<ApiEnum<string, NewPlanUnitWithPercentPriceCadence>>(
                this.RawData,
                "cadence"
            );
        }
    ...
    public required ApiEnum<string, NewPlanUnitWithPercentPriceModelType> ModelType
    {
        get
        {
            return JsonModel.GetNotNullClass<ApiEnum<string, NewPlanUnitWithPercentPriceModelType>>(
                this.RawData,
                "model_type"
            );
        }
    ...
    public required NewPlanUnitWithPercentPriceUnitWithPercentConfig UnitWithPercentConfig
    {
        get
        {
            return JsonModel.GetNotNullClass<NewPlanUnitWithPercentPriceUnitWithPercentConfig>(
                this.RawData,
    ...
    public NewPlanUnitWithPercentPriceConversionRateConfig? ConversionRateConfig
    {
        get
        {
            return JsonModel.GetNullableClass<NewPlanUnitWithPercentPriceConversionRateConfig>(
                this.RawData,
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    NewPlanUnitWithPercentPrice(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = [.. rawData];
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="NewPlanUnitWithPercentPriceFromRaw.FromRawUnchecked"/>
...
class NewPlanUnitWithPercentPriceFromRaw : IFromRawJson<NewPlanUnitWithPercentPrice>
{
    /// <inheritdoc/>
...
public sealed record class NewPlanUnitWithPercentPriceUnitWithPercentConfig : JsonModel
{
    /// <summary>
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    NewPlanUnitWithPercentPriceUnitWithPercentConfig(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = [.. rawData];
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="NewPlanUnitWithPercentPriceUnitWithPercentConfigFromRaw.FromRawUnchecked"/>
...
class NewPlanUnitWithPercentPriceUnitWithPercentConfigFromRaw
    : IFromRawJson<NewPlanUnitWithPercentPriceUnitWithPercentConfig>
{
    /// <inheritdoc/>
...
public record class NewPlanUnitWithPercentPriceConversionRateConfig : ModelBase
{
    ...
    public NewPlanUnitWithPercentPriceConversionRateConfig(JsonElement element)
    {
        this._element = element;
    }
    ...
    : JsonConverter<NewPlanUnitWithPercentPriceConversionRateConfig>
{
    ...
    )
    {
        ...
        switch (conversionRateType)
        {
            ...
            default:
            {
                return new NewPlanUnitWithPercentPriceConversionRateConfig(element);
            }
        }
    }
