        ...
        IFromRaw<NewFloatingScalableMatrixWithTieredPricingPrice>
{
    ...
    public NewFloatingScalableMatrixWithTieredPricingPriceConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewFloatingScalableMatrixWithTieredPricingPriceConversionRateConfig?>(
                element,
                ModelBase.SerializerOptions
            );
        }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    ScalableMatrixWithTieredPricingConfig(FrozenDictionary<string, JsonElement> properties)
    {
        this._properties = [.. properties];
    }
#pragma warning restore CS8618
...
public sealed record class MatrixScalingFactor : ModelBase, IFromRaw<MatrixScalingFactor>
{
    ...
    public MatrixScalingFactor(IReadOnlyDictionary<string, JsonElement> properties)
    {
        this._properties = [.. properties];
    }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    MatrixScalingFactor(FrozenDictionary<string, JsonElement> properties)
    {
        this._properties = [.. properties];
    }
#pragma warning restore CS8618
...
#pragma warning restore CS8618
    ...
    public static Tier3 FromRawUnchecked(IReadOnlyDictionary<string, JsonElement> properties)
    {
        return new(FrozenDictionary.ToFrozenDictionary(properties));
    }
}
...
public record class NewFloatingScalableMatrixWithTieredPricingPriceConversionRateConfig
{
    ...
    NewFloatingScalableMatrixWithTieredPricingPriceConversionRateConfig(UnknownVariant value)
    {
        Value = value;
    }

    public static NewFloatingScalableMatrixWithTieredPricingPriceConversionRateConfig CreateUnknownVariant(
        JsonElement value
    )
    {
