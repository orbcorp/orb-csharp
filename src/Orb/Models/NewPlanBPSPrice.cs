...
[JsonConverter(typeof(ModelConverter<NewPlanBPSPrice>))]
public sealed record class NewPlanBPSPrice : ModelBase, IFromRaw<NewPlanBPSPrice>
{
    ...
    /// </summary>
    public required NewPlanBPSPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewPlanBPSPriceProperties::Cadence>(
                    element,
    ...
    public required NewPlanBPSPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewPlanBPSPriceProperties::ModelType>(
                    element,
                    ModelBase.SerializerOptions
    ...
    /// </summary>
    public NewPlanBPSPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewPlanBPSPriceProperties::ConversionRateConfig?>(
                element,
                ModelBase.SerializerOptions
            );
        }
    ...
    public NewPlanBPSPrice() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    NewPlanBPSPrice(Dictionary<string, JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static NewPlanBPSPrice FromRawUnchecked(Dictionary<string, JsonElement> properties)
    {
