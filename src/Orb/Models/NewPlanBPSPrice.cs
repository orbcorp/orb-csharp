...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<NewPlanBPSPrice>))]
public sealed record class NewPlanBPSPrice : Orb::ModelBase, Orb::IFromRaw<NewPlanBPSPrice>
{
    ...
    public required NewPlanBPSPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewPlanBPSPriceProperties::Cadence>(element)
    ...
    public required NewPlanBPSPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewPlanBPSPriceProperties::ModelType>(element)
    ...
    public NewPlanBPSPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewPlanBPSPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
...
#pragma warning disable CS8618
    ...
    NewPlanBPSPrice(Generic::Dictionary<string, Json::JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static NewPlanBPSPrice FromRawUnchecked(
