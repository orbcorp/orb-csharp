...
[JsonConverter(typeof(ModelConverter<NewFloatingPackagePrice, NewFloatingPackagePriceFromRaw>))]
public sealed record class NewFloatingPackagePrice : ModelBase
{
    /// <summary>
    ...
    public required ApiEnum<string, NewFloatingPackagePriceCadence> Cadence
    {
        get
        {
            return ModelBase.GetNotNullClass<ApiEnum<string, NewFloatingPackagePriceCadence>>(
                this.RawData,
                "cadence"
            );
        }
    ...
    public required ApiEnum<string, NewFloatingPackagePriceModelType> ModelType
    {
        get
        {
            return ModelBase.GetNotNullClass<ApiEnum<string, NewFloatingPackagePriceModelType>>(
                this.RawData,
                "model_type"
            );
        }
    ...
    public NewFloatingPackagePriceConversionRateConfig? ConversionRateConfig
    {
        get
        {
            return ModelBase.GetNullableClass<NewFloatingPackagePriceConversionRateConfig>(
                this.RawData,
...
class NewFloatingPackagePriceFromRaw : IFromRaw<NewFloatingPackagePrice>
{
    /// <inheritdoc/>
...
public record class NewFloatingPackagePriceConversionRateConfig
{
    ...
    public NewFloatingPackagePriceConversionRateConfig(JsonElement json)
    {
        this._json = json;
    }
    ...
    : JsonConverter<NewFloatingPackagePriceConversionRateConfig>
{
    ...
    )
    {
        ...
        switch (conversionRateType)
        {
            ...
            default:
            {
                return new NewFloatingPackagePriceConversionRateConfig(json);
            }
        }
    }
