...
public sealed record class NewFloatingPackagePrice : JsonModel
{
    ...
    public required ApiEnum<string, NewFloatingPackagePriceCadence> Cadence
    {
        get
        {
            return JsonModel.GetNotNullClass<ApiEnum<string, NewFloatingPackagePriceCadence>>(
                this.RawData,
                "cadence"
            );
        }
    ...
    public required ApiEnum<string, NewFloatingPackagePriceModelType> ModelType
    {
        get
        {
            return JsonModel.GetNotNullClass<ApiEnum<string, NewFloatingPackagePriceModelType>>(
                this.RawData,
                "model_type"
            );
        }
    ...
    public NewFloatingPackagePriceConversionRateConfig? ConversionRateConfig
    {
        get
        {
            return JsonModel.GetNullableClass<NewFloatingPackagePriceConversionRateConfig>(
                this.RawData,
