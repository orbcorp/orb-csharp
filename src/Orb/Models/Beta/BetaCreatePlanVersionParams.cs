...
public sealed record class BetaCreatePlanVersionParams : ParamsBase
{
    ...
    /// </summary>
    public List<BetaCreatePlanVersionParamsProperties::AddAdjustment>? AddAdjustments
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<List<BetaCreatePlanVersionParamsProperties::AddAdjustment>?>(
                element
            );
        }
    ...
    /// </summary>
    public List<BetaCreatePlanVersionParamsProperties::AddPrice>? AddPrices
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<List<BetaCreatePlanVersionParamsProperties::AddPrice>?>(
                element
            );
        }
    ...
    /// </summary>
    public List<BetaCreatePlanVersionParamsProperties::RemoveAdjustment>? RemoveAdjustments
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<List<BetaCreatePlanVersionParamsProperties::RemoveAdjustment>?>(
                element
            );
        }
        set
    ...
    /// </summary>
    public List<BetaCreatePlanVersionParamsProperties::RemovePrice>? RemovePrices
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<List<BetaCreatePlanVersionParamsProperties::RemovePrice>?>(
                element
            );
        }
    ...
    /// </summary>
    public List<BetaCreatePlanVersionParamsProperties::ReplaceAdjustment>? ReplaceAdjustments
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<List<BetaCreatePlanVersionParamsProperties::ReplaceAdjustment>?>(
                element
            );
        }
        set
    ...
    /// </summary>
    public List<BetaCreatePlanVersionParamsProperties::ReplacePrice>? ReplacePrices
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<List<BetaCreatePlanVersionParamsProperties::ReplacePrice>?>(
                element
            );
        }
