...
using Orb.Models.Beta.ExternalPlanID.ExternalPlanIDCreatePlanVersionParamsProperties.ReplacePriceProperties.PriceProperties.BulkWithFiltersProperties;
    ...
    public required BulkWithFiltersConfig BulkWithFiltersConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<BulkWithFiltersConfig>(
                ...
                ?? throw new OrbInvalidDataException(
                    "'bulk_with_filters_config' cannot be null",
                    new ArgumentNullException("bulk_with_filters_config")
                );
        }
        set
        {
...
#pragma warning restore CS8618
    ...
    public static BulkWithFilters FromRawUnchecked(Dictionary<string, JsonElement> properties)
    {
