...
using Orb.Models.Beta.ExternalPlanID.ExternalPlanIDCreatePlanVersionParamsProperties.ReplacePriceProperties.PriceProperties.PercentProperties;

namespace Orb.Models.Beta.ExternalPlanID.ExternalPlanIDCreatePlanVersionParamsProperties.ReplacePriceProperties.PriceProperties;
        ...
        get
        {
            if (!this.Properties.TryGetValue("percent_config", out JsonElement element))
                throw new OrbInvalidDataException(
                    ...
                    new ArgumentOutOfRangeException("percent_config", "Missing required argument")
                );

            return JsonSerializer.Deserialize<PercentConfig>(element, ModelBase.SerializerOptions)
                ?? throw new OrbInvalidDataException(
                    "'percent_config' cannot be null",
                    new ArgumentNullException("percent_config")
                );
        }
        set
        {
...
#pragma warning restore CS8618
    ...
    public static Percent FromRawUnchecked(Dictionary<string, JsonElement> properties)
    {
