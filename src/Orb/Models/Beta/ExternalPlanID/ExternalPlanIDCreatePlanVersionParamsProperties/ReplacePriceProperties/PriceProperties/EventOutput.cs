...
using Orb.Models.Beta.ExternalPlanID.ExternalPlanIDCreatePlanVersionParamsProperties.ReplacePriceProperties.PriceProperties.EventOutputProperties;
    ...
    public required EventOutputConfig EventOutputConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<EventOutputConfig>(
                ...
                ?? throw new OrbInvalidDataException(
                    "'event_output_config' cannot be null",
                    new ArgumentNullException("event_output_config")
                );
        }
        set
        {
...
#pragma warning restore CS8618
    ...
    public static EventOutput FromRawUnchecked(Dictionary<string, JsonElement> properties)
    {
