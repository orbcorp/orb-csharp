...
using Orb.Models.Beta.ExternalPlanID.ExternalPlanIDCreatePlanVersionParamsProperties.ReplacePriceProperties.PriceProperties.GroupedWithMinMaxThresholdsProperties;
    ...
    public required GroupedWithMinMaxThresholdsConfig GroupedWithMinMaxThresholdsConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<GroupedWithMinMaxThresholdsConfig>(
                ...
                ?? throw new OrbInvalidDataException(
                    "'grouped_with_min_max_thresholds_config' cannot be null",
                    new ArgumentNullException("grouped_with_min_max_thresholds_config")
                );
        }
        set
        {
