...
namespace Orb.Models.Beta.ExternalPlanID.ExternalPlanIDCreatePlanVersionParamsProperties.ReplaceAdjustmentProperties.AdjustmentVariants;
...
public sealed record class NewPercentageDiscount(Models::NewPercentageDiscount Value)
    : ReplaceAdjustmentProperties::Adjustment,
