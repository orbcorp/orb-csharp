...
/// </summary>
[JsonConverter(
    typeof(global::Orb.Models.Beta.BetaCreatePlanVersionParamsProperties.ReplacePriceProperties.PriceConverter)
)]
public record class Price
{
    ...
    public static global::Orb.Models.Beta.BetaCreatePlanVersionParamsProperties.ReplacePriceProperties.Price CreateUnknownVariant(
        JsonElement value
    )
    {
...
sealed class PriceConverter
    : JsonConverter<global::Orb.Models.Beta.BetaCreatePlanVersionParamsProperties.ReplacePriceProperties.Price?>
{
    public override global::Orb.Models.Beta.BetaCreatePlanVersionParamsProperties.ReplacePriceProperties.Price? Read(
            ...
            case "unit":
            {
                ...
                try
                {
                    ...
                    if (deserialized != null)
                    {
                        ...
                        return new global::Orb.Models.Beta.BetaCreatePlanVersionParamsProperties.ReplacePriceProperties.Price(
                            deserialized
                        );
                    }
                }
    ...
    public override void Write(
        ...
        global::Orb.Models.Beta.BetaCreatePlanVersionParamsProperties.ReplacePriceProperties.Price? value,
        JsonSerializerOptions options
    )
    {
