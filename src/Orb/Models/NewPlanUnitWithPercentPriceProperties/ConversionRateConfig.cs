...
using ConversionRateConfigVariants = Orb.Models.NewPlanUnitWithPercentPriceProperties.ConversionRateConfigVariants;

namespace Orb.Models.NewPlanUnitWithPercentPriceProperties;
