...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    AutoCollectionModel(Dictionary<string, JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static AutoCollectionModel FromRawUnchecked(Dictionary<string, JsonElement> properties)
    {
        return new(properties);
    }
}
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    CustomerBalanceTransactionModel(Dictionary<string, JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    LineItem1(Dictionary<string, JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static LineItem1 FromRawUnchecked(Dictionary<string, JsonElement> properties)
    {
        return new(properties);
    }
}
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    PaymentAttemptModel(Dictionary<string, JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static PaymentAttemptModel FromRawUnchecked(Dictionary<string, JsonElement> properties)
    {
        return new(properties);
    }
}
