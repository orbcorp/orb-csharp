...
public sealed record class Invoice : ModelBase, IFromRaw<Invoice>
{
    ...
    public required List<CustomerBalanceTransactionModel> CustomerBalanceTransactions
    {
        get
        {
            if (
    ...
    /// </summary>
    public required List<LineItem1> LineItems
    {
        get
        {
    ...
    /// </summary>
    public required List<PaymentAttemptModel> PaymentAttempts
    {
        get
        {
...
#pragma warning restore CS8618
    ...
    public static Invoice FromRawUnchecked(IReadOnlyDictionary<string, JsonElement> properties)
    {
...
[JsonConverter(typeof(ModelConverter<CustomerBalanceTransactionModel>))]
public sealed record class CustomerBalanceTransactionModel
    : ModelBase,
        IFromRaw<CustomerBalanceTransactionModel>
{
    /// <summary>
    ...
    public CustomerBalanceTransactionModel(IReadOnlyDictionary<string, JsonElement> properties)
    {
        this._properties = [.. properties];
    }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    CustomerBalanceTransactionModel(FrozenDictionary<string, JsonElement> properties)
    {
        this._properties = [.. properties];
    }
#pragma warning restore CS8618
...
[JsonConverter(typeof(ModelConverter<LineItem1>))]
public sealed record class LineItem1 : ModelBase, IFromRaw<LineItem1>
{
    /// <summary>
    ...
    /// </summary>
    public required List<SubLineItemModel> SubLineItems
    {
        get
        {
    ...
    public LineItem1(IReadOnlyDictionary<string, JsonElement> properties)
    {
        this._properties = [.. properties];
    }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    LineItem1(FrozenDictionary<string, JsonElement> properties)
    {
        this._properties = [.. properties];
    }
#pragma warning restore CS8618

    public static LineItem1 FromRawUnchecked(IReadOnlyDictionary<string, JsonElement> properties)
    {
        return new(FrozenDictionary.ToFrozenDictionary(properties));
    }
}
...
[JsonConverter(typeof(ModelConverter<PaymentAttemptModel>))]
public sealed record class PaymentAttemptModel : ModelBase, IFromRaw<PaymentAttemptModel>
{
    /// <summary>
    ...
    public PaymentAttemptModel(IReadOnlyDictionary<string, JsonElement> properties)
    {
        this._properties = [.. properties];
    }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    PaymentAttemptModel(FrozenDictionary<string, JsonElement> properties)
    {
        this._properties = [.. properties];
    }
#pragma warning restore CS8618
