...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<CreditNoteListPageResponse>))]
public sealed record class CreditNoteListPageResponse
    : Orb::ModelBase,
        Orb::IFromRaw<CreditNoteListPageResponse>
{
    public required Generic::List<Models::CreditNote> Data
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<Generic::List<Models::CreditNote>>(element)
...
#pragma warning disable CS8618
    ...
    CreditNoteListPageResponse(Generic::Dictionary<string, Json::JsonElement> properties)
    {
