...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<MonetaryMaximumAdjustment>))]
public sealed record class MonetaryMaximumAdjustment
    : Orb::ModelBase,
        Orb::IFromRaw<MonetaryMaximumAdjustment>
{
    ...
    public required MonetaryMaximumAdjustmentProperties::AdjustmentType AdjustmentType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<MonetaryMaximumAdjustmentProperties::AdjustmentType>(
                    element
...
#pragma warning disable CS8618
    ...
    MonetaryMaximumAdjustment(Generic::Dictionary<string, Json::JsonElement> properties)
    {
