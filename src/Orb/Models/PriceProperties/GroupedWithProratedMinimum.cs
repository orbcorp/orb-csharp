...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<GroupedWithProratedMinimum>))]
public sealed record class GroupedWithProratedMinimum
    : Orb::ModelBase,
        Orb::IFromRaw<GroupedWithProratedMinimum>
{
    ...
    public required GroupedWithProratedMinimumProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<GroupedWithProratedMinimumProperties::Cadence>(
                    element
    ...
    public required GroupedWithProratedMinimumProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<GroupedWithProratedMinimumProperties::ConversionRateConfig?>(
                element
            );
        }
        set
    ...
    public required GroupedWithProratedMinimumProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<GroupedWithProratedMinimumProperties::ModelType>(
                    element
    ...
    public required GroupedWithProratedMinimumProperties::PriceType PriceType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<GroupedWithProratedMinimumProperties::PriceType>(
                    element
...
#pragma warning disable CS8618
    ...
    GroupedWithProratedMinimum(Generic::Dictionary<string, Json::JsonElement> properties)
    {
