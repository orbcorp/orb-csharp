        ...
        IFromRaw<ScalableMatrixWithTieredPricing>
{
    ...
    public required ScalableMatrixWithTieredPricingProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<ScalableMatrixWithTieredPricingProperties::Cadence>(
                    element,
                    ModelBase.SerializerOptions
    ...
    public required ScalableMatrixWithTieredPricingProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<ScalableMatrixWithTieredPricingProperties::ConversionRateConfig?>(
                element,
                ModelBase.SerializerOptions
            );
        }
    ...
    public required ScalableMatrixWithTieredPricingProperties::PriceType PriceType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<ScalableMatrixWithTieredPricingProperties::PriceType>(
                    element,
                    ModelBase.SerializerOptions
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    ScalableMatrixWithTieredPricing(Dictionary<string, JsonElement> properties)
    {
