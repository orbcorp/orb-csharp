...
public sealed record class BulkWithProration : ModelBase, IFromRaw<BulkWithProration>
{
    ...
    public required BulkWithProrationProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<BulkWithProrationProperties::Cadence>(
                    element,
                    ModelBase.SerializerOptions
    ...
    public required BulkWithProrationProperties::PriceType PriceType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<BulkWithProrationProperties::PriceType>(
                    element,
                    ModelBase.SerializerOptions
