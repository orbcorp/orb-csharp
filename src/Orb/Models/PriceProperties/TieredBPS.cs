...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<TieredBPS>))]
public sealed record class TieredBPS : Orb::ModelBase, Orb::IFromRaw<TieredBPS>
{
    ...
    public required TieredBPSProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<TieredBPSProperties::Cadence>(element)
    ...
    public required TieredBPSProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<TieredBPSProperties::ConversionRateConfig?>(
                element
            );
        }
        set
    ...
    public required TieredBPSProperties::PriceType PriceType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<TieredBPSProperties::PriceType>(element)
...
#pragma warning disable CS8618
    ...
    TieredBPS(Generic::Dictionary<string, Json::JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static TieredBPS FromRawUnchecked(
