...
[JsonConverter(typeof(ModelConverter<TieredBPS>))]
public sealed record class TieredBPS : ModelBase, IFromRaw<TieredBPS>
{
    ...
    public required TieredBPSProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<TieredBPSProperties::Cadence>(element)
    ...
    public required TieredBPSProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<TieredBPSProperties::ConversionRateConfig?>(element);
        }
        set
        {
    ...
    public required TieredBPSProperties::PriceType PriceType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<TieredBPSProperties::PriceType>(element)
    ...
    public required Models::TieredBPSConfig TieredBPSConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<Models::TieredBPSConfig>(element)
                ?? throw new ArgumentNullException("tiered_bps_config");
        }
    ...
    public TieredBPS()
    {
        this.ModelType = JsonSerializer.Deserialize<JsonElement>("\"tiered_bps\"");
    }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    TieredBPS(Dictionary<string, JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static TieredBPS FromRawUnchecked(Dictionary<string, JsonElement> properties)
    {
