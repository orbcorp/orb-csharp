...
using ConversionRateConfigVariants = Orb.Models.PriceProperties.EventOutputProperties.ConversionRateConfigVariants;

namespace Orb.Models.PriceProperties.EventOutputProperties;
