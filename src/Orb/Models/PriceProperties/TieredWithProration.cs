...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<TieredWithProration>))]
public sealed record class TieredWithProration : Orb::ModelBase, Orb::IFromRaw<TieredWithProration>
{
    ...
    public required TieredWithProrationProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<TieredWithProrationProperties::Cadence>(element)
    ...
    public required TieredWithProrationProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<TieredWithProrationProperties::ConversionRateConfig?>(
                element
            );
        }
        set
    ...
    public required TieredWithProrationProperties::PriceType PriceType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<TieredWithProrationProperties::PriceType>(
                    element
...
#pragma warning disable CS8618
    ...
    TieredWithProration(Generic::Dictionary<string, Json::JsonElement> properties)
    {
