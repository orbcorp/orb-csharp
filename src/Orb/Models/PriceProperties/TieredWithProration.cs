...
public sealed record class TieredWithProration : ModelBase, IFromRaw<TieredWithProration>
{
    ...
    public required TieredWithProrationProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<TieredWithProrationProperties::Cadence>(element)
    ...
    public required TieredWithProrationProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<TieredWithProrationProperties::ConversionRateConfig?>(
                element
            );
        }
        set
    ...
    public required TieredWithProrationProperties::PriceType PriceType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<TieredWithProrationProperties::PriceType>(element)
