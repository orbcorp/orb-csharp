...
public sealed record class TieredWithMinimum : ModelBase, IFromRaw<TieredWithMinimum>
{
    ...
    public required TieredWithMinimumProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<TieredWithMinimumProperties::Cadence>(element)
    ...
    public required TieredWithMinimumProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<TieredWithMinimumProperties::ConversionRateConfig?>(
                element
            );
        }
        set
    ...
    public required TieredWithMinimumProperties::PriceType PriceType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<TieredWithMinimumProperties::PriceType>(element)
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    TieredWithMinimum(Dictionary<string, JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static TieredWithMinimum FromRawUnchecked(Dictionary<string, JsonElement> properties)
    {
