...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<TieredWithMinimum>))]
public sealed record class TieredWithMinimum : Orb::ModelBase, Orb::IFromRaw<TieredWithMinimum>
{
    ...
    public required TieredWithMinimumProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<TieredWithMinimumProperties::Cadence>(element)
    ...
    public required TieredWithMinimumProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<TieredWithMinimumProperties::ConversionRateConfig?>(
                element
            );
        }
        set
    ...
    public required TieredWithMinimumProperties::PriceType PriceType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<TieredWithMinimumProperties::PriceType>(element)
...
#pragma warning disable CS8618
    ...
    TieredWithMinimum(Generic::Dictionary<string, Json::JsonElement> properties)
    {
