...
using ConversionRateConfigVariants = Orb.Models.PriceProperties.UnitWithPercentProperties.ConversionRateConfigVariants;

namespace Orb.Models.PriceProperties.UnitWithPercentProperties;
