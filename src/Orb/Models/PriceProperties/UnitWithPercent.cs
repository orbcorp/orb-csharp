...
public sealed record class UnitWithPercent : ModelBase, IFromRaw<UnitWithPercent>
{
    ...
    public required UnitWithPercentProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<UnitWithPercentProperties::Cadence>(element)
    ...
    public required UnitWithPercentProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<UnitWithPercentProperties::ConversionRateConfig?>(
                element
            );
        }
        set
    ...
    public required UnitWithPercentProperties::PriceType PriceType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<UnitWithPercentProperties::PriceType>(element)
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    UnitWithPercent(Dictionary<string, JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static UnitWithPercent FromRawUnchecked(Dictionary<string, JsonElement> properties)
    {
