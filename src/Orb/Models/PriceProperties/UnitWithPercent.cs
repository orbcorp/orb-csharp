...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<UnitWithPercent>))]
public sealed record class UnitWithPercent : Orb::ModelBase, Orb::IFromRaw<UnitWithPercent>
{
    ...
    public required UnitWithPercentProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<UnitWithPercentProperties::Cadence>(element)
    ...
    public required UnitWithPercentProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<UnitWithPercentProperties::ConversionRateConfig?>(
                element
            );
        }
        set
    ...
    public required UnitWithPercentProperties::PriceType PriceType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<UnitWithPercentProperties::PriceType>(element)
...
#pragma warning disable CS8618
    ...
    UnitWithPercent(Generic::Dictionary<string, Json::JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static UnitWithPercent FromRawUnchecked(
