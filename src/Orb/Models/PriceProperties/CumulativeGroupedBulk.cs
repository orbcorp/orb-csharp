...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<CumulativeGroupedBulk>))]
public sealed record class CumulativeGroupedBulk
    : Orb::ModelBase,
        Orb::IFromRaw<CumulativeGroupedBulk>
{
    ...
    public required CumulativeGroupedBulkProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<CumulativeGroupedBulkProperties::Cadence>(
                    element
    ...
    public required CumulativeGroupedBulkProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<CumulativeGroupedBulkProperties::ConversionRateConfig?>(
                element
            );
        }
        set
    ...
    public required CumulativeGroupedBulkProperties::PriceType PriceType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<CumulativeGroupedBulkProperties::PriceType>(
                    element
...
#pragma warning disable CS8618
    ...
    CumulativeGroupedBulk(Generic::Dictionary<string, Json::JsonElement> properties)
    {
