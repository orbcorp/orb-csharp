...
public sealed record class CumulativeGroupedBulk : ModelBase, IFromRaw<CumulativeGroupedBulk>
{
    ...
    public required CumulativeGroupedBulkProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<CumulativeGroupedBulkProperties::Cadence>(element)
    ...
    public required CumulativeGroupedBulkProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<CumulativeGroupedBulkProperties::ConversionRateConfig?>(
                element
            );
        }
        set
    ...
    public required CumulativeGroupedBulkProperties::PriceType PriceType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<CumulativeGroupedBulkProperties::PriceType>(element)
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    CumulativeGroupedBulk(Dictionary<string, JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static CumulativeGroupedBulk FromRawUnchecked(Dictionary<string, JsonElement> properties)
    {
