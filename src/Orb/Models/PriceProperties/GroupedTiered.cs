...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<GroupedTiered>))]
public sealed record class GroupedTiered : Orb::ModelBase, Orb::IFromRaw<GroupedTiered>
{
    ...
    public required GroupedTieredProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<GroupedTieredProperties::Cadence>(element)
    ...
    public required GroupedTieredProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<GroupedTieredProperties::ConversionRateConfig?>(
                element
            );
        }
        set
    ...
    public required GroupedTieredProperties::PriceType PriceType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<GroupedTieredProperties::PriceType>(element)
...
#pragma warning disable CS8618
    ...
    GroupedTiered(Generic::Dictionary<string, Json::JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static GroupedTiered FromRawUnchecked(
