...
public sealed record class GroupedTiered : ModelBase, IFromRaw<GroupedTiered>
{
    ...
    public required GroupedTieredProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<GroupedTieredProperties::Cadence>(element)
    ...
    public required GroupedTieredProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<GroupedTieredProperties::ConversionRateConfig?>(
                element
            );
        }
        set
    ...
    public required GroupedTieredProperties::PriceType PriceType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<GroupedTieredProperties::PriceType>(element)
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    GroupedTiered(Dictionary<string, JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static GroupedTiered FromRawUnchecked(Dictionary<string, JsonElement> properties)
    {
