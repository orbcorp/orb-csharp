...
using TieredWithProrationConfigProperties = Orb.Models.PriceProperties.TieredWithProrationProperties.TieredWithProrationConfigProperties;

namespace Orb.Models.PriceProperties.TieredWithProrationProperties;
