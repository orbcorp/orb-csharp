...
using ConversionRateConfigVariants = Orb.Models.PriceProperties.TieredBPSProperties.ConversionRateConfigVariants;

namespace Orb.Models.PriceProperties.TieredBPSProperties;
