...
public sealed record class MatrixWithAllocation : ModelBase, IFromRaw<MatrixWithAllocation>
{
    ...
    public required MatrixWithAllocationProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<MatrixWithAllocationProperties::Cadence>(element)
    ...
    public required MatrixWithAllocationProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<MatrixWithAllocationProperties::ConversionRateConfig?>(
                element
            );
        }
        set
    ...
    public required MatrixWithAllocationProperties::PriceType PriceType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<MatrixWithAllocationProperties::PriceType>(element)
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    MatrixWithAllocation(Dictionary<string, JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static MatrixWithAllocation FromRawUnchecked(Dictionary<string, JsonElement> properties)
    {
