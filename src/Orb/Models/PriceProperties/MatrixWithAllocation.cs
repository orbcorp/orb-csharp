...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<MatrixWithAllocation>))]
public sealed record class MatrixWithAllocation
    : Orb::ModelBase,
        Orb::IFromRaw<MatrixWithAllocation>
{
    ...
    public required MatrixWithAllocationProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<MatrixWithAllocationProperties::Cadence>(
                    element
    ...
    public required MatrixWithAllocationProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<MatrixWithAllocationProperties::ConversionRateConfig?>(
                element
            );
        }
        set
    ...
    public required MatrixWithAllocationProperties::PriceType PriceType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<MatrixWithAllocationProperties::PriceType>(
                    element
...
#pragma warning disable CS8618
    ...
    MatrixWithAllocation(Generic::Dictionary<string, Json::JsonElement> properties)
    {
