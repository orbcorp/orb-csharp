...
using ConversionRateConfigVariants = Orb.Models.PriceProperties.PercentProperties.ConversionRateConfigVariants;

namespace Orb.Models.PriceProperties.PercentProperties;
