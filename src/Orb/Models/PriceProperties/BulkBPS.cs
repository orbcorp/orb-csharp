...
[JsonConverter(typeof(ModelConverter<BulkBPS>))]
public sealed record class BulkBPS : ModelBase, IFromRaw<BulkBPS>
{
    ...
    public BulkBPS()
    {
        this.ModelType = JsonSerializer.Deserialize<JsonElement>("\"bulk_bps\"");
    }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    BulkBPS(Dictionary<string, JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static BulkBPS FromRawUnchecked(Dictionary<string, JsonElement> properties)
    {
