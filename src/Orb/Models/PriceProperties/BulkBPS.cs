...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<BulkBPS>))]
public sealed record class BulkBPS : Orb::ModelBase, Orb::IFromRaw<BulkBPS>
{
    ...
    public required BulkBPSProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<BulkBPSProperties::Cadence>(element)
    ...
    public required BulkBPSProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<BulkBPSProperties::ConversionRateConfig?>(
                element
            );
        }
        set
    ...
    public required BulkBPSProperties::PriceType PriceType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<BulkBPSProperties::PriceType>(element)
    ...
    public override void Validate()
    {
        ...
        if (
            !this.ModelType.Equals(
                Json::JsonSerializer.Deserialize<Json::JsonElement>("\"bulk_bps\"")
            )
        )
        {
    ...
    public BulkBPS()
    {
        this.ModelType = Json::JsonSerializer.Deserialize<Json::JsonElement>("\"bulk_bps\"");
    }

#pragma warning disable CS8618
    [CodeAnalysis::SetsRequiredMembers]
    BulkBPS(Generic::Dictionary<string, Json::JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static BulkBPS FromRawUnchecked(
