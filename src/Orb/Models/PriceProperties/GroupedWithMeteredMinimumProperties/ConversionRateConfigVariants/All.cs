...
namespace Orb.Models.PriceProperties.GroupedWithMeteredMinimumProperties.ConversionRateConfigVariants;
...
public sealed record class UnitConversionRateConfig(Models::UnitConversionRateConfig Value)
    : GroupedWithMeteredMinimumProperties::ConversionRateConfig,
