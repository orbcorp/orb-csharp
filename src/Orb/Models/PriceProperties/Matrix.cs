...
public sealed record class Matrix : ModelBase, IFromRaw<Matrix>
{
    ...
    public required MatrixProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<MatrixProperties::Cadence>(element)
    ...
    public required MatrixProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<MatrixProperties::ConversionRateConfig?>(element);
        }
        set
        {
    ...
    public required MatrixProperties::PriceType PriceType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<MatrixProperties::PriceType>(element)
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    Matrix(Dictionary<string, JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static Matrix FromRawUnchecked(Dictionary<string, JsonElement> properties)
    {
