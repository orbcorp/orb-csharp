...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<Matrix>))]
public sealed record class Matrix : Orb::ModelBase, Orb::IFromRaw<Matrix>
{
    ...
    public required MatrixProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<MatrixProperties::Cadence>(element)
    ...
    public required MatrixProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<MatrixProperties::ConversionRateConfig?>(
                element
            );
        }
        set
    ...
    public required MatrixProperties::PriceType PriceType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<MatrixProperties::PriceType>(element)
...
#pragma warning disable CS8618
    ...
    Matrix(Generic::Dictionary<string, Json::JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static Matrix FromRawUnchecked(Generic::Dictionary<string, Json::JsonElement> properties)
    {
