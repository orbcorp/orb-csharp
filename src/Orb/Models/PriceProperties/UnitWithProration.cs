...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<UnitWithProration>))]
public sealed record class UnitWithProration : Orb::ModelBase, Orb::IFromRaw<UnitWithProration>
{
    ...
    public required UnitWithProrationProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<UnitWithProrationProperties::Cadence>(element)
    ...
    public required UnitWithProrationProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<UnitWithProrationProperties::ConversionRateConfig?>(
                element
            );
        }
        set
    ...
    public required UnitWithProrationProperties::PriceType PriceType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<UnitWithProrationProperties::PriceType>(element)
...
#pragma warning disable CS8618
    ...
    UnitWithProration(Generic::Dictionary<string, Json::JsonElement> properties)
    {
