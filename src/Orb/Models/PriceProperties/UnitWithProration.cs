...
public sealed record class UnitWithProration : ModelBase, IFromRaw<UnitWithProration>
{
    ...
    public required UnitWithProrationProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<UnitWithProrationProperties::Cadence>(element)
    ...
    public required UnitWithProrationProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<UnitWithProrationProperties::ConversionRateConfig?>(
                element
            );
        }
        set
    ...
    public required UnitWithProrationProperties::PriceType PriceType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<UnitWithProrationProperties::PriceType>(element)
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    UnitWithProration(Dictionary<string, JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static UnitWithProration FromRawUnchecked(Dictionary<string, JsonElement> properties)
    {
