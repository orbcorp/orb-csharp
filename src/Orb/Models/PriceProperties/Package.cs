...
public sealed record class Package : ModelBase, IFromRaw<Package>
{
    ...
    public required PackageProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<PackageProperties::Cadence>(element)
    ...
    public required PackageProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<PackageProperties::ConversionRateConfig?>(element);
        }
        set
        {
    ...
    public required Models::PackageConfig PackageConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<Models::PackageConfig>(element)
                ?? throw new ArgumentNullException("package_config");
        }
    ...
    public required PackageProperties::PriceType PriceType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<PackageProperties::PriceType>(element)
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    Package(Dictionary<string, JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static Package FromRawUnchecked(Dictionary<string, JsonElement> properties)
    {
