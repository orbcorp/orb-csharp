...
public sealed record class Package : ModelBase, IFromRaw<Package>
{
    ...
    public required PackageProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<PackageProperties::Cadence>(
                    element,
                    ModelBase.SerializerOptions
    ...
    public required PackageProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<PackageProperties::ConversionRateConfig?>(
                element,
                ModelBase.SerializerOptions
            );
        }
    ...
    public required PackageProperties::PriceType PriceType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<PackageProperties::PriceType>(
                    element,
                    ModelBase.SerializerOptions
