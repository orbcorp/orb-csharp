...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<Package>))]
public sealed record class Package : Orb::ModelBase, Orb::IFromRaw<Package>
{
    ...
    public required PackageProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<PackageProperties::Cadence>(element)
    ...
    public required PackageProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<PackageProperties::ConversionRateConfig?>(
                element
            );
        }
        set
    ...
    public required PackageProperties::PriceType PriceType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<PackageProperties::PriceType>(element)
...
#pragma warning disable CS8618
    ...
    Package(Generic::Dictionary<string, Json::JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static Package FromRawUnchecked(
