...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<GroupedTieredPackage>))]
public sealed record class GroupedTieredPackage
    : Orb::ModelBase,
        Orb::IFromRaw<GroupedTieredPackage>
{
    ...
    public required GroupedTieredPackageProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<GroupedTieredPackageProperties::Cadence>(
                    element
    ...
    public required GroupedTieredPackageProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<GroupedTieredPackageProperties::ConversionRateConfig?>(
                element
            );
        }
        set
    ...
    public required GroupedTieredPackageProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<GroupedTieredPackageProperties::ModelType>(
                    element
    ...
    public required GroupedTieredPackageProperties::PriceType PriceType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<GroupedTieredPackageProperties::PriceType>(
                    element
...
#pragma warning disable CS8618
    ...
    GroupedTieredPackage(Generic::Dictionary<string, Json::JsonElement> properties)
    {
