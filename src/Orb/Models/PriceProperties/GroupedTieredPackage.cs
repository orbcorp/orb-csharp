...
public sealed record class GroupedTieredPackage : ModelBase, IFromRaw<GroupedTieredPackage>
{
    ...
    public required GroupedTieredPackageProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<GroupedTieredPackageProperties::Cadence>(element)
    ...
    public required GroupedTieredPackageProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<GroupedTieredPackageProperties::ConversionRateConfig?>(
                element
            );
        }
        set
    ...
    public required GroupedTieredPackageProperties::PriceType PriceType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<GroupedTieredPackageProperties::PriceType>(element)
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    GroupedTieredPackage(Dictionary<string, JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static GroupedTieredPackage FromRawUnchecked(Dictionary<string, JsonElement> properties)
    {
