...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<PackageWithAllocation>))]
public sealed record class PackageWithAllocation
    : Orb::ModelBase,
        Orb::IFromRaw<PackageWithAllocation>
{
    ...
    public required PackageWithAllocationProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<PackageWithAllocationProperties::Cadence>(
                    element
    ...
    public required PackageWithAllocationProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<PackageWithAllocationProperties::ConversionRateConfig?>(
                element
            );
        }
        set
    ...
    public required PackageWithAllocationProperties::PriceType PriceType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<PackageWithAllocationProperties::PriceType>(
                    element
...
#pragma warning disable CS8618
    ...
    PackageWithAllocation(Generic::Dictionary<string, Json::JsonElement> properties)
    {
