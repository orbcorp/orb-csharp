...
public sealed record class PackageWithAllocation : ModelBase, IFromRaw<PackageWithAllocation>
{
    ...
    public required PackageWithAllocationProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<PackageWithAllocationProperties::Cadence>(element)
    ...
    public required PackageWithAllocationProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<PackageWithAllocationProperties::ConversionRateConfig?>(
                element
            );
        }
        set
    ...
    public required PackageWithAllocationProperties::PriceType PriceType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<PackageWithAllocationProperties::PriceType>(element)
