...
public sealed record class Unit : ModelBase, IFromRaw<Unit>
{
    ...
    public required UnitProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<UnitProperties::Cadence>(
                    element,
                    ModelBase.SerializerOptions
    ...
    public required UnitProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<UnitProperties::ConversionRateConfig?>(
                element,
                ModelBase.SerializerOptions
            );
        }
    ...
    public required UnitProperties::PriceType PriceType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<UnitProperties::PriceType>(
                    element,
                    ModelBase.SerializerOptions
