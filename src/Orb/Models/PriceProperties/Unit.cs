...
public sealed record class Unit : ModelBase, IFromRaw<Unit>
{
    ...
    public required UnitProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<UnitProperties::Cadence>(element)
    ...
    public required UnitProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<UnitProperties::ConversionRateConfig?>(element);
        }
        set
        {
    ...
    public required UnitProperties::PriceType PriceType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<UnitProperties::PriceType>(element)
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    Unit(Dictionary<string, JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static Unit FromRawUnchecked(Dictionary<string, JsonElement> properties)
    {
