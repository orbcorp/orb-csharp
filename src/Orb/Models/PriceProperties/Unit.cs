...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<Unit>))]
public sealed record class Unit : Orb::ModelBase, Orb::IFromRaw<Unit>
{
    ...
    public required UnitProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<UnitProperties::Cadence>(element)
    ...
    public required UnitProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<UnitProperties::ConversionRateConfig?>(element);
        }
        set
        {
    ...
    public required UnitProperties::PriceType PriceType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<UnitProperties::PriceType>(element)
...
#pragma warning disable CS8618
    ...
    Unit(Generic::Dictionary<string, Json::JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static Unit FromRawUnchecked(Generic::Dictionary<string, Json::JsonElement> properties)
    {
