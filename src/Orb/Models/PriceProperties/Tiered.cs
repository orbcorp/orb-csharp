...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<Tiered>))]
public sealed record class Tiered : Orb::ModelBase, Orb::IFromRaw<Tiered>
{
    ...
    public required TieredProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<TieredProperties::Cadence>(element)
    ...
    public required TieredProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<TieredProperties::ConversionRateConfig?>(
                element
            );
        }
        set
    ...
    public required TieredProperties::PriceType PriceType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<TieredProperties::PriceType>(element)
    ...
    public required Models::TieredConfig TieredConfig
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<Models::TieredConfig>(element)
    ...
    public override void Validate()
    {
        ...
        if (
            !this.ModelType.Equals(
                Json::JsonSerializer.Deserialize<Json::JsonElement>("\"tiered\"")
            )
        )
        {
    ...
    public Tiered()
    {
        this.ModelType = Json::JsonSerializer.Deserialize<Json::JsonElement>("\"tiered\"");
    }

#pragma warning disable CS8618
    [CodeAnalysis::SetsRequiredMembers]
    Tiered(Generic::Dictionary<string, Json::JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static Tiered FromRawUnchecked(Generic::Dictionary<string, Json::JsonElement> properties)
    {
