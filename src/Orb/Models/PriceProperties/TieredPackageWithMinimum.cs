...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<TieredPackageWithMinimum>))]
public sealed record class TieredPackageWithMinimum
    : Orb::ModelBase,
        Orb::IFromRaw<TieredPackageWithMinimum>
{
    ...
    public required TieredPackageWithMinimumProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<TieredPackageWithMinimumProperties::Cadence>(
                    element
    ...
    public required TieredPackageWithMinimumProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<TieredPackageWithMinimumProperties::ConversionRateConfig?>(
                element
            );
        }
        set
    ...
    public required TieredPackageWithMinimumProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<TieredPackageWithMinimumProperties::ModelType>(
                    element
    ...
    public required TieredPackageWithMinimumProperties::PriceType PriceType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<TieredPackageWithMinimumProperties::PriceType>(
                    element
    ...
    public required Generic::Dictionary<string, Json::JsonElement> TieredPackageWithMinimumConfig
    {
        get
        {
            if (
    ...
    public override void Validate()
    {
        ...
        foreach (var item in this.TieredPackageWithMinimumConfig.Values)
        {
            _ = item;
        }
...
#pragma warning disable CS8618
    ...
    TieredPackageWithMinimum(Generic::Dictionary<string, Json::JsonElement> properties)
    {
