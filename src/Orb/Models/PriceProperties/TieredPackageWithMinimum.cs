...
public sealed record class TieredPackageWithMinimum : ModelBase, IFromRaw<TieredPackageWithMinimum>
{
    ...
    public required TieredPackageWithMinimumProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<TieredPackageWithMinimumProperties::Cadence>(element)
    ...
    public required TieredPackageWithMinimumProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<TieredPackageWithMinimumProperties::ConversionRateConfig?>(
                element
            );
        }
        set
    ...
    public required TieredPackageWithMinimumProperties::PriceType PriceType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<TieredPackageWithMinimumProperties::PriceType>(
                    element
    ...
    public required Dictionary<string, JsonElement> TieredPackageWithMinimumConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<Dictionary<string, JsonElement>>(element)
                ?? throw new ArgumentNullException("tiered_package_with_minimum_config");
        }
        set
        {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    TieredPackageWithMinimum(Dictionary<string, JsonElement> properties)
    {
