...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<ScalableMatrixWithUnitPricing>))]
public sealed record class ScalableMatrixWithUnitPricing
    : Orb::ModelBase,
        Orb::IFromRaw<ScalableMatrixWithUnitPricing>
{
    ...
    public required ScalableMatrixWithUnitPricingProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<ScalableMatrixWithUnitPricingProperties::Cadence>(
                    element
    ...
    public required ScalableMatrixWithUnitPricingProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<ScalableMatrixWithUnitPricingProperties::ConversionRateConfig?>(
                element
            );
        }
        set
    ...
    public required ScalableMatrixWithUnitPricingProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<ScalableMatrixWithUnitPricingProperties::ModelType>(
                    element
    ...
    public required ScalableMatrixWithUnitPricingProperties::PriceType PriceType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<ScalableMatrixWithUnitPricingProperties::PriceType>(
                    element
...
#pragma warning disable CS8618
    ...
    ScalableMatrixWithUnitPricing(Generic::Dictionary<string, Json::JsonElement> properties)
    {
