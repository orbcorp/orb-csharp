        ...
        IFromRaw<ScalableMatrixWithUnitPricing>
{
    ...
    public required ScalableMatrixWithUnitPricingProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<ScalableMatrixWithUnitPricingProperties::Cadence>(
                    element,
                    ModelBase.SerializerOptions
    ...
    public required ScalableMatrixWithUnitPricingProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<ScalableMatrixWithUnitPricingProperties::ConversionRateConfig?>(
                element,
                ModelBase.SerializerOptions
            );
        }
    ...
    public required ScalableMatrixWithUnitPricingProperties::PriceType PriceType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<ScalableMatrixWithUnitPricingProperties::PriceType>(
                    element,
                    ModelBase.SerializerOptions
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    ScalableMatrixWithUnitPricing(Dictionary<string, JsonElement> properties)
    {
