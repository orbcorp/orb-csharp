...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<MatrixWithDisplayName>))]
public sealed record class MatrixWithDisplayName
    : Orb::ModelBase,
        Orb::IFromRaw<MatrixWithDisplayName>
{
    ...
    public required MatrixWithDisplayNameProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<MatrixWithDisplayNameProperties::Cadence>(
                    element
    ...
    public required MatrixWithDisplayNameProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<MatrixWithDisplayNameProperties::ConversionRateConfig?>(
                element
            );
        }
        set
    ...
    public required MatrixWithDisplayNameProperties::PriceType PriceType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<MatrixWithDisplayNameProperties::PriceType>(
                    element
...
#pragma warning disable CS8618
    ...
    MatrixWithDisplayName(Generic::Dictionary<string, Json::JsonElement> properties)
    {
