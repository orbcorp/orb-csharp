...
public sealed record class MatrixWithDisplayName : ModelBase, IFromRaw<MatrixWithDisplayName>
{
    ...
    public required MatrixWithDisplayNameProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<MatrixWithDisplayNameProperties::Cadence>(element)
    ...
    public required MatrixWithDisplayNameProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<MatrixWithDisplayNameProperties::ConversionRateConfig?>(
                element
            );
        }
        set
    ...
    public required MatrixWithDisplayNameProperties::PriceType PriceType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<MatrixWithDisplayNameProperties::PriceType>(element)
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    MatrixWithDisplayName(Dictionary<string, JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static MatrixWithDisplayName FromRawUnchecked(Dictionary<string, JsonElement> properties)
    {
