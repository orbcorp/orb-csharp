...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<ThresholdTotalAmount>))]
public sealed record class ThresholdTotalAmount
    : Orb::ModelBase,
        Orb::IFromRaw<ThresholdTotalAmount>
{
    ...
    public required ThresholdTotalAmountProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<ThresholdTotalAmountProperties::Cadence>(
                    element
    ...
    public required ThresholdTotalAmountProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<ThresholdTotalAmountProperties::ConversionRateConfig?>(
                element
            );
        }
        set
    ...
    public required ThresholdTotalAmountProperties::PriceType PriceType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<ThresholdTotalAmountProperties::PriceType>(
                    element
...
#pragma warning disable CS8618
    ...
    ThresholdTotalAmount(Generic::Dictionary<string, Json::JsonElement> properties)
    {
