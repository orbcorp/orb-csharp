...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<BPS>))]
public sealed record class BPS : Orb::ModelBase, Orb::IFromRaw<BPS>
{
    ...
    public required BPSProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<BPSProperties::Cadence>(element)
    ...
    public required BPSProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<BPSProperties::ConversionRateConfig?>(element);
        }
        set
        {
    ...
    public required BPSProperties::PriceType PriceType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<BPSProperties::PriceType>(element)
...
#pragma warning disable CS8618
    ...
    BPS(Generic::Dictionary<string, Json::JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static BPS FromRawUnchecked(Generic::Dictionary<string, Json::JsonElement> properties)
    {
