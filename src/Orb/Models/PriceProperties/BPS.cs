...
[JsonConverter(typeof(ModelConverter<BPS>))]
public sealed record class BPS : ModelBase, IFromRaw<BPS>
{
    ...
    public required Models::BPSConfig BPSConfig
    {
        get
        {
            if (!this.Properties.TryGetValue("bps_config", out JsonElement element))
                throw new ArgumentOutOfRangeException("bps_config", "Missing required argument");

            return JsonSerializer.Deserialize<Models::BPSConfig>(element)
                ?? throw new ArgumentNullException("bps_config");
        }
        set { this.Properties["bps_config"] = JsonSerializer.SerializeToElement(value); }
    }

    public required BPSProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<BPSProperties::Cadence>(element)
    ...
    public required BPSProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<BPSProperties::ConversionRateConfig?>(element);
        }
        set
        {
    ...
    public required BPSProperties::PriceType PriceType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<BPSProperties::PriceType>(element)
    ...
    public BPS()
    {
        this.ModelType = JsonSerializer.Deserialize<JsonElement>("\"bps\"");
    }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    BPS(Dictionary<string, JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static BPS FromRawUnchecked(Dictionary<string, JsonElement> properties)
    {
