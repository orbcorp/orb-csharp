...
public sealed record class BPS : ModelBase, IFromRaw<BPS>
{
    ...
    public required Models::BPSConfig BPSConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<Models::BPSConfig>(
                    element,
                    ModelBase.SerializerOptions
    ...
    public required BPSProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<BPSProperties::Cadence>(
                    element,
                    ModelBase.SerializerOptions
    ...
    public required BPSProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<BPSProperties::ConversionRateConfig?>(
                element,
                ModelBase.SerializerOptions
            );
        }
    ...
    public required BPSProperties::PriceType PriceType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<BPSProperties::PriceType>(
                    element,
                    ModelBase.SerializerOptions
