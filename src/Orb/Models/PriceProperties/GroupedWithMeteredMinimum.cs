...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<GroupedWithMeteredMinimum>))]
public sealed record class GroupedWithMeteredMinimum
    : Orb::ModelBase,
        Orb::IFromRaw<GroupedWithMeteredMinimum>
{
    ...
    public required GroupedWithMeteredMinimumProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<GroupedWithMeteredMinimumProperties::Cadence>(
                    element
    ...
    public required GroupedWithMeteredMinimumProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<GroupedWithMeteredMinimumProperties::ConversionRateConfig?>(
                element
            );
        }
        set
    ...
    public required GroupedWithMeteredMinimumProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<GroupedWithMeteredMinimumProperties::ModelType>(
                    element
    ...
    public required GroupedWithMeteredMinimumProperties::PriceType PriceType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<GroupedWithMeteredMinimumProperties::PriceType>(
                    element
...
#pragma warning disable CS8618
    ...
    GroupedWithMeteredMinimum(Generic::Dictionary<string, Json::JsonElement> properties)
    {
