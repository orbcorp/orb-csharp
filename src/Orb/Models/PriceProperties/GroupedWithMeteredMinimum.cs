        ...
        IFromRaw<GroupedWithMeteredMinimum>
{
    ...
    public required GroupedWithMeteredMinimumProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<GroupedWithMeteredMinimumProperties::Cadence>(element)
    ...
    public required GroupedWithMeteredMinimumProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<GroupedWithMeteredMinimumProperties::ConversionRateConfig?>(
                element
            );
        }
        set
    ...
    public required GroupedWithMeteredMinimumProperties::PriceType PriceType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<GroupedWithMeteredMinimumProperties::PriceType>(
                    element
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    GroupedWithMeteredMinimum(Dictionary<string, JsonElement> properties)
    {
