...
public sealed record class TieredPackage : ModelBase, IFromRaw<TieredPackage>
{
    ...
    public required TieredPackageProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<TieredPackageProperties::Cadence>(element)
    ...
    public required TieredPackageProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<TieredPackageProperties::ConversionRateConfig?>(
                element
            );
        }
        set
    ...
    public required TieredPackageProperties::PriceType PriceType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<TieredPackageProperties::PriceType>(element)
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    TieredPackage(Dictionary<string, JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static TieredPackage FromRawUnchecked(Dictionary<string, JsonElement> properties)
    {
