...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<TieredPackage>))]
public sealed record class TieredPackage : Orb::ModelBase, Orb::IFromRaw<TieredPackage>
{
    ...
    public required TieredPackageProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<TieredPackageProperties::Cadence>(element)
    ...
    public required TieredPackageProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<TieredPackageProperties::ConversionRateConfig?>(
                element
            );
        }
        set
    ...
    public required TieredPackageProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<TieredPackageProperties::ModelType>(element)
    ...
    public required TieredPackageProperties::PriceType PriceType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<TieredPackageProperties::PriceType>(element)
    ...
    public required Generic::Dictionary<string, Json::JsonElement> TieredPackageConfig
    {
        get
        {
            if (
                !this.Properties.TryGetValue("tiered_package_config", out Json::JsonElement element)
            )
                throw new System::ArgumentOutOfRangeException(
            ...
            return Json::JsonSerializer.Deserialize<Generic::Dictionary<string, Json::JsonElement>>(
                    element
                ) ?? throw new System::ArgumentNullException("tiered_package_config");
        }
        set
        {
            this.Properties["tiered_package_config"] = Json::JsonSerializer.SerializeToElement(
                value
            );
        }
    }
...
#pragma warning disable CS8618
    ...
    TieredPackage(Generic::Dictionary<string, Json::JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static TieredPackage FromRawUnchecked(
