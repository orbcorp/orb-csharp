...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<MaxGroupTieredPackage>))]
public sealed record class MaxGroupTieredPackage
    : Orb::ModelBase,
        Orb::IFromRaw<MaxGroupTieredPackage>
{
    ...
    public required MaxGroupTieredPackageProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<MaxGroupTieredPackageProperties::Cadence>(
                    element
    ...
    public required MaxGroupTieredPackageProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<MaxGroupTieredPackageProperties::ConversionRateConfig?>(
                element
            );
        }
        set
    ...
    public required MaxGroupTieredPackageProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<MaxGroupTieredPackageProperties::ModelType>(
                    element
    ...
    public required MaxGroupTieredPackageProperties::PriceType PriceType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<MaxGroupTieredPackageProperties::PriceType>(
                    element
...
#pragma warning disable CS8618
    ...
    MaxGroupTieredPackage(Generic::Dictionary<string, Json::JsonElement> properties)
    {
