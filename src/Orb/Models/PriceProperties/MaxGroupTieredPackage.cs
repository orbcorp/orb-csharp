...
public sealed record class MaxGroupTieredPackage : ModelBase, IFromRaw<MaxGroupTieredPackage>
{
    ...
    public required MaxGroupTieredPackageProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<MaxGroupTieredPackageProperties::Cadence>(element)
    ...
    public required MaxGroupTieredPackageProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<MaxGroupTieredPackageProperties::ConversionRateConfig?>(
                element
            );
        }
        set
    ...
    public required MaxGroupTieredPackageProperties::PriceType PriceType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<MaxGroupTieredPackageProperties::PriceType>(element)
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    MaxGroupTieredPackage(Dictionary<string, JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static MaxGroupTieredPackage FromRawUnchecked(Dictionary<string, JsonElement> properties)
    {
