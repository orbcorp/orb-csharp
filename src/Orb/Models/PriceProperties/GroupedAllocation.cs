...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<GroupedAllocation>))]
public sealed record class GroupedAllocation : Orb::ModelBase, Orb::IFromRaw<GroupedAllocation>
{
    ...
    public required GroupedAllocationProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<GroupedAllocationProperties::Cadence>(element)
    ...
    public required GroupedAllocationProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<GroupedAllocationProperties::ConversionRateConfig?>(
                element
            );
        }
        set
    ...
    public required GroupedAllocationProperties::PriceType PriceType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<GroupedAllocationProperties::PriceType>(element)
...
#pragma warning disable CS8618
    ...
    GroupedAllocation(Generic::Dictionary<string, Json::JsonElement> properties)
    {
