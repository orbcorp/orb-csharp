...
public sealed record class GroupedAllocation : ModelBase, IFromRaw<GroupedAllocation>
{
    ...
    public required GroupedAllocationProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<GroupedAllocationProperties::Cadence>(element)
    ...
    public required GroupedAllocationProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<GroupedAllocationProperties::ConversionRateConfig?>(
                element
            );
        }
        set
    ...
    public required GroupedAllocationProperties::PriceType PriceType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<GroupedAllocationProperties::PriceType>(element)
