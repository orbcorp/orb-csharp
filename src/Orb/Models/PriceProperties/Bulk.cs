...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<Bulk>))]
public sealed record class Bulk : Orb::ModelBase, Orb::IFromRaw<Bulk>
{
    ...
    public required Models::BulkConfig BulkConfig
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<Models::BulkConfig>(element)
    ...
    public required BulkProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<BulkProperties::Cadence>(element)
    ...
    public required BulkProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<BulkProperties::ConversionRateConfig?>(element);
        }
        set
        {
    ...
    public required BulkProperties::PriceType PriceType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<BulkProperties::PriceType>(element)
...
#pragma warning disable CS8618
    ...
    Bulk(Generic::Dictionary<string, Json::JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static Bulk FromRawUnchecked(Generic::Dictionary<string, Json::JsonElement> properties)
    {
