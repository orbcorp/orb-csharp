...
public sealed record class Bulk : ModelBase, IFromRaw<Bulk>
{
    ...
    public required Models::BulkConfig BulkConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<Models::BulkConfig>(element)
    ...
    public required BulkProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<BulkProperties::Cadence>(element)
    ...
    public required BulkProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<BulkProperties::ConversionRateConfig?>(element);
        }
        set
        {
    ...
    public required BulkProperties::PriceType PriceType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<BulkProperties::PriceType>(element)
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    Bulk(Dictionary<string, JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static Bulk FromRawUnchecked(Dictionary<string, JsonElement> properties)
    {
