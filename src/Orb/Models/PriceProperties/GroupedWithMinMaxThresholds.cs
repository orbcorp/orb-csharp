...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<GroupedWithMinMaxThresholds>))]
public sealed record class GroupedWithMinMaxThresholds
    : Orb::ModelBase,
        Orb::IFromRaw<GroupedWithMinMaxThresholds>
{
    ...
    public required GroupedWithMinMaxThresholdsProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<GroupedWithMinMaxThresholdsProperties::Cadence>(
                    element
    ...
    public required GroupedWithMinMaxThresholdsProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<GroupedWithMinMaxThresholdsProperties::ConversionRateConfig?>(
                element
            );
        }
        set
    ...
    public required Generic::Dictionary<string, Json::JsonElement> GroupedWithMinMaxThresholdsConfig
    {
        get
        {
            if (
    ...
    public required GroupedWithMinMaxThresholdsProperties::PriceType PriceType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<GroupedWithMinMaxThresholdsProperties::PriceType>(
                    element
...
#pragma warning disable CS8618
    ...
    GroupedWithMinMaxThresholds(Generic::Dictionary<string, Json::JsonElement> properties)
    {
