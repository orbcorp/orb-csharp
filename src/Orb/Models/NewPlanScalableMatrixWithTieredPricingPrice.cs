...
[Serialization::JsonConverter(
    typeof(Orb::ModelConverter<NewPlanScalableMatrixWithTieredPricingPrice>)
)]
public sealed record class NewPlanScalableMatrixWithTieredPricingPrice
    : Orb::ModelBase,
        Orb::IFromRaw<NewPlanScalableMatrixWithTieredPricingPrice>
{
    /// <summary>
    /// The cadence to bill for this price on.
    /// </summary>
    public required NewPlanScalableMatrixWithTieredPricingPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewPlanScalableMatrixWithTieredPricingPriceProperties::Cadence>(
                    element
    ...
    public required NewPlanScalableMatrixWithTieredPricingPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewPlanScalableMatrixWithTieredPricingPriceProperties::ModelType>(
                    element
    ...
    /// </summary>
    public NewPlanScalableMatrixWithTieredPricingPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<NewPlanScalableMatrixWithTieredPricingPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
