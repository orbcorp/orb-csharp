        ...
        IFromRaw<NewPlanScalableMatrixWithTieredPricingPrice>
{
    ...
    public required NewPlanScalableMatrixWithTieredPricingPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewPlanScalableMatrixWithTieredPricingPriceProperties::Cadence>(
                    element
    ...
    public required NewPlanScalableMatrixWithTieredPricingPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewPlanScalableMatrixWithTieredPricingPriceProperties::ModelType>(
                    element
    ...
    public NewPlanScalableMatrixWithTieredPricingPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewPlanScalableMatrixWithTieredPricingPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    NewPlanScalableMatrixWithTieredPricingPrice(Dictionary<string, JsonElement> properties)
    {
