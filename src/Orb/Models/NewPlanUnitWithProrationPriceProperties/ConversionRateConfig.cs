...
using ConversionRateConfigVariants = Orb.Models.NewPlanUnitWithProrationPriceProperties.ConversionRateConfigVariants;

namespace Orb.Models.NewPlanUnitWithProrationPriceProperties;
