...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<NewPlanBulkWithProrationPrice>))]
public sealed record class NewPlanBulkWithProrationPrice
    : Orb::ModelBase,
        Orb::IFromRaw<NewPlanBulkWithProrationPrice>
{
    ...
    /// </summary>
    public required NewPlanBulkWithProrationPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewPlanBulkWithProrationPriceProperties::Cadence>(
                    element
    ...
    public required NewPlanBulkWithProrationPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewPlanBulkWithProrationPriceProperties::ModelType>(
                    element
    ...
    /// </summary>
    public NewPlanBulkWithProrationPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<NewPlanBulkWithProrationPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
...
#pragma warning disable CS8618
    ...
    NewPlanBulkWithProrationPrice(Generic::Dictionary<string, Json::JsonElement> properties)
    {
