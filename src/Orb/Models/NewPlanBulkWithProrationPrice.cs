        ...
        IFromRaw<NewPlanBulkWithProrationPrice>
{
    ...
    public required NewPlanBulkWithProrationPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewPlanBulkWithProrationPriceProperties::Cadence>(
                    element,
                    ModelBase.SerializerOptions
    ...
    public required NewPlanBulkWithProrationPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewPlanBulkWithProrationPriceProperties::ModelType>(
                    element,
                    ModelBase.SerializerOptions
    ...
    public NewPlanBulkWithProrationPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewPlanBulkWithProrationPriceProperties::ConversionRateConfig?>(
                element,
                ModelBase.SerializerOptions
            );
        }
