...
public sealed record class NewPlanBulkWithProrationPrice : JsonModel
{
    ...
    public required NewPlanBulkWithProrationPriceBulkWithProrationConfig BulkWithProrationConfig
    {
        get
        {
            ...
            return this._rawData.GetNotNullClass<NewPlanBulkWithProrationPriceBulkWithProrationConfig>(
    ...
    public NewPlanBulkWithProrationPriceConversionRateConfig? ConversionRateConfig
    {
        ...
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableClass<NewPlanBulkWithProrationPriceConversionRateConfig>(
    ...
    public required IReadOnlyList<NewPlanBulkWithProrationPriceBulkWithProrationConfigTier> Tiers
    {
        get
        {
            ...
            return this._rawData.GetNotNullStruct<
                ImmutableArray<NewPlanBulkWithProrationPriceBulkWithProrationConfigTier>
            >("tiers");
        }
        init
        {
