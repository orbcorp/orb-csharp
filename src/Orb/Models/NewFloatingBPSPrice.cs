...
[JsonConverter(typeof(ModelConverter<NewFloatingBPSPrice>))]
public sealed record class NewFloatingBPSPrice : ModelBase, IFromRaw<NewFloatingBPSPrice>
{
    public required BPSConfig BPSConfig
    {
        get
        {
            if (!this.Properties.TryGetValue("bps_config", out JsonElement element))
                throw new System::ArgumentOutOfRangeException(
                    "bps_config",
                    "Missing required argument"
                );

            return JsonSerializer.Deserialize<BPSConfig>(element, ModelBase.SerializerOptions)
                ?? throw new System::ArgumentNullException("bps_config");
        }
        set { this.Properties["bps_config"] = JsonSerializer.SerializeToElement(value); }
    }

    /// <summary>
    /// The cadence to bill for this price on.
    /// </summary>
    public required NewFloatingBPSPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewFloatingBPSPriceProperties::Cadence>(
                    element,
    ...
    public required NewFloatingBPSPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewFloatingBPSPriceProperties::ModelType>(
                    element,
                    ModelBase.SerializerOptions
    ...
    /// </summary>
    public NewFloatingBPSPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewFloatingBPSPriceProperties::ConversionRateConfig?>(
                element,
                ModelBase.SerializerOptions
            );
        }
    ...
    public NewFloatingBPSPrice() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    NewFloatingBPSPrice(Dictionary<string, JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static NewFloatingBPSPrice FromRawUnchecked(Dictionary<string, JsonElement> properties)
    {
