...
public sealed record class NewFloatingBPSPrice : ModelBase, IFromRaw<NewFloatingBPSPrice>
{
    public required BPSConfig BPSConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<BPSConfig>(element)
    ...
    public required NewFloatingBPSPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewFloatingBPSPriceProperties::Cadence>(element)
    ...
    public required NewFloatingBPSPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewFloatingBPSPriceProperties::ModelType>(element)
