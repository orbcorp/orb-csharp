...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<NewFloatingBPSPrice>))]
public sealed record class NewFloatingBPSPrice : Orb::ModelBase, Orb::IFromRaw<NewFloatingBPSPrice>
{
    public required BPSConfig BPSConfig
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<BPSConfig>(element)
    ...
    public required NewFloatingBPSPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewFloatingBPSPriceProperties::Cadence>(element)
    ...
    public required NewFloatingBPSPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewFloatingBPSPriceProperties::ModelType>(
                    element
    ...
    public NewFloatingBPSPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewFloatingBPSPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
...
#pragma warning disable CS8618
    ...
    NewFloatingBPSPrice(Generic::Dictionary<string, Json::JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static NewFloatingBPSPrice FromRawUnchecked(
