        ...
        IFromRaw<NewFloatingThresholdTotalAmountPrice>
{
    ...
    public required NewFloatingThresholdTotalAmountPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewFloatingThresholdTotalAmountPriceProperties::Cadence>(
                    element,
    ...
    public required NewFloatingThresholdTotalAmountPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewFloatingThresholdTotalAmountPriceProperties::ModelType>(
                    element,
                    ModelBase.SerializerOptions
    ...
    public NewFloatingThresholdTotalAmountPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewFloatingThresholdTotalAmountPriceProperties::ConversionRateConfig?>(
                element,
                ModelBase.SerializerOptions
            );
        }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    NewFloatingThresholdTotalAmountPrice(Dictionary<string, JsonElement> properties)
    {
