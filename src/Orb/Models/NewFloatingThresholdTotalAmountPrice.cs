...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<NewFloatingThresholdTotalAmountPrice>))]
public sealed record class NewFloatingThresholdTotalAmountPrice
    : Orb::ModelBase,
        Orb::IFromRaw<NewFloatingThresholdTotalAmountPrice>
{
    /// <summary>
    /// The cadence to bill for this price on.
    /// </summary>
    public required NewFloatingThresholdTotalAmountPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewFloatingThresholdTotalAmountPriceProperties::Cadence>(
                    element
    ...
    public required NewFloatingThresholdTotalAmountPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewFloatingThresholdTotalAmountPriceProperties::ModelType>(
                    element
    ...
    public required Generic::Dictionary<string, Json::JsonElement> ThresholdTotalAmountConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<Generic::Dictionary<string, Json::JsonElement>>(
                    element
                ) ?? throw new System::ArgumentNullException("threshold_total_amount_config");
        }
        set
        {
            this.Properties["threshold_total_amount_config"] =
    ...
    /// </summary>
    public NewFloatingThresholdTotalAmountPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<NewFloatingThresholdTotalAmountPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
...
#pragma warning disable CS8618
    ...
    NewFloatingThresholdTotalAmountPrice(Generic::Dictionary<string, Json::JsonElement> properties)
    {
