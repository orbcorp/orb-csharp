        ...
        IFromRaw<NewPlanScalableMatrixWithUnitPricingPrice>
{
    ...
    public required NewPlanScalableMatrixWithUnitPricingPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewPlanScalableMatrixWithUnitPricingPriceProperties::Cadence>(
                    element,
    ...
    public required NewPlanScalableMatrixWithUnitPricingPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewPlanScalableMatrixWithUnitPricingPriceProperties::ModelType>(
                    element,
                    ModelBase.SerializerOptions
    ...
    public NewPlanScalableMatrixWithUnitPricingPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewPlanScalableMatrixWithUnitPricingPriceProperties::ConversionRateConfig?>(
                element,
                ModelBase.SerializerOptions
            );
        }
