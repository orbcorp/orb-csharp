...
[Serialization::JsonConverter(
    typeof(Orb::ModelConverter<NewPlanScalableMatrixWithUnitPricingPrice>)
)]
public sealed record class NewPlanScalableMatrixWithUnitPricingPrice
    : Orb::ModelBase,
        Orb::IFromRaw<NewPlanScalableMatrixWithUnitPricingPrice>
{
    /// <summary>
    /// The cadence to bill for this price on.
    /// </summary>
    public required NewPlanScalableMatrixWithUnitPricingPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewPlanScalableMatrixWithUnitPricingPriceProperties::Cadence>(
                    element
    ...
    public required NewPlanScalableMatrixWithUnitPricingPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewPlanScalableMatrixWithUnitPricingPriceProperties::ModelType>(
                    element
    ...
    /// </summary>
    public NewPlanScalableMatrixWithUnitPricingPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<NewPlanScalableMatrixWithUnitPricingPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
