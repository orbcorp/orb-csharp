...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<NewPlanPackageWithAllocationPrice>))]
public sealed record class NewPlanPackageWithAllocationPrice
    : Orb::ModelBase,
        Orb::IFromRaw<NewPlanPackageWithAllocationPrice>
{
    /// <summary>
    /// The cadence to bill for this price on.
    /// </summary>
    public required NewPlanPackageWithAllocationPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewPlanPackageWithAllocationPriceProperties::Cadence>(
                    element
    ...
    public required NewPlanPackageWithAllocationPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewPlanPackageWithAllocationPriceProperties::ModelType>(
                    element
    ...
    /// </summary>
    public NewPlanPackageWithAllocationPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<NewPlanPackageWithAllocationPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
...
#pragma warning disable CS8618
    ...
    NewPlanPackageWithAllocationPrice(Generic::Dictionary<string, Json::JsonElement> properties)
    {
