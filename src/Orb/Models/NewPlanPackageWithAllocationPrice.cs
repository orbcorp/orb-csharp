        ...
        IFromRaw<NewPlanPackageWithAllocationPrice>
{
    ...
    public required NewPlanPackageWithAllocationPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewPlanPackageWithAllocationPriceProperties::Cadence>(
                    element
    ...
    public required NewPlanPackageWithAllocationPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewPlanPackageWithAllocationPriceProperties::ModelType>(
                    element
    ...
    public NewPlanPackageWithAllocationPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewPlanPackageWithAllocationPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    NewPlanPackageWithAllocationPrice(Dictionary<string, JsonElement> properties)
    {
