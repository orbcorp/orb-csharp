...
using TieredWithMinimumConfigProperties = Orb.Models.NewPlanTieredWithMinimumPriceProperties.TieredWithMinimumConfigProperties;

namespace Orb.Models.NewPlanTieredWithMinimumPriceProperties;
