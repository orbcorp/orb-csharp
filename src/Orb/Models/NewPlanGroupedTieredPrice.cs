...
[JsonConverter(
    typeof(JsonModelConverter<NewPlanGroupedTieredPrice, NewPlanGroupedTieredPriceFromRaw>)
)]
public sealed record class NewPlanGroupedTieredPrice : JsonModel
{
    /// <summary>
    ...
    public required ApiEnum<string, NewPlanGroupedTieredPriceCadence> Cadence
    {
        get
        {
            ...
            return this._rawData.GetNotNullClass<ApiEnum<string, NewPlanGroupedTieredPriceCadence>>(
                "cadence"
            );
        }
    ...
    public required NewPlanGroupedTieredPriceGroupedTieredConfig GroupedTieredConfig
    {
        ...
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<NewPlanGroupedTieredPriceGroupedTieredConfig>(
    ...
    public NewPlanGroupedTieredPriceConversionRateConfig? ConversionRateConfig
    {
        ...
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableClass<NewPlanGroupedTieredPriceConversionRateConfig>(
...
#pragma warning restore CS8618
    ...
    /// <inheritdoc cref="NewPlanGroupedTieredPriceFromRaw.FromRawUnchecked"/>
...
class NewPlanGroupedTieredPriceFromRaw : IFromRawJson<NewPlanGroupedTieredPrice>
{
    /// <inheritdoc/>
...
public sealed record class NewPlanGroupedTieredPriceGroupedTieredConfig : JsonModel
{
    /// <summary>
    ...
    public required IReadOnlyList<NewPlanGroupedTieredPriceGroupedTieredConfigTier> Tiers
    {
        get
        {
            ...
            return this._rawData.GetNotNullStruct<
                ImmutableArray<NewPlanGroupedTieredPriceGroupedTieredConfigTier>
            >("tiers");
        }
        init
        {
            this._rawData.Set<ImmutableArray<NewPlanGroupedTieredPriceGroupedTieredConfigTier>>(
                "tiers",
...
#pragma warning restore CS8618
    ...
    /// <inheritdoc cref="NewPlanGroupedTieredPriceGroupedTieredConfigFromRaw.FromRawUnchecked"/>
...
class NewPlanGroupedTieredPriceGroupedTieredConfigFromRaw
    : IFromRawJson<NewPlanGroupedTieredPriceGroupedTieredConfig>
{
    /// <inheritdoc/>
...
#pragma warning restore CS8618
    ...
    /// <inheritdoc cref="NewPlanGroupedTieredPriceGroupedTieredConfigTierFromRaw.FromRawUnchecked"/>
...
class NewPlanGroupedTieredPriceGroupedTieredConfigTierFromRaw
    : IFromRawJson<NewPlanGroupedTieredPriceGroupedTieredConfigTier>
{
    /// <inheritdoc/>
...
public record class NewPlanGroupedTieredPriceConversionRateConfig : ModelBase
{
    ...
    public NewPlanGroupedTieredPriceConversionRateConfig(JsonElement element)
    {
        this._element = element;
    }
    ...
    : JsonConverter<NewPlanGroupedTieredPriceConversionRateConfig>
{
    ...
    )
    {
        ...
        switch (conversionRateType)
        {
            ...
            default:
            {
                return new NewPlanGroupedTieredPriceConversionRateConfig(element);
            }
        }
    }
