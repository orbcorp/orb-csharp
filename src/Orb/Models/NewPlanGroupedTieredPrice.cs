...
public sealed record class NewPlanGroupedTieredPrice : JsonModel
{
    ...
    public required ApiEnum<string, NewPlanGroupedTieredPriceCadence> Cadence
    {
        get
        {
            return JsonModel.GetNotNullClass<ApiEnum<string, NewPlanGroupedTieredPriceCadence>>(
                this.RawData,
                "cadence"
            );
        }
    ...
    public required NewPlanGroupedTieredPriceGroupedTieredConfig GroupedTieredConfig
    {
        get
        {
            return JsonModel.GetNotNullClass<NewPlanGroupedTieredPriceGroupedTieredConfig>(
                this.RawData,
    ...
    public required ApiEnum<string, NewPlanGroupedTieredPriceModelType> ModelType
    {
        get
        {
            return JsonModel.GetNotNullClass<ApiEnum<string, NewPlanGroupedTieredPriceModelType>>(
                this.RawData,
                "model_type"
            );
        }
    ...
    public NewPlanGroupedTieredPriceConversionRateConfig? ConversionRateConfig
    {
        get
        {
            return JsonModel.GetNullableClass<NewPlanGroupedTieredPriceConversionRateConfig>(
                this.RawData,
