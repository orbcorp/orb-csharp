        ...
        IFromRaw<NewPlanGroupedTieredPrice>
{
    ...
    public required NewPlanGroupedTieredPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewPlanGroupedTieredPriceProperties::Cadence>(element)
    ...
    public required NewPlanGroupedTieredPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewPlanGroupedTieredPriceProperties::ModelType>(
                    element
    ...
    public NewPlanGroupedTieredPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewPlanGroupedTieredPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
