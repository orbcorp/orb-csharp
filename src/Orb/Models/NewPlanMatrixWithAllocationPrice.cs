        ...
        IFromRaw<NewPlanMatrixWithAllocationPrice>
{
    ...
    public required NewPlanMatrixWithAllocationPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewPlanMatrixWithAllocationPriceProperties::Cadence>(
                    element
    ...
    public required MatrixWithAllocationConfig MatrixWithAllocationConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<MatrixWithAllocationConfig>(element)
    ...
    public required NewPlanMatrixWithAllocationPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewPlanMatrixWithAllocationPriceProperties::ModelType>(
                    element
    ...
    public NewPlanMatrixWithAllocationPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewPlanMatrixWithAllocationPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    NewPlanMatrixWithAllocationPrice(Dictionary<string, JsonElement> properties)
    {
