...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<NewPlanMatrixWithAllocationPrice>))]
public sealed record class NewPlanMatrixWithAllocationPrice
    : Orb::ModelBase,
        Orb::IFromRaw<NewPlanMatrixWithAllocationPrice>
{
    /// <summary>
    /// The cadence to bill for this price on.
    /// </summary>
    public required NewPlanMatrixWithAllocationPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewPlanMatrixWithAllocationPriceProperties::Cadence>(
                    element
    ...
    public required MatrixWithAllocationConfig MatrixWithAllocationConfig
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<MatrixWithAllocationConfig>(element)
                ?? throw new System::ArgumentNullException("matrix_with_allocation_config");
        }
        set
        {
            this.Properties["matrix_with_allocation_config"] =
                Json::JsonSerializer.SerializeToElement(value);
        }
    }

    public required NewPlanMatrixWithAllocationPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewPlanMatrixWithAllocationPriceProperties::ModelType>(
                    element
    ...
    /// </summary>
    public NewPlanMatrixWithAllocationPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<NewPlanMatrixWithAllocationPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
...
#pragma warning disable CS8618
    ...
    NewPlanMatrixWithAllocationPrice(Generic::Dictionary<string, Json::JsonElement> properties)
    {
