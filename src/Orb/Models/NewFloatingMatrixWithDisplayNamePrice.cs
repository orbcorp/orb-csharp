        ...
        IFromRaw<NewFloatingMatrixWithDisplayNamePrice>
{
    ...
    public required NewFloatingMatrixWithDisplayNamePriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewFloatingMatrixWithDisplayNamePriceProperties::Cadence>(
                    element,
    ...
    public required NewFloatingMatrixWithDisplayNamePriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewFloatingMatrixWithDisplayNamePriceProperties::ModelType>(
                    element,
                    ModelBase.SerializerOptions
    ...
    public NewFloatingMatrixWithDisplayNamePriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<NewFloatingMatrixWithDisplayNamePriceProperties::ConversionRateConfig?>(
                element,
                ModelBase.SerializerOptions
            );
        }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    NewFloatingMatrixWithDisplayNamePrice(Dictionary<string, JsonElement> properties)
    {
