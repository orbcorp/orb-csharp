...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<NewFloatingMatrixWithDisplayNamePrice>))]
public sealed record class NewFloatingMatrixWithDisplayNamePrice
    : Orb::ModelBase,
        Orb::IFromRaw<NewFloatingMatrixWithDisplayNamePrice>
{
    /// <summary>
    /// The cadence to bill for this price on.
    /// </summary>
    public required NewFloatingMatrixWithDisplayNamePriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewFloatingMatrixWithDisplayNamePriceProperties::Cadence>(
                    element
    ...
    public required NewFloatingMatrixWithDisplayNamePriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewFloatingMatrixWithDisplayNamePriceProperties::ModelType>(
                    element
    ...
    /// </summary>
    public NewFloatingMatrixWithDisplayNamePriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<NewFloatingMatrixWithDisplayNamePriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
...
#pragma warning disable CS8618
    ...
    NewFloatingMatrixWithDisplayNamePrice(Generic::Dictionary<string, Json::JsonElement> properties)
    {
