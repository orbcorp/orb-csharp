...
[Serialization::JsonConverter(typeof(Orb::ModelConverter<NewPlanMatrixPrice>))]
public sealed record class NewPlanMatrixPrice : Orb::ModelBase, Orb::IFromRaw<NewPlanMatrixPrice>
{
    /// <summary>
    /// The cadence to bill for this price on.
    /// </summary>
    public required NewPlanMatrixPriceProperties::Cadence Cadence
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewPlanMatrixPriceProperties::Cadence>(element)
    ...
    public required NewPlanMatrixPriceProperties::ModelType ModelType
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<NewPlanMatrixPriceProperties::ModelType>(
                    element
    ...
    /// </summary>
    public NewPlanMatrixPriceProperties::ConversionRateConfig? ConversionRateConfig
    {
        get
        {
            if (
            ...
            return Json::JsonSerializer.Deserialize<NewPlanMatrixPriceProperties::ConversionRateConfig?>(
                element
            );
        }
        set
...
#pragma warning disable CS8618
    ...
    NewPlanMatrixPrice(Generic::Dictionary<string, Json::JsonElement> properties)
    {
