using ConversionRateConfigVariants = Orb.Models.NewPlanPackagePriceProperties.ConversionRateConfigVariants;
using Models = Orb.Models;
using Orb = Orb;
using Serialization = System.Text.Json.Serialization;

namespace Orb.Models.NewPlanPackagePriceProperties;
