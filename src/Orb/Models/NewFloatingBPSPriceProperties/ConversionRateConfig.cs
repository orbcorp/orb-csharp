...
using ConversionRateConfigVariants = Orb.Models.NewFloatingBPSPriceProperties.ConversionRateConfigVariants;

namespace Orb.Models.NewFloatingBPSPriceProperties;
