...
/// </summary>
public record class BackfillFetchParams : ParamsBase
{
...
#pragma warning restore CS8618
    ...
    public static BackfillFetchParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public override string ToString() =>
        JsonSerializer.Serialize(
            FriendlyJsonPrinter.PrintValue(
                ...
                {
                    ["BackfillID"] = JsonSerializer.SerializeToElement(this.BackfillID),
    ...
    public virtual bool Equals(BackfillFetchParams? other)
    {
        if (other == null)
        {
            return false;
