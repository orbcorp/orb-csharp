...
/// </summary>
[Serialization::JsonConverter(typeof(Orb::ModelConverter<BackfillFetchResponse>))]
public sealed record class BackfillFetchResponse
    : Orb::ModelBase,
        Orb::IFromRaw<BackfillFetchResponse>
{
    ...
    public required BackfillFetchResponseProperties::Status Status
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<BackfillFetchResponseProperties::Status>(
                    element
...
#pragma warning disable CS8618
    ...
    BackfillFetchResponse(Generic::Dictionary<string, Json::JsonElement> properties)
    {
