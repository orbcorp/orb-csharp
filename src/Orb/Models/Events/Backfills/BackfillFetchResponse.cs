...
public sealed record class BackfillFetchResponse : ModelBase, IFromRaw<BackfillFetchResponse>
{
    ...
    public required BackfillFetchResponseProperties::Status Status
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<BackfillFetchResponseProperties::Status>(element)
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    BackfillFetchResponse(Dictionary<string, JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static BackfillFetchResponse FromRawUnchecked(Dictionary<string, JsonElement> properties)
    {
