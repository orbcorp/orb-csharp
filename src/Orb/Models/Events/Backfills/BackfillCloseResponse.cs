...
/// </summary>
[Serialization::JsonConverter(typeof(Orb::ModelConverter<BackfillCloseResponse>))]
public sealed record class BackfillCloseResponse
    : Orb::ModelBase,
        Orb::IFromRaw<BackfillCloseResponse>
{
    ...
    /// </summary>
    public required BackfillCloseResponseProperties::Status Status
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<BackfillCloseResponseProperties::Status>(
                    element
...
#pragma warning disable CS8618
    ...
    BackfillCloseResponse(Generic::Dictionary<string, Json::JsonElement> properties)
    {
