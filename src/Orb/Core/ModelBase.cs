...
public abstract record class ModelBase
{
    ...
    internal static readonly JsonSerializerOptions SerializerOptions = new()
    {
        Converters =
        {
            ...
            new ApiEnumConverter<string, AccountingProviderProviderType>(),
            new ApiEnumConverter<string, PaymentProvider5ProviderType>(),
            ...
            new ApiEnumConverter<string, PaymentProvider1ProviderType>(),
            new ApiEnumConverter<string, PaymentProvider2>(),
            new ApiEnumConverter<string, PaymentProvider3ProviderType>(),
            new ApiEnumConverter<string, PaymentProvider4>(),
