...
public interface ICreditNoteService
{
    ...
    ///
    /// 1. Global service periods: Specify start_date and end_date at the credit
    /// note level.    These dates will be applied to all line items uniformly.
    ///
    ...
    ///
    /// 3. Default behavior: If no service periods are specified (neither global
    /// nor individual),    the original invoice line item service periods will be used.
    ///
    /// Note: Mixing global and individual service periods in the same request is
    ...
    ///
    /// Note: Both start_date and end_date are inclusive - the service period will
