...
public interface ILedgerService
{
    ...
    /// that the deduction leads to multiple ledger entries, the response from this
    /// endpoint will be the final deduction. Orb also optionally allows specifying a
    /// description to assist with auditing.</para>
    ///
