...
public interface IPlanServiceWithRawResponse
{
    ...
    /// <summary>
    /// Returns a raw HTTP response for <c>post /plans</c>, but is otherwise the
    ...
    /// <summary>
    /// Returns a raw HTTP response for <c>put /plans/{plan_id}</c>, but is otherwise the
    ...
    /// <summary>
    /// Returns a raw HTTP response for <c>get /plans</c>, but is otherwise the
    ...
    /// <summary>
    /// Returns a raw HTTP response for <c>get /plans/{plan_id}</c>, but is otherwise the
