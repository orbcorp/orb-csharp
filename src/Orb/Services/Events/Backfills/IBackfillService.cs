...
public interface IBackfillService
{
    ...
    ///
    /// This endpoint will return a backfill object, which contains an `id`. That
    ...
    /// the backfill. If `false`, newly ingested events will be added to the existing events.
    ///
