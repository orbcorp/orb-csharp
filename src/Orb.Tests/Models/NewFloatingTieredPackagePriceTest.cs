...
public class NewFloatingTieredPackagePriceTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new NewFloatingTieredPackagePrice
        {
        ...
        ApiEnum<string, NewFloatingTieredPackagePriceCadence> expectedCadence =
            NewFloatingTieredPackagePriceCadence.Annual;
        string expectedCurrency = "currency";
        string expectedItemID = "item_id";
        ApiEnum<string, NewFloatingTieredPackagePriceModelType> expectedModelType =
            NewFloatingTieredPackagePriceModelType.TieredPackage;
        ...
        NewFloatingTieredPackagePriceConversionRateConfig expectedConversionRateConfig =
    ...
    public void CopyConstructor_Works()
    {
        ...
        NewFloatingTieredPackagePrice copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class NewFloatingTieredPackagePriceCadenceTest : TestBase
{
    [Theory]
    [InlineData(NewFloatingTieredPackagePriceCadence.Annual)]
    [InlineData(NewFloatingTieredPackagePriceCadence.SemiAnnual)]
    [InlineData(NewFloatingTieredPackagePriceCadence.Monthly)]
    [InlineData(NewFloatingTieredPackagePriceCadence.Quarterly)]
    [InlineData(NewFloatingTieredPackagePriceCadence.OneTime)]
    [InlineData(NewFloatingTieredPackagePriceCadence.Custom)]
    public void Validation_Works(NewFloatingTieredPackagePriceCadence rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, NewFloatingTieredPackagePriceCadence> value = rawValue;
        value.Validate();
    }
    ...
    [InlineData(NewFloatingTieredPackagePriceCadence.OneTime)]
    [InlineData(NewFloatingTieredPackagePriceCadence.Custom)]
    public void SerializationRoundtrip_Works(NewFloatingTieredPackagePriceCadence rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, NewFloatingTieredPackagePriceCadence> value = rawValue;
...
public class NewFloatingTieredPackagePriceModelTypeTest : TestBase
{
    [Theory]
    [InlineData(NewFloatingTieredPackagePriceModelType.TieredPackage)]
    public void Validation_Works(NewFloatingTieredPackagePriceModelType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, NewFloatingTieredPackagePriceModelType> value = rawValue;
        value.Validate();
    }
    ...
    [Theory]
    [InlineData(NewFloatingTieredPackagePriceModelType.TieredPackage)]
    public void SerializationRoundtrip_Works(NewFloatingTieredPackagePriceModelType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, NewFloatingTieredPackagePriceModelType> value = rawValue;
...
public class TieredPackageConfigTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        ...
        List<TieredPackageConfigTier> expectedTiers =
        [
            new() { PerUnit = "per_unit", TierLowerBound = "tier_lower_bound" },
            new() { PerUnit = "per_unit", TierLowerBound = "tier_lower_bound" },
        ];
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<TieredPackageConfig>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        TieredPackageConfig copied = new(model);
...
public class TieredPackageConfigTierTest : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<TieredPackageConfigTier>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        TieredPackageConfigTier copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class NewFloatingTieredPackagePriceConversionRateConfigTest : TestBase
{
    [Fact]
    ...
    public void UnitSerializationRoundtripWorks()
    {
        ...
        var deserialized =
            JsonSerializer.Deserialize<NewFloatingTieredPackagePriceConversionRateConfig>(
                element,
                ModelBase.SerializerOptions
            );
