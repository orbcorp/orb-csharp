...
public class NewFloatingMaxGroupTieredPackagePriceTest : TestBase
{
    ...
    public void CopyConstructor_Works()
    {
        ...
        NewFloatingMaxGroupTieredPackagePrice copied = new(model);
...
public class MaxGroupTieredPackageConfigTest : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<MaxGroupTieredPackageConfig>(
            json,
            ModelBase.SerializerOptions
        );
...
public class MaxGroupTieredPackageConfigTierTest : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<MaxGroupTieredPackageConfigTier>(
            json,
            ModelBase.SerializerOptions
        );
