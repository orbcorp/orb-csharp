...
public class UsageGetAllUsageResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new UsageGetAllUsageResponse
        {
            Data =
            [
                new()
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<UsageGetAllUsageResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        UsageGetAllUsageResponse copied = new(model);
