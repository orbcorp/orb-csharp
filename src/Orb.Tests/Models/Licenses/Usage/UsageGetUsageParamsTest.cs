...
public class UsageGetUsageParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new UsageGetUsageParams
        {
    ...
    {
        var parameters = new UsageGetUsageParams { LicenseID = "license_id", Limit = 1 };
    ...
    {
        UsageGetUsageParams parameters = new()
        {
            LicenseID = "license_id",
            Cursor = "cursor",
            EndDate = "2019-12-27",
        ...
        Assert.True(
            TestBase.UrisEqual(
                new Uri(
                    "https://api.withorb.com/v1/licenses/license_id/usage?cursor=cursor&end_date=2019-12-27&group_by=group_by&limit=1&start_date=2019-12-27"
                ),
                url
            )
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        UsageGetUsageParams copied = new(parameters);
