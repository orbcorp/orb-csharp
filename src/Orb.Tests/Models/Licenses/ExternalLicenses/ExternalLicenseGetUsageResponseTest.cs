...
public class ExternalLicenseGetUsageResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ExternalLicenseGetUsageResponse
        {
            Data =
            [
                new()
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<ExternalLicenseGetUsageResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        ExternalLicenseGetUsageResponse copied = new(model);
