...
public class MonetaryPercentageDiscountAdjustmentTest : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<MonetaryPercentageDiscountAdjustment>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        MonetaryPercentageDiscountAdjustment copied = new(model);
...
public class MonetaryPercentageDiscountAdjustmentFilterTest : TestBase
{
    ...
    public void CopyConstructor_Works()
    {
        ...
        MonetaryPercentageDiscountAdjustmentFilter copied = new(model);
