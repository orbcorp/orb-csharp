...
public class BetaCreatePlanVersionParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new BetaCreatePlanVersionParams
        {
            ...
            [
                new()
                {
                    ...
                    LicenseAllocationPrice = new()
                    {
                        Cadence = ReplacePriceLicenseAllocationPriceCadence.Annual,
                        ItemID = "item_id",
                        LicenseAllocations =
                        [
                            new()
                        ...
                        ModelType = ReplacePriceLicenseAllocationPriceModelType.Unit,
                        Name = "Annual fee",
                        UnitConfig = new() { UnitAmount = "unit_amount", Prorated = true },
                        BillableMetricID = "billable_metric_id",
                        BilledInAdvance = true,
        ...
        List<AddAdjustment> expectedAddAdjustments =
        [
            new()
            {
                Adjustment = new Models::NewPercentageDiscount()
        ...
        List<AddPrice> expectedAddPrices =
        [
            new()
            {
                AllocationPrice = new()
        ...
        List<RemoveAdjustment> expectedRemoveAdjustments =
        [
            new() { AdjustmentID = "adjustment_id", PlanPhaseOrder = 0 },
        ];
        List<RemovePrice> expectedRemovePrices =
        [
            new() { PriceID = "price_id", PlanPhaseOrder = 0 },
        ];
        List<ReplaceAdjustment> expectedReplaceAdjustments =
        [
            new()
            {
                Adjustment = new Models::NewPercentageDiscount()
        ...
        List<ReplacePrice> expectedReplacePrices =
        [
            new()
            {
                ReplacesPriceID = "replaces_price_id",
    ...
    {
        var parameters = new BetaCreatePlanVersionParams { PlanID = "plan_id", Version = 0 };
    ...
    {
        BetaCreatePlanVersionParams parameters = new() { PlanID = "plan_id", Version = 0 };
...
public class AddAdjustmentTest : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<AddAdjustment>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        AddAdjustment copied = new(model);
...
public class AdjustmentTest : TestBase
{
    ...
    {
        Adjustment value = new Models::NewPercentageDiscount()
        {
            AdjustmentType = Models::NewPercentageDiscountAdjustmentType.PercentageDiscount,
            PercentageDiscount = 0,
            AppliesToAll = Models::NewPercentageDiscountAppliesToAll.True,
    ...
    {
        Adjustment value = new Models::NewUsageDiscount()
        {
    ...
    {
        Adjustment value = new Models::NewAmountDiscount()
        {
    ...
    {
        Adjustment value = new Models::NewMinimum()
        {
    ...
    {
        Adjustment value = new Models::NewMaximum()
        {
...
public class AddPriceTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        ...
        LicenseAllocationPrice expectedLicenseAllocationPrice = new()
        {
            Cadence = Cadence.Annual,
            ItemID = "item_id",
            LicenseAllocations =
        ...
        Assert.Equal(expectedLicenseAllocationPrice, model.LicenseAllocationPrice);
        Assert.Equal(expectedPlanPhaseOrder, model.PlanPhaseOrder);
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<AddPrice>(json, ModelBase.SerializerOptions);
    ...
    public void FieldRoundtripThroughSerialization_Works()
    {
        ...
        string element = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<AddPrice>(
            element,
            ModelBase.SerializerOptions
        );
        Assert.NotNull(deserialized);
        ...
        Assert.Equal(expectedLicenseAllocationPrice, deserialized.LicenseAllocationPrice);
        Assert.Equal(expectedPlanPhaseOrder, deserialized.PlanPhaseOrder);
    ...
    public void OptionalNullablePropertiesUnsetAreNotSet_Works()
    {
        ...
        Assert.Null(model.LicenseAllocationPrice);
        Assert.False(model.RawData.ContainsKey("license_allocation_price"));
        Assert.Null(model.PlanPhaseOrder);
        Assert.False(model.RawData.ContainsKey("plan_phase_order"));
    ...
    public void OptionalNullablePropertiesSetToNullAreSetToNull_Works()
    {
        ...
        Assert.Null(model.LicenseAllocationPrice);
        Assert.True(model.RawData.ContainsKey("license_allocation_price"));
        Assert.Null(model.PlanPhaseOrder);
        Assert.True(model.RawData.ContainsKey("plan_phase_order"));
        Assert.Null(model.Price);
...
public class LicenseAllocationPriceTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        ...
        List<LicenseAllocation> expectedLicenseAllocations =
        [
            new()
            {
                Amount = "amount",
        ...
        Assert.Equal(expectedLicenseAllocations.Count, model.LicenseAllocations.Count);
        for (int i = 0; i < expectedLicenseAllocations.Count; i++)
        {
            Assert.Equal(expectedLicenseAllocations[i], model.LicenseAllocations[i]);
        }
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<LicenseAllocationPrice>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void FieldRoundtripThroughSerialization_Works()
    {
        ...
        Assert.Equal(expectedLicenseAllocations.Count, deserialized.LicenseAllocations.Count);
        for (int i = 0; i < expectedLicenseAllocations.Count; i++)
        {
            Assert.Equal(expectedLicenseAllocations[i], deserialized.LicenseAllocations[i]);
        }
...
public class LicenseAllocationTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new LicenseAllocation
        {
            Amount = "amount",
            Currency = "currency",
            WriteOffOverage = true,
        ...
        string expectedCurrency = "currency";
        bool expectedWriteOffOverage = true;

        Assert.Equal(expectedAmount, model.Amount);
        Assert.Equal(expectedCurrency, model.Currency);
        Assert.Equal(expectedWriteOffOverage, model.WriteOffOverage);
    }
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<LicenseAllocation>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void FieldRoundtripThroughSerialization_Works()
    {
        ...
        Assert.Equal(expectedCurrency, deserialized.Currency);
        Assert.Equal(expectedWriteOffOverage, deserialized.WriteOffOverage);
    }
    ...
    public void OptionalNullablePropertiesUnsetAreNotSet_Works()
    {
        var model = new LicenseAllocation { Amount = "amount", Currency = "currency" };

        Assert.Null(model.WriteOffOverage);
        Assert.False(model.RawData.ContainsKey("write_off_overage"));
    }
    ...
    public void OptionalNullablePropertiesSetToNullAreSetToNull_Works()
    {
        var model = new LicenseAllocation
        {
            ...
            WriteOffOverage = null,
        };

        Assert.Null(model.WriteOffOverage);
        Assert.True(model.RawData.ContainsKey("write_off_overage"));
    }
    ...
    public void CopyConstructor_Works()
    {
        ...
        LicenseAllocation copied = new(model);
...
public class ConversionRateConfigTest : TestBase
{
    ...
    {
        ConversionRateConfig value = new Models::SharedUnitConversionRateConfig()
        {
            ConversionRateType = Models::SharedUnitConversionRateConfigConversionRateType.Unit,
            UnitConfig = new("unit_amount"),
        };
    ...
    public void UnitSerializationRoundtripWorks()
    {
        ...
        string element = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ConversionRateConfig>(
            element,
            ModelBase.SerializerOptions
        );
...
public class PriceTest : TestBase
{
    ...
    {
        Price value = new Models::NewPlanUnitPrice()
        {
            Cadence = Models::NewPlanUnitPriceCadence.Annual,
            ItemID = "item_id",
            ModelType = Models::NewPlanUnitPriceModelType.Unit,
    ...
    {
        Price value = new Models::NewPlanTieredPrice()
        {
    ...
    {
        Price value = new Models::NewPlanBulkPrice()
        {
    ...
    public void BulkWithFiltersValidationWorks()
    {
        Price value = new BulkWithFilters()
        {
            ...
            Cadence = BulkWithFiltersCadence.Annual,
            ItemID = "item_id",
            Name = "Annual fee",
            BillableMetricID = "billable_metric_id",
            BilledInAdvance = true,
    ...
    {
        Price value = new Models::NewPlanPackagePrice()
        {
    ...
    {
        Price value = new Models::NewPlanMatrixPrice()
        {
    ...
    {
        Price value = new Models::NewPlanThresholdTotalAmountPrice()
        {
    ...
    {
        Price value = new Models::NewPlanTieredPackagePrice()
        {
    ...
    {
        Price value = new Models::NewPlanTieredWithMinimumPrice()
        {
    ...
    {
        Price value = new Models::NewPlanTieredPackageWithMinimumPrice()
        {
    ...
    {
        Price value = new Models::NewPlanPackageWithAllocationPrice()
        {
    ...
    {
        Price value = new Models::NewPlanUnitWithPercentPrice()
        {
    ...
    {
        Price value = new Models::NewPlanMatrixWithAllocationPrice()
        {
    ...
    {
        Price value = new Models::NewPlanGroupedAllocationPrice()
        {
    ...
    {
        Price value = new Models::NewPlanBulkWithProrationPrice()
        {
    ...
    {
        Price value = new Models::NewPlanGroupedWithProratedMinimumPrice()
        {
    ...
    {
        Price value = new Models::NewPlanMatrixWithDisplayNamePrice()
        {
            ...
            ModelType = Models::NewPlanMatrixWithDisplayNamePriceModelType.MatrixWithDisplayName,
            Name = "Annual fee",
            BillableMetricID = "billable_metric_id",
            BilledInAdvance = true,
            BillingCycleConfiguration = new()
    ...
    {
        Price value = new Models::NewPlanMaxGroupTieredPackagePrice()
        {
            ...
            ModelType = Models::NewPlanMaxGroupTieredPackagePriceModelType.MaxGroupTieredPackage,
            Name = "Annual fee",
            BillableMetricID = "billable_metric_id",
            BilledInAdvance = true,
            BillingCycleConfiguration = new()
    ...
    {
        Price value = new Models::NewPlanScalableMatrixWithTieredPricingPrice()
        {
    ...
    {
        Price value = new Models::NewPlanCumulativeGroupedBulkPrice()
        {
            ...
            ItemID = "item_id",
            ModelType = Models::NewPlanCumulativeGroupedBulkPriceModelType.CumulativeGroupedBulk,
            Name = "Annual fee",
            BillableMetricID = "billable_metric_id",
            BilledInAdvance = true,
            BillingCycleConfiguration = new()
    ...
    {
        Price value = new Models::NewPlanMinimumCompositePrice()
        {
            ...
            ModelType = Models::NewPlanMinimumCompositePriceModelType.MinimumComposite,
            Name = "Annual fee",
            BillableMetricID = "billable_metric_id",
            BilledInAdvance = true,
            BillingCycleConfiguration = new()
...
public class BulkWithFiltersTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        ...
        ApiEnum<string, BulkWithFiltersCadence> expectedCadence = BulkWithFiltersCadence.Annual;
        string expectedItemID = "item_id";
...
public class BulkWithFiltersConfigTest : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<BulkWithFiltersConfig>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        BulkWithFiltersConfig copied = new(model);
...
public class BulkWithFiltersConversionRateConfigTest : TestBase
{
    ...
    public void UnitValidationWorks()
    {
        BulkWithFiltersConversionRateConfig value = new Models::SharedUnitConversionRateConfig()
        {
            ConversionRateType = Models::SharedUnitConversionRateConfigConversionRateType.Unit,
            UnitConfig = new("unit_amount"),
        };
    ...
    public void UnitSerializationRoundtripWorks()
    {
        ...
        string element = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<BulkWithFiltersConversionRateConfig>(
            element,
            ModelBase.SerializerOptions
        );
...
public class TieredWithProrationConfigTest : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<TieredWithProrationConfig>(
            json,
            ModelBase.SerializerOptions
        );
...
public class TieredWithProrationConfigTierTest : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<TieredWithProrationConfigTier>(
            json,
            ModelBase.SerializerOptions
        );
...
public class TieredWithProrationConversionRateConfigTest : TestBase
{
    ...
    public void UnitValidationWorks()
    {
        TieredWithProrationConversionRateConfig value = new Models::SharedUnitConversionRateConfig()
        {
            ConversionRateType = Models::SharedUnitConversionRateConfigConversionRateType.Unit,
            UnitConfig = new("unit_amount"),
        };
...
public class GroupedWithMinMaxThresholdsConfigTest : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<GroupedWithMinMaxThresholdsConfig>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        GroupedWithMinMaxThresholdsConfig copied = new(model);
...
public class GroupedWithMinMaxThresholdsConversionRateConfigTest : TestBase
{
    ...
    public void UnitSerializationRoundtripWorks()
    {
        ...
        string element = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized =
            JsonSerializer.Deserialize<GroupedWithMinMaxThresholdsConversionRateConfig>(
                element,
                ModelBase.SerializerOptions
            );
...
public class CumulativeGroupedAllocationConfigTest : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<CumulativeGroupedAllocationConfig>(
            json,
            ModelBase.SerializerOptions
        );
...
public class CumulativeGroupedAllocationConversionRateConfigTest : TestBase
{
    ...
    public void UnitSerializationRoundtripWorks()
    {
        ...
        string element = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized =
            JsonSerializer.Deserialize<CumulativeGroupedAllocationConversionRateConfig>(
                element,
                ModelBase.SerializerOptions
            );
...
public class PercentTest : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<Percent>(json, ModelBase.SerializerOptions);
    ...
    public void FieldRoundtripThroughSerialization_Works()
    {
        ...
        string element = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<Percent>(
            element,
            ModelBase.SerializerOptions
        );
        Assert.NotNull(deserialized);
...
public class PercentConfigTest : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<PercentConfig>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        PercentConfig copied = new(model);
...
public class PercentConversionRateConfigTest : TestBase
{
    ...
    public void UnitValidationWorks()
    {
        PercentConversionRateConfig value = new Models::SharedUnitConversionRateConfig()
        {
            ConversionRateType = Models::SharedUnitConversionRateConfigConversionRateType.Unit,
            UnitConfig = new("unit_amount"),
        };
    ...
    public void UnitSerializationRoundtripWorks()
    {
        ...
        string element = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<PercentConversionRateConfig>(
            element,
            ModelBase.SerializerOptions
        );
...
public class EventOutputTest : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<EventOutput>(
            json,
            ModelBase.SerializerOptions
        );
...
public class EventOutputConfigTest : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<EventOutputConfig>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        EventOutputConfig copied = new(model);
...
public class EventOutputConversionRateConfigTest : TestBase
{
    ...
    public void UnitValidationWorks()
    {
        EventOutputConversionRateConfig value = new Models::SharedUnitConversionRateConfig()
        {
            ConversionRateType = Models::SharedUnitConversionRateConfigConversionRateType.Unit,
            UnitConfig = new("unit_amount"),
        };
    ...
    public void UnitSerializationRoundtripWorks()
    {
        ...
        string element = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<EventOutputConversionRateConfig>(
            element,
            ModelBase.SerializerOptions
        );
...
public class RemoveAdjustmentTest : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<RemoveAdjustment>(
            json,
            ModelBase.SerializerOptions
        );
...
public class RemovePriceTest : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<RemovePrice>(
            json,
            ModelBase.SerializerOptions
        );
...
public class ReplaceAdjustmentTest : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ReplaceAdjustment>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        ReplaceAdjustment copied = new(model);
...
public class ReplaceAdjustmentAdjustmentTest : TestBase
{
    ...
    public void NewPercentageDiscountValidationWorks()
    {
        ReplaceAdjustmentAdjustment value = new Models::NewPercentageDiscount()
        {
            AdjustmentType = Models::NewPercentageDiscountAdjustmentType.PercentageDiscount,
            PercentageDiscount = 0,
            AppliesToAll = Models::NewPercentageDiscountAppliesToAll.True,
    ...
    public void NewUsageDiscountValidationWorks()
    {
        ReplaceAdjustmentAdjustment value = new Models::NewUsageDiscount()
        {
            AdjustmentType = Models::NewUsageDiscountAdjustmentType.UsageDiscount,
            UsageDiscount = 0,
            AppliesToAll = Models::NewUsageDiscountAppliesToAll.True,
    ...
    public void NewAmountDiscountValidationWorks()
    {
        ReplaceAdjustmentAdjustment value = new Models::NewAmountDiscount()
        {
            AdjustmentType = Models::NewAmountDiscountAdjustmentType.AmountDiscount,
            AmountDiscount = "amount_discount",
            AppliesToAll = Models::AppliesToAll.True,
    ...
    public void NewMinimumValidationWorks()
    {
        ReplaceAdjustmentAdjustment value = new Models::NewMinimum()
        {
            AdjustmentType = Models::NewMinimumAdjustmentType.Minimum,
            ItemID = "item_id",
            MinimumAmount = "minimum_amount",
    ...
    public void NewMaximumValidationWorks()
    {
        ReplaceAdjustmentAdjustment value = new Models::NewMaximum()
        {
            AdjustmentType = Models::NewMaximumAdjustmentType.Maximum,
            MaximumAmount = "maximum_amount",
            AppliesToAll = Models::NewMaximumAppliesToAll.True,
    ...
    public void NewPercentageDiscountSerializationRoundtripWorks()
    {
        ...
        string element = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ReplaceAdjustmentAdjustment>(
            element,
            ModelBase.SerializerOptions
        );
...
public class ReplacePriceTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        ...
        ReplacePriceLicenseAllocationPrice expectedLicenseAllocationPrice = new()
        {
            Cadence = ReplacePriceLicenseAllocationPriceCadence.Annual,
            ItemID = "item_id",
            LicenseAllocations =
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ReplacePrice>(
            json,
            ModelBase.SerializerOptions
        );
...
public class ReplacePriceLicenseAllocationPriceTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ReplacePriceLicenseAllocationPrice
        {
            Cadence = ReplacePriceLicenseAllocationPriceCadence.Annual,
            ItemID = "item_id",
            LicenseAllocations =
        ...
        ApiEnum<string, ReplacePriceLicenseAllocationPriceCadence> expectedCadence =
            ReplacePriceLicenseAllocationPriceCadence.Annual;
        string expectedItemID = "item_id";
        List<ReplacePriceLicenseAllocationPriceLicenseAllocation> expectedLicenseAllocations =
        [
            new()
            {
                Amount = "amount",
        ...
        ApiEnum<string, ReplacePriceLicenseAllocationPriceModelType> expectedModelType =
            ReplacePriceLicenseAllocationPriceModelType.Unit;
        string expectedName = "Annual fee";
        Models::UnitConfig expectedUnitConfig = new()
        {
            UnitAmount = "unit_amount",
        ...
        double expectedConversionRate = 0;
        ReplacePriceLicenseAllocationPriceConversionRateConfig expectedConversionRateConfig =
            new Models::SharedUnitConversionRateConfig()
            {
                ConversionRateType = Models::SharedUnitConversionRateConfigConversionRateType.Unit,
                UnitConfig = new("unit_amount"),
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ReplacePriceLicenseAllocationPrice>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        ReplacePriceLicenseAllocationPrice copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class ReplacePriceLicenseAllocationPriceCadenceTest : TestBase
{
    [Theory]
    [InlineData(ReplacePriceLicenseAllocationPriceCadence.Annual)]
    [InlineData(ReplacePriceLicenseAllocationPriceCadence.SemiAnnual)]
    [InlineData(ReplacePriceLicenseAllocationPriceCadence.Monthly)]
    [InlineData(ReplacePriceLicenseAllocationPriceCadence.Quarterly)]
    [InlineData(ReplacePriceLicenseAllocationPriceCadence.OneTime)]
    [InlineData(ReplacePriceLicenseAllocationPriceCadence.Custom)]
    public void Validation_Works(ReplacePriceLicenseAllocationPriceCadence rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, ReplacePriceLicenseAllocationPriceCadence> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<
            ApiEnum<string, ReplacePriceLicenseAllocationPriceCadence>
    ...
    [InlineData(ReplacePriceLicenseAllocationPriceCadence.OneTime)]
    [InlineData(ReplacePriceLicenseAllocationPriceCadence.Custom)]
    public void SerializationRoundtrip_Works(ReplacePriceLicenseAllocationPriceCadence rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, ReplacePriceLicenseAllocationPriceCadence> value = rawValue;
...
public class ReplacePriceLicenseAllocationPriceLicenseAllocationTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ReplacePriceLicenseAllocationPriceLicenseAllocation
        {
            Amount = "amount",
            Currency = "currency",
            WriteOffOverage = true,
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized =
            JsonSerializer.Deserialize<ReplacePriceLicenseAllocationPriceLicenseAllocation>(
                json,
                ModelBase.SerializerOptions
            );
    ...
    public void CopyConstructor_Works()
    {
        ...
        ReplacePriceLicenseAllocationPriceLicenseAllocation copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class ReplacePriceLicenseAllocationPriceModelTypeTest : TestBase
{
    [Theory]
    [InlineData(ReplacePriceLicenseAllocationPriceModelType.Unit)]
    public void Validation_Works(ReplacePriceLicenseAllocationPriceModelType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, ReplacePriceLicenseAllocationPriceModelType> value = rawValue;
        value.Validate();
    }
    ...
    {
        var value = JsonSerializer.Deserialize<
            ApiEnum<string, ReplacePriceLicenseAllocationPriceModelType>
        >(JsonSerializer.SerializeToElement("invalid value"), ModelBase.SerializerOptions);
    ...
    [Theory]
    [InlineData(ReplacePriceLicenseAllocationPriceModelType.Unit)]
    public void SerializationRoundtrip_Works(ReplacePriceLicenseAllocationPriceModelType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, ReplacePriceLicenseAllocationPriceModelType> value = rawValue;
...
public class ReplacePriceLicenseAllocationPriceConversionRateConfigTest : TestBase
{
    [Fact]
    public void UnitValidationWorks()
    {
        ReplacePriceLicenseAllocationPriceConversionRateConfig value =
            new Models::SharedUnitConversionRateConfig()
            {
                ConversionRateType = Models::SharedUnitConversionRateConfigConversionRateType.Unit,
                UnitConfig = new("unit_amount"),
    ...
    public void UnitSerializationRoundtripWorks()
    {
        ...
        string element = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized =
            JsonSerializer.Deserialize<ReplacePriceLicenseAllocationPriceConversionRateConfig>(
                element,
                ModelBase.SerializerOptions
            );
...
public class ReplacePricePriceTest : TestBase
{
    ...
    public void NewPlanUnitValidationWorks()
    {
        ReplacePricePrice value = new Models::NewPlanUnitPrice()
        {
            Cadence = Models::NewPlanUnitPriceCadence.Annual,
            ItemID = "item_id",
            ModelType = Models::NewPlanUnitPriceModelType.Unit,
    ...
    public void NewPlanTieredValidationWorks()
    {
        ReplacePricePrice value = new Models::NewPlanTieredPrice()
        {
            Cadence = Models::NewPlanTieredPriceCadence.Annual,
            ItemID = "item_id",
            ModelType = Models::NewPlanTieredPriceModelType.Tiered,
    ...
    public void NewPlanBulkValidationWorks()
    {
        ReplacePricePrice value = new Models::NewPlanBulkPrice()
        {
            BulkConfig = new([new() { UnitAmount = "unit_amount", MaximumUnits = 0 }]),
            Cadence = Models::NewPlanBulkPriceCadence.Annual,
            ItemID = "item_id",
    ...
    public void BulkWithFiltersValidationWorks()
    {
        ReplacePricePrice value = new ReplacePricePriceBulkWithFilters()
        {
            BulkWithFiltersConfig = new()
            {
                Filters = [new() { PropertyKey = "x", PropertyValue = "x" }],
    ...
    public void NewPlanPackageValidationWorks()
    {
        ReplacePricePrice value = new Models::NewPlanPackagePrice()
        {
            Cadence = Models::NewPlanPackagePriceCadence.Annual,
            ItemID = "item_id",
            ModelType = Models::NewPlanPackagePriceModelType.Package,
    ...
    public void NewPlanMatrixValidationWorks()
    {
        ReplacePricePrice value = new Models::NewPlanMatrixPrice()
        {
            Cadence = Models::NewPlanMatrixPriceCadence.Annual,
            ItemID = "item_id",
            MatrixConfig = new()
    ...
    public void NewPlanThresholdTotalAmountValidationWorks()
    {
        ReplacePricePrice value = new Models::NewPlanThresholdTotalAmountPrice()
        {
            Cadence = Models::NewPlanThresholdTotalAmountPriceCadence.Annual,
            ItemID = "item_id",
            ModelType = Models::NewPlanThresholdTotalAmountPriceModelType.ThresholdTotalAmount,
    ...
    public void NewPlanTieredPackageValidationWorks()
    {
        ReplacePricePrice value = new Models::NewPlanTieredPackagePrice()
        {
            Cadence = Models::NewPlanTieredPackagePriceCadence.Annual,
            ItemID = "item_id",
            ModelType = Models::NewPlanTieredPackagePriceModelType.TieredPackage,
    ...
    public void NewPlanTieredWithMinimumValidationWorks()
    {
        ReplacePricePrice value = new Models::NewPlanTieredWithMinimumPrice()
        {
            Cadence = Models::NewPlanTieredWithMinimumPriceCadence.Annual,
            ItemID = "item_id",
            ModelType = Models::NewPlanTieredWithMinimumPriceModelType.TieredWithMinimum,
    ...
    public void NewPlanTieredPackageWithMinimumValidationWorks()
    {
        ReplacePricePrice value = new Models::NewPlanTieredPackageWithMinimumPrice()
        {
            Cadence = Models::NewPlanTieredPackageWithMinimumPriceCadence.Annual,
            ItemID = "item_id",
            ModelType =
    ...
    public void NewPlanPackageWithAllocationValidationWorks()
    {
        ReplacePricePrice value = new Models::NewPlanPackageWithAllocationPrice()
        {
            Cadence = Models::NewPlanPackageWithAllocationPriceCadence.Annual,
            ItemID = "item_id",
            ModelType = Models::NewPlanPackageWithAllocationPriceModelType.PackageWithAllocation,
    ...
    public void NewPlanUnitWithPercentValidationWorks()
    {
        ReplacePricePrice value = new Models::NewPlanUnitWithPercentPrice()
        {
            Cadence = Models::NewPlanUnitWithPercentPriceCadence.Annual,
            ItemID = "item_id",
            ModelType = Models::NewPlanUnitWithPercentPriceModelType.UnitWithPercent,
    ...
    public void NewPlanMatrixWithAllocationValidationWorks()
    {
        ReplacePricePrice value = new Models::NewPlanMatrixWithAllocationPrice()
        {
            Cadence = Models::NewPlanMatrixWithAllocationPriceCadence.Annual,
            ItemID = "item_id",
            MatrixWithAllocationConfig = new()
    ...
    public void TieredWithProrationValidationWorks()
    {
        ReplacePricePrice value = new ReplacePricePriceTieredWithProration()
        {
    ...
    public void NewPlanGroupedAllocationValidationWorks()
    {
        ReplacePricePrice value = new Models::NewPlanGroupedAllocationPrice()
        {
            Cadence = Models::NewPlanGroupedAllocationPriceCadence.Annual,
            GroupedAllocationConfig = new()
            {
    ...
    public void NewPlanBulkWithProrationValidationWorks()
    {
        ReplacePricePrice value = new Models::NewPlanBulkWithProrationPrice()
        {
            BulkWithProrationConfig = new(
                [
                    new() { UnitAmount = "unit_amount", TierLowerBound = "tier_lower_bound" },
    ...
    public void NewPlanGroupedWithProratedMinimumValidationWorks()
    {
        ReplacePricePrice value = new Models::NewPlanGroupedWithProratedMinimumPrice()
        {
            Cadence = Models::NewPlanGroupedWithProratedMinimumPriceCadence.Annual,
            GroupedWithProratedMinimumConfig = new()
            {
    ...
    public void GroupedWithMinMaxThresholdsValidationWorks()
    {
        ReplacePricePrice value = new ReplacePricePriceGroupedWithMinMaxThresholds()
        {
    ...
    public void NewPlanMatrixWithDisplayNameValidationWorks()
    {
        ReplacePricePrice value = new Models::NewPlanMatrixWithDisplayNamePrice()
        {
            Cadence = Models::NewPlanMatrixWithDisplayNamePriceCadence.Annual,
            ItemID = "item_id",
            MatrixWithDisplayNameConfig = new()
    ...
    public void NewPlanMaxGroupTieredPackageValidationWorks()
    {
        ReplacePricePrice value = new Models::NewPlanMaxGroupTieredPackagePrice()
        {
            Cadence = Models::NewPlanMaxGroupTieredPackagePriceCadence.Annual,
            ItemID = "item_id",
            MaxGroupTieredPackageConfig = new()
    ...
    public void NewPlanScalableMatrixWithTieredPricingValidationWorks()
    {
        ReplacePricePrice value = new Models::NewPlanScalableMatrixWithTieredPricingPrice()
        {
            Cadence = Models::NewPlanScalableMatrixWithTieredPricingPriceCadence.Annual,
            ItemID = "item_id",
            ModelType =
    ...
    public void NewPlanCumulativeGroupedBulkValidationWorks()
    {
        ReplacePricePrice value = new Models::NewPlanCumulativeGroupedBulkPrice()
        {
            Cadence = Models::NewPlanCumulativeGroupedBulkPriceCadence.Annual,
            CumulativeGroupedBulkConfig = new()
            {
    ...
    public void NewPlanMinimumCompositeValidationWorks()
    {
        ReplacePricePrice value = new Models::NewPlanMinimumCompositePrice()
        {
            Cadence = Models::NewPlanMinimumCompositePriceCadence.Annual,
            ItemID = "item_id",
            MinimumCompositeConfig = new() { MinimumAmount = "minimum_amount", Prorated = true },
    ...
    public void PercentValidationWorks()
    {
        ReplacePricePrice value = new ReplacePricePricePercent()
        {
    ...
    public void NewPlanUnitSerializationRoundtripWorks()
    {
        ...
        string element = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ReplacePricePrice>(
            element,
            ModelBase.SerializerOptions
        );
...
public class ReplacePricePriceBulkWithFiltersBulkWithFiltersConfigTest : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized =
            JsonSerializer.Deserialize<ReplacePricePriceBulkWithFiltersBulkWithFiltersConfig>(
                json,
                ModelBase.SerializerOptions
            );
    ...
    public void CopyConstructor_Works()
    {
        ...
        ReplacePricePriceBulkWithFiltersBulkWithFiltersConfig copied = new(model);
...
public class ReplacePricePriceBulkWithFiltersBulkWithFiltersConfigFilterTest : TestBase
{
    ...
    public void CopyConstructor_Works()
    {
        ...
        ReplacePricePriceBulkWithFiltersBulkWithFiltersConfigFilter copied = new(model);
...
public class ReplacePricePriceBulkWithFiltersBulkWithFiltersConfigTierTest : TestBase
{
    ...
    public void CopyConstructor_Works()
    {
        ...
        ReplacePricePriceBulkWithFiltersBulkWithFiltersConfigTier copied = new(model);
...
public class ReplacePricePriceBulkWithFiltersConversionRateConfigTest : TestBase
{
    ...
    public void UnitSerializationRoundtripWorks()
    {
        ...
        string element = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized =
            JsonSerializer.Deserialize<ReplacePricePriceBulkWithFiltersConversionRateConfig>(
                element,
                ModelBase.SerializerOptions
            );
...
public class ReplacePricePriceTieredWithProrationTest : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ReplacePricePriceTieredWithProration>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        ReplacePricePriceTieredWithProration copied = new(model);
...
public class ReplacePricePriceTieredWithProrationTieredWithProrationConfigTest : TestBase
{
    ...
    public void CopyConstructor_Works()
    {
        ...
        ReplacePricePriceTieredWithProrationTieredWithProrationConfig copied = new(model);
...
public class ReplacePricePriceTieredWithProrationTieredWithProrationConfigTierTest : TestBase
{
    ...
    public void CopyConstructor_Works()
    {
        ...
        ReplacePricePriceTieredWithProrationTieredWithProrationConfigTier copied = new(model);
...
public class ReplacePricePriceGroupedWithMinMaxThresholdsTest : TestBase
{
    ...
    public void CopyConstructor_Works()
    {
        ...
        ReplacePricePriceGroupedWithMinMaxThresholds copied = new(model);
    ...
    : TestBase
{
    ...
    public void CopyConstructor_Works()
    {
        ...
        ReplacePricePriceGroupedWithMinMaxThresholdsGroupedWithMinMaxThresholdsConfig copied = new(
            model
        );
...
public class ReplacePricePriceCumulativeGroupedAllocationTest : TestBase
{
    ...
    public void CopyConstructor_Works()
    {
        ...
        ReplacePricePriceCumulativeGroupedAllocation copied = new(model);
    ...
    : TestBase
{
    ...
    public void CopyConstructor_Works()
    {
        ...
        ReplacePricePriceCumulativeGroupedAllocationCumulativeGroupedAllocationConfig copied = new(
            model
        );
...
public class ReplacePricePricePercentPercentConfigTest : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ReplacePricePricePercentPercentConfig>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        ReplacePricePricePercentPercentConfig copied = new(model);
...
public class ReplacePricePriceEventOutputTest : TestBase
{
    ...
    public void CopyConstructor_Works()
    {
        ...
        ReplacePricePriceEventOutput copied = new(model);
...
public class ReplacePricePriceEventOutputEventOutputConfigTest : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized =
            JsonSerializer.Deserialize<ReplacePricePriceEventOutputEventOutputConfig>(
                json,
                ModelBase.SerializerOptions
            );
    ...
    public void CopyConstructor_Works()
    {
        ...
        ReplacePricePriceEventOutputEventOutputConfig copied = new(model);
...
public class ReplacePricePriceEventOutputConversionRateConfigTest : TestBase
{
    ...
    public void UnitSerializationRoundtripWorks()
    {
        ...
        string element = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized =
            JsonSerializer.Deserialize<ReplacePricePriceEventOutputConversionRateConfig>(
                element,
                ModelBase.SerializerOptions
            );
