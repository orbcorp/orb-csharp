...
public class NewFloatingThresholdTotalAmountPriceTest : TestBase
{
    ...
    public void CopyConstructor_Works()
    {
        ...
        NewFloatingThresholdTotalAmountPrice copied = new(model);
...
public class ThresholdTotalAmountConfigTest : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ThresholdTotalAmountConfig>(
            json,
            ModelBase.SerializerOptions
        );
...
public class ConsumptionTableTest : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ConsumptionTable>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        ConsumptionTable copied = new(model);
