...
public class BackfillListResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BackfillListResponse
        {
            ID = "id",
        ...
        ApiEnum<string, BackfillListResponseStatus> expectedStatus =
            BackfillListResponseStatus.Pending;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BackfillListResponse>(json);
    ...
    public void FieldRoundtripThroughSerialization_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BackfillListResponse>(element);
...
public class BackfillListResponseStatusTest : TestBase
{
    [Theory]
    [InlineData(BackfillListResponseStatus.Pending)]
    [InlineData(BackfillListResponseStatus.Reflected)]
    [InlineData(BackfillListResponseStatus.PendingRevert)]
    [InlineData(BackfillListResponseStatus.Reverted)]
    public void Validation_Works(BackfillListResponseStatus rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, BackfillListResponseStatus> value = rawValue;
        value.Validate();
    }
    ...
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, BackfillListResponseStatus>>(
    ...
    [InlineData(BackfillListResponseStatus.PendingRevert)]
    [InlineData(BackfillListResponseStatus.Reverted)]
    public void SerializationRoundtrip_Works(BackfillListResponseStatus rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, BackfillListResponseStatus> value = rawValue;

        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ApiEnum<string, BackfillListResponseStatus>>(
            json,
            ModelBase.SerializerOptions
        );
