...
public class BackfillCreateResponseTest : TestBase
{
    [Fact]
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BackfillCreateResponse>(json);
    ...
    public void FieldRoundtripThroughSerialization_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BackfillCreateResponse>(element);
...
public class StatusTest : TestBase
{
    ...
    [InlineData(Status.Reflected)]
    [InlineData(Status.PendingRevert)]
    [InlineData(Status.Reverted)]
