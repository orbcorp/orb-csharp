...
public class NewFloatingScalableMatrixWithTieredPricingPriceTest : TestBase
{
    ...
    public void CopyConstructor_Works()
    {
        ...
        NewFloatingScalableMatrixWithTieredPricingPrice copied = new(model);
...
public class ScalableMatrixWithTieredPricingConfigTest : TestBase
{
    ...
    public void CopyConstructor_Works()
    {
        ...
        ScalableMatrixWithTieredPricingConfig copied = new(model);
...
public class MatrixScalingFactorTest : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<MatrixScalingFactor>(
            json,
            ModelBase.SerializerOptions
        );
