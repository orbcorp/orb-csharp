...
public class NewSubscriptionTieredPackageWithMinimumPriceTest : TestBase
{
    ...
    {
        var model = new Subscriptions::NewSubscriptionTieredPackageWithMinimumPrice
        {
        ...
        > expectedCadence =
            Subscriptions::NewSubscriptionTieredPackageWithMinimumPriceCadence.Annual;
        ...
        Subscriptions::TieredPackageWithMinimumConfig expectedTieredPackageWithMinimumConfig = new()
        {
            PackageSize = 0,
            Tiers =
            [
        ...
        Subscriptions::NewSubscriptionTieredPackageWithMinimumPriceConversionRateConfig expectedConversionRateConfig =
...
public class NewSubscriptionTieredPackageWithMinimumPriceCadenceTest : TestBase
{
    [Theory]
    [InlineData(Subscriptions::NewSubscriptionTieredPackageWithMinimumPriceCadence.Annual)]
    [InlineData(Subscriptions::NewSubscriptionTieredPackageWithMinimumPriceCadence.SemiAnnual)]
    [InlineData(Subscriptions::NewSubscriptionTieredPackageWithMinimumPriceCadence.Monthly)]
    [InlineData(Subscriptions::NewSubscriptionTieredPackageWithMinimumPriceCadence.Quarterly)]
    [InlineData(Subscriptions::NewSubscriptionTieredPackageWithMinimumPriceCadence.OneTime)]
    [InlineData(Subscriptions::NewSubscriptionTieredPackageWithMinimumPriceCadence.Custom)]
    public void Validation_Works(
        Subscriptions::NewSubscriptionTieredPackageWithMinimumPriceCadence rawValue
    )
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Subscriptions::NewSubscriptionTieredPackageWithMinimumPriceCadence> value =
            rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<
            ApiEnum<string, Subscriptions::NewSubscriptionTieredPackageWithMinimumPriceCadence>
...
public class NewSubscriptionTieredPackageWithMinimumPriceModelTypeTest : TestBase
{
    [Theory]
    [InlineData(
        Subscriptions::NewSubscriptionTieredPackageWithMinimumPriceModelType.TieredPackageWithMinimum
    ...
    public void Validation_Works(
        Subscriptions::NewSubscriptionTieredPackageWithMinimumPriceModelType rawValue
    )
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<
    ...
    {
        var value = JsonSerializer.Deserialize<
            ApiEnum<string, Subscriptions::NewSubscriptionTieredPackageWithMinimumPriceModelType>
        >(JsonSerializer.SerializeToElement("invalid value"), ModelBase.SerializerOptions);
...
public class TieredPackageWithMinimumConfigTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        var model = new Subscriptions::TieredPackageWithMinimumConfig
        {
            PackageSize = 0,
            Tiers =
            [
        ...
        List<Subscriptions::TieredPackageWithMinimumConfigTier> expectedTiers =
        [
            new()
            {
                MinimumAmount = "minimum_amount",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized =
            JsonSerializer.Deserialize<Subscriptions::TieredPackageWithMinimumConfig>(
                json,
                ModelBase.SerializerOptions
            );
    ...
    public void CopyConstructor_Works()
    {
        ...
        Subscriptions::TieredPackageWithMinimumConfig copied = new(model);
...
public class TieredPackageWithMinimumConfigTierTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        var model = new Subscriptions::TieredPackageWithMinimumConfigTier
        {
            MinimumAmount = "minimum_amount",
            PerUnit = "per_unit",
            TierLowerBound = "tier_lower_bound",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized =
            JsonSerializer.Deserialize<Subscriptions::TieredPackageWithMinimumConfigTier>(
                json,
                ModelBase.SerializerOptions
            );
    ...
    public void CopyConstructor_Works()
    {
        ...
        Subscriptions::TieredPackageWithMinimumConfigTier copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class NewSubscriptionTieredPackageWithMinimumPriceConversionRateConfigTest : TestBase
{
    [Fact]
