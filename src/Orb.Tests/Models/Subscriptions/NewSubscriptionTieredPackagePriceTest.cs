...
public class NewSubscriptionTieredPackagePriceTest : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized =
            JsonSerializer.Deserialize<Subscriptions::NewSubscriptionTieredPackagePrice>(
                json,
...
public class TieredPackageConfigTest : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<Subscriptions::TieredPackageConfig>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        Subscriptions::TieredPackageConfig copied = new(model);
...
public class TieredPackageConfigTierTest : TestBase
{
    ...
    public void CopyConstructor_Works()
    {
        ...
        Subscriptions::TieredPackageConfigTier copied = new(model);
