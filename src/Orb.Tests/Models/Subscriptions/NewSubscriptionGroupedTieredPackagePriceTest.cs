...
public class GroupedTieredPackageConfigTierTest : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model);
        var deserialized =
            JsonSerializer.Deserialize<Subscriptions::GroupedTieredPackageConfigTier>(json);
    ...
    public void FieldRoundtripThroughSerialization_Works()
    {
        ...
        string element = JsonSerializer.Serialize(model);
        var deserialized =
            JsonSerializer.Deserialize<Subscriptions::GroupedTieredPackageConfigTier>(element);
        Assert.NotNull(deserialized);
...
public class NewSubscriptionGroupedTieredPackagePriceConversionRateConfigTest : TestBase
{
    ...
    {
        Subscriptions::NewSubscriptionGroupedTieredPackagePriceConversionRateConfig value = new(
            new SharedUnitConversionRateConfig()
            {
                ConversionRateType = SharedUnitConversionRateConfigConversionRateType.Unit,
                UnitConfig = new("unit_amount"),
