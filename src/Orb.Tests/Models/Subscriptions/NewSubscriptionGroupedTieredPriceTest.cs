...
public class NewSubscriptionGroupedTieredPriceTest : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized =
            JsonSerializer.Deserialize<Subscriptions::NewSubscriptionGroupedTieredPrice>(
                json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        Subscriptions::NewSubscriptionGroupedTieredPrice copied = new(model);
...
public class GroupedTieredConfigTest : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<Subscriptions::GroupedTieredConfig>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        Subscriptions::GroupedTieredConfig copied = new(model);
...
public class GroupedTieredConfigTierTest : TestBase
{
    ...
    public void CopyConstructor_Works()
    {
        ...
        Subscriptions::GroupedTieredConfigTier copied = new(model);
