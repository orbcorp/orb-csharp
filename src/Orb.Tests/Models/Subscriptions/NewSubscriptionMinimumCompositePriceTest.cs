...
public class NewSubscriptionMinimumCompositePriceTest : TestBase
{
    ...
    {
        var model = new NewSubscriptionMinimumCompositePrice
        {
            Cadence = NewSubscriptionMinimumCompositePriceCadence.Annual,
            ItemID = "item_id",
            MinimumConfig = new() { MinimumAmount = "minimum_amount", Prorated = true },
            ModelType = NewSubscriptionMinimumCompositePriceModelType.Minimum,
            Name = "Annual fee",
        ...
        ApiEnum<string, NewSubscriptionMinimumCompositePriceCadence> expectedCadence =
            NewSubscriptionMinimumCompositePriceCadence.Annual;
        ...
        ApiEnum<string, NewSubscriptionMinimumCompositePriceModelType> expectedModelType =
            NewSubscriptionMinimumCompositePriceModelType.Minimum;
        ...
        NewSubscriptionMinimumCompositePriceConversionRateConfig expectedConversionRateConfig =
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<NewSubscriptionMinimumCompositePrice>(json);
