...
public class MatrixWithDisplayNameConfigTest : TestBase
{
    ...
    public void CopyConstructor_Works()
    {
        ...
        Subscriptions::MatrixWithDisplayNameConfig copied = new(model);
...
public class MatrixWithDisplayNameConfigUnitAmountTest : TestBase
{
    ...
    public void CopyConstructor_Works()
    {
        ...
        Subscriptions::MatrixWithDisplayNameConfigUnitAmount copied = new(model);
...
public class NewSubscriptionMatrixWithDisplayNamePriceConversionRateConfigTest : TestBase
{
    ...
    {
        Subscriptions::NewSubscriptionMatrixWithDisplayNamePriceConversionRateConfig value =
            new SharedUnitConversionRateConfig()
            {
                ConversionRateType = SharedUnitConversionRateConfigConversionRateType.Unit,
                UnitConfig = new("unit_amount"),
