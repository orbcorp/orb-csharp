...
public class NewSubscriptionScalableMatrixWithUnitPricingPriceTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new Subscriptions::NewSubscriptionScalableMatrixWithUnitPricingPrice
        {
            Cadence =
        ...
        Subscriptions::ScalableMatrixWithUnitPricingConfig expectedScalableMatrixWithUnitPricingConfig =
            new()
            {
                FirstDimension = "first_dimension",
                MatrixScalingFactors =
        ...
        Subscriptions::NewSubscriptionScalableMatrixWithUnitPricingPriceConversionRateConfig expectedConversionRateConfig =
...
public class NewSubscriptionScalableMatrixWithUnitPricingPriceCadenceTest : TestBase
{
    [Theory]
    [InlineData(Subscriptions::NewSubscriptionScalableMatrixWithUnitPricingPriceCadence.Annual)]
    [InlineData(Subscriptions::NewSubscriptionScalableMatrixWithUnitPricingPriceCadence.SemiAnnual)]
    [InlineData(Subscriptions::NewSubscriptionScalableMatrixWithUnitPricingPriceCadence.Monthly)]
    [InlineData(Subscriptions::NewSubscriptionScalableMatrixWithUnitPricingPriceCadence.Quarterly)]
    [InlineData(Subscriptions::NewSubscriptionScalableMatrixWithUnitPricingPriceCadence.OneTime)]
    [InlineData(Subscriptions::NewSubscriptionScalableMatrixWithUnitPricingPriceCadence.Custom)]
    public void Validation_Works(
        Subscriptions::NewSubscriptionScalableMatrixWithUnitPricingPriceCadence rawValue
    )
    {
...
public class NewSubscriptionScalableMatrixWithUnitPricingPriceModelTypeTest : TestBase
{
    [Theory]
    [InlineData(
        Subscriptions::NewSubscriptionScalableMatrixWithUnitPricingPriceModelType.ScalableMatrixWithUnitPricing
    ...
    public void Validation_Works(
        Subscriptions::NewSubscriptionScalableMatrixWithUnitPricingPriceModelType rawValue
    )
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<
...
public class ScalableMatrixWithUnitPricingConfigTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        var model = new Subscriptions::ScalableMatrixWithUnitPricingConfig
        {
            FirstDimension = "first_dimension",
            MatrixScalingFactors =
            [
        ...
        List<Subscriptions::ScalableMatrixWithUnitPricingConfigMatrixScalingFactor> expectedMatrixScalingFactors =
        [
            new()
            {
                FirstDimensionValue = "first_dimension_value",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized =
            JsonSerializer.Deserialize<Subscriptions::ScalableMatrixWithUnitPricingConfig>(
                json,
                ModelBase.SerializerOptions
            );
    ...
    public void CopyConstructor_Works()
    {
        ...
        Subscriptions::ScalableMatrixWithUnitPricingConfig copied = new(model);
...
public class ScalableMatrixWithUnitPricingConfigMatrixScalingFactorTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        var model = new Subscriptions::ScalableMatrixWithUnitPricingConfigMatrixScalingFactor
        {
            FirstDimensionValue = "first_dimension_value",
            ScalingFactor = "scaling_factor",
            SecondDimensionValue = "second_dimension_value",
