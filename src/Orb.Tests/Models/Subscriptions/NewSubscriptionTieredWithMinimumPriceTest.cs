...
public class NewSubscriptionTieredWithMinimumPriceTest : TestBase
{
    ...
    {
        var model = new Subscriptions::NewSubscriptionTieredWithMinimumPrice
        {
        ...
        > expectedCadence = Subscriptions::NewSubscriptionTieredWithMinimumPriceCadence.Annual;
        ...
        Subscriptions::TieredWithMinimumConfig expectedTieredWithMinimumConfig = new()
        {
            Tiers =
            [
                new()
        ...
        Subscriptions::NewSubscriptionTieredWithMinimumPriceConversionRateConfig expectedConversionRateConfig =
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized =
            JsonSerializer.Deserialize<Subscriptions::NewSubscriptionTieredWithMinimumPrice>(
                json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        Subscriptions::NewSubscriptionTieredWithMinimumPrice copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class NewSubscriptionTieredWithMinimumPriceCadenceTest : TestBase
{
    [Theory]
    [InlineData(Subscriptions::NewSubscriptionTieredWithMinimumPriceCadence.Annual)]
    [InlineData(Subscriptions::NewSubscriptionTieredWithMinimumPriceCadence.SemiAnnual)]
    [InlineData(Subscriptions::NewSubscriptionTieredWithMinimumPriceCadence.Monthly)]
    [InlineData(Subscriptions::NewSubscriptionTieredWithMinimumPriceCadence.Quarterly)]
    [InlineData(Subscriptions::NewSubscriptionTieredWithMinimumPriceCadence.OneTime)]
    [InlineData(Subscriptions::NewSubscriptionTieredWithMinimumPriceCadence.Custom)]
    public void Validation_Works(
        Subscriptions::NewSubscriptionTieredWithMinimumPriceCadence rawValue
    )
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Subscriptions::NewSubscriptionTieredWithMinimumPriceCadence> value =
            rawValue;
        value.Validate();
    }
...
public class NewSubscriptionTieredWithMinimumPriceModelTypeTest : TestBase
{
    [Theory]
    [InlineData(Subscriptions::NewSubscriptionTieredWithMinimumPriceModelType.TieredWithMinimum)]
    public void Validation_Works(
        Subscriptions::NewSubscriptionTieredWithMinimumPriceModelType rawValue
    )
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Subscriptions::NewSubscriptionTieredWithMinimumPriceModelType> value =
            rawValue;
        value.Validate();
    }
    ...
    {
        var value = JsonSerializer.Deserialize<
            ApiEnum<string, Subscriptions::NewSubscriptionTieredWithMinimumPriceModelType>
        >(JsonSerializer.SerializeToElement("invalid value"), ModelBase.SerializerOptions);
...
public class TieredWithMinimumConfigTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        var model = new Subscriptions::TieredWithMinimumConfig
        {
            Tiers =
            [
                new()
        ...
        List<Subscriptions::TieredWithMinimumConfigTier> expectedTiers =
        [
            new()
            {
                MinimumAmount = "minimum_amount",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<Subscriptions::TieredWithMinimumConfig>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        Subscriptions::TieredWithMinimumConfig copied = new(model);
...
public class TieredWithMinimumConfigTierTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        var model = new Subscriptions::TieredWithMinimumConfigTier
        {
            MinimumAmount = "minimum_amount",
            TierLowerBound = "tier_lower_bound",
            UnitAmount = "unit_amount",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<Subscriptions::TieredWithMinimumConfigTier>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        Subscriptions::TieredWithMinimumConfigTier copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class NewSubscriptionTieredWithMinimumPriceConversionRateConfigTest : TestBase
{
    [Fact]
