...
public class NewFloatingGroupedWithProratedMinimumPriceTest : TestBase
{
    ...
    public void CopyConstructor_Works()
    {
        ...
        NewFloatingGroupedWithProratedMinimumPrice copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class NewFloatingGroupedWithProratedMinimumPriceCadenceTest : TestBase
{
    [Theory]
    [InlineData(NewFloatingGroupedWithProratedMinimumPriceCadence.Annual)]
    [InlineData(NewFloatingGroupedWithProratedMinimumPriceCadence.SemiAnnual)]
    [InlineData(NewFloatingGroupedWithProratedMinimumPriceCadence.Monthly)]
    [InlineData(NewFloatingGroupedWithProratedMinimumPriceCadence.Quarterly)]
    [InlineData(NewFloatingGroupedWithProratedMinimumPriceCadence.OneTime)]
    [InlineData(NewFloatingGroupedWithProratedMinimumPriceCadence.Custom)]
    public void Validation_Works(NewFloatingGroupedWithProratedMinimumPriceCadence rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, NewFloatingGroupedWithProratedMinimumPriceCadence> value = rawValue;
        value.Validate();
    }
    ...
    [InlineData(NewFloatingGroupedWithProratedMinimumPriceCadence.Custom)]
    public void SerializationRoundtrip_Works(
        NewFloatingGroupedWithProratedMinimumPriceCadence rawValue
    )
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, NewFloatingGroupedWithProratedMinimumPriceCadence> value = rawValue;
...
public class GroupedWithProratedMinimumConfigTest : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<GroupedWithProratedMinimumConfig>(
            json,
            ModelBase.SerializerOptions
        );
...
public class NewFloatingGroupedWithProratedMinimumPriceModelTypeTest : TestBase
{
    [Theory]
    [InlineData(NewFloatingGroupedWithProratedMinimumPriceModelType.GroupedWithProratedMinimum)]
    public void Validation_Works(NewFloatingGroupedWithProratedMinimumPriceModelType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, NewFloatingGroupedWithProratedMinimumPriceModelType> value = rawValue;
        value.Validate();
    }
    ...
    [InlineData(NewFloatingGroupedWithProratedMinimumPriceModelType.GroupedWithProratedMinimum)]
    public void SerializationRoundtrip_Works(
        NewFloatingGroupedWithProratedMinimumPriceModelType rawValue
    )
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, NewFloatingGroupedWithProratedMinimumPriceModelType> value = rawValue;
...
public class NewFloatingGroupedWithProratedMinimumPriceConversionRateConfigTest : TestBase
{
    [Fact]
