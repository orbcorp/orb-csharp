...
public class NewPlanGroupedTieredPriceGroupedTieredConfigTest : TestBase
{
    ...
    public void CopyConstructor_Works()
    {
        ...
        NewPlanGroupedTieredPriceGroupedTieredConfig copied = new(model);
...
public class NewPlanGroupedTieredPriceGroupedTieredConfigTierTest : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized =
            JsonSerializer.Deserialize<NewPlanGroupedTieredPriceGroupedTieredConfigTier>(
                json,
                ModelBase.SerializerOptions
            );
    ...
    public void CopyConstructor_Works()
    {
        ...
        NewPlanGroupedTieredPriceGroupedTieredConfigTier copied = new(model);
...
public class NewPlanGroupedTieredPriceConversionRateConfigTest : TestBase
{
    ...
    {
        NewPlanGroupedTieredPriceConversionRateConfig value = new SharedUnitConversionRateConfig()
        {
            ConversionRateType = SharedUnitConversionRateConfigConversionRateType.Unit,
            UnitConfig = new("unit_amount"),
        };
    ...
    {
        NewPlanGroupedTieredPriceConversionRateConfig value = new SharedTieredConversionRateConfig()
        {
    ...
    public void UnitSerializationRoundtripWorks()
    {
        ...
        var deserialized =
            JsonSerializer.Deserialize<NewPlanGroupedTieredPriceConversionRateConfig>(
                element,
                ModelBase.SerializerOptions
            );
