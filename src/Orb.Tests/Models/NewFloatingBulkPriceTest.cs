...
public class NewFloatingBulkPriceTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new NewFloatingBulkPrice
        {
        ...
        ApiEnum<string, NewFloatingBulkPriceCadence> expectedCadence =
            NewFloatingBulkPriceCadence.Annual;
        ...
        ConversionRateConfig expectedConversionRateConfig = new SharedUnitConversionRateConfig()
        {
            ConversionRateType = SharedUnitConversionRateConfigConversionRateType.Unit,
            UnitConfig = new("unit_amount"),
        };
    ...
    public void CopyConstructor_Works()
    {
        ...
        NewFloatingBulkPrice copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class NewFloatingBulkPriceCadenceTest : TestBase
{
    [Theory]
    [InlineData(NewFloatingBulkPriceCadence.Annual)]
    [InlineData(NewFloatingBulkPriceCadence.SemiAnnual)]
    [InlineData(NewFloatingBulkPriceCadence.Monthly)]
    [InlineData(NewFloatingBulkPriceCadence.Quarterly)]
    [InlineData(NewFloatingBulkPriceCadence.OneTime)]
    [InlineData(NewFloatingBulkPriceCadence.Custom)]
    public void Validation_Works(NewFloatingBulkPriceCadence rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, NewFloatingBulkPriceCadence> value = rawValue;
        value.Validate();
    }
    ...
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, NewFloatingBulkPriceCadence>>(
    ...
    [InlineData(NewFloatingBulkPriceCadence.OneTime)]
    [InlineData(NewFloatingBulkPriceCadence.Custom)]
    public void SerializationRoundtrip_Works(NewFloatingBulkPriceCadence rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, NewFloatingBulkPriceCadence> value = rawValue;

        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ApiEnum<string, NewFloatingBulkPriceCadence>>(
            json,
            ModelBase.SerializerOptions
        );
...
public class ConversionRateConfigTest : TestBase
{
    ...
    {
        ConversionRateConfig value = new SharedUnitConversionRateConfig()
        {
            ConversionRateType = SharedUnitConversionRateConfigConversionRateType.Unit,
            UnitConfig = new("unit_amount"),
        };
    ...
    {
        ConversionRateConfig value = new SharedTieredConversionRateConfig()
        {
