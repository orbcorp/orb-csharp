...
public class NewFloatingUnitPriceTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new NewFloatingUnitPrice
        {
        ...
        ApiEnum<string, NewFloatingUnitPriceCadence> expectedCadence =
            NewFloatingUnitPriceCadence.Annual;
        string expectedCurrency = "currency";
        string expectedItemID = "item_id";
        ApiEnum<string, NewFloatingUnitPriceModelType> expectedModelType =
            NewFloatingUnitPriceModelType.Unit;
        ...
        NewFloatingUnitPriceConversionRateConfig expectedConversionRateConfig =
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<NewFloatingUnitPrice>(json);
    ...
    public void FieldRoundtripThroughSerialization_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<NewFloatingUnitPrice>(element);
...
public class NewFloatingUnitPriceConversionRateConfigTest : TestBase
{
    ...
    {
        NewFloatingUnitPriceConversionRateConfig value = new SharedUnitConversionRateConfig()
        {
            ConversionRateType = SharedUnitConversionRateConfigConversionRateType.Unit,
            UnitConfig = new("unit_amount"),
        };
    ...
    {
        NewFloatingUnitPriceConversionRateConfig value = new SharedTieredConversionRateConfig()
        {
