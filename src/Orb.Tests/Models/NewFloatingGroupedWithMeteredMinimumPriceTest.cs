...
public class NewFloatingGroupedWithMeteredMinimumPriceTest : TestBase
{
    ...
    public void CopyConstructor_Works()
    {
        ...
        NewFloatingGroupedWithMeteredMinimumPrice copied = new(model);
...
public class GroupedWithMeteredMinimumConfigTest : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<GroupedWithMeteredMinimumConfig>(
            json,
            ModelBase.SerializerOptions
        );
...
public class ScalingFactorTest : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ScalingFactor>(
            json,
            ModelBase.SerializerOptions
        );
...
public class UnitAmountTest : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<UnitAmount>(
            json,
            ModelBase.SerializerOptions
        );
