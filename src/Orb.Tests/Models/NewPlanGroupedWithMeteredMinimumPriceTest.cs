...
public class NewPlanGroupedWithMeteredMinimumPriceGroupedWithMeteredMinimumConfigTest : TestBase
{
    ...
    public void CopyConstructor_Works()
    {
        ...
        NewPlanGroupedWithMeteredMinimumPriceGroupedWithMeteredMinimumConfig copied = new(model);
    ...
    : TestBase
{
    ...
    public void CopyConstructor_Works()
    {
        ...
        NewPlanGroupedWithMeteredMinimumPriceGroupedWithMeteredMinimumConfigScalingFactor copied =
            new(model);
    ...
    : TestBase
{
    ...
    public void CopyConstructor_Works()
    {
        ...
        NewPlanGroupedWithMeteredMinimumPriceGroupedWithMeteredMinimumConfigUnitAmount copied = new(
            model
        );
