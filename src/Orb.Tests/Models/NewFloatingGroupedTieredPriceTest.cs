...
public class NewFloatingGroupedTieredPriceTest : TestBase
{
    ...
    public void CopyConstructor_Works()
    {
        ...
        NewFloatingGroupedTieredPrice copied = new(model);
...
public class GroupedTieredConfigTest : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<GroupedTieredConfig>(
            json,
            ModelBase.SerializerOptions
        );
...
public class GroupedTieredConfigTierTest : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<GroupedTieredConfigTier>(
            json,
            ModelBase.SerializerOptions
        );
...
public class NewFloatingGroupedTieredPriceConversionRateConfigTest : TestBase
{
    ...
    public void UnitSerializationRoundtripWorks()
    {
        ...
        var deserialized =
            JsonSerializer.Deserialize<NewFloatingGroupedTieredPriceConversionRateConfig>(
                element,
                ModelBase.SerializerOptions
            );
