...
public class NewPlanGroupedTieredPackagePriceGroupedTieredPackageConfigTest : TestBase
{
    ...
    public void CopyConstructor_Works()
    {
        ...
        NewPlanGroupedTieredPackagePriceGroupedTieredPackageConfig copied = new(model);
...
public class NewPlanGroupedTieredPackagePriceGroupedTieredPackageConfigTierTest : TestBase
{
    ...
    public void CopyConstructor_Works()
    {
        ...
        NewPlanGroupedTieredPackagePriceGroupedTieredPackageConfigTier copied = new(model);
...
public class NewPlanGroupedTieredPackagePriceConversionRateConfigTest : TestBase
{
    ...
    public void UnitSerializationRoundtripWorks()
    {
        ...
        var deserialized =
            JsonSerializer.Deserialize<NewPlanGroupedTieredPackagePriceConversionRateConfig>(
                element,
                ModelBase.SerializerOptions
            );
