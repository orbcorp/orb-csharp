...
public class ChangedSubscriptionResourcesTest : TestBase
{
    ...
    public void CopyConstructor_Works()
    {
        ...
        Models::ChangedSubscriptionResources copied = new(model);
...
public class CreatedInvoiceTest : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<Models::CreatedInvoice>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        Models::CreatedInvoice copied = new(model);
...
public class AutoCollectionTest : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<Models::AutoCollection>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        Models::AutoCollection copied = new(model);
...
public class CreditNoteTest : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<Models::CreditNote>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        Models::CreditNote copied = new(model);
...
public class CustomerBalanceTransactionTest : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<Models::CustomerBalanceTransaction>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        Models::CustomerBalanceTransaction copied = new(model);
...
{
    [Theory]
    [InlineData(Models::Action.AppliedToInvoice)]
    [InlineData(Models::Action.ManualAdjustment)]
    [InlineData(Models::Action.ProratedRefund)]
    [InlineData(Models::Action.RevertProratedRefund)]
    [InlineData(Models::Action.ReturnFromVoiding)]
    [InlineData(Models::Action.CreditNoteApplied)]
    [InlineData(Models::Action.CreditNoteVoided)]
    [InlineData(Models::Action.OverpaymentRefund)]
    [InlineData(Models::Action.ExternalPayment)]
    [InlineData(Models::Action.SmallInvoiceCarryover)]
    public void Validation_Works(Models::Action rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Models::Action> value = rawValue;
        value.Validate();
    }
    ...
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, Models::Action>>(
    ...
    [InlineData(Models::Action.ExternalPayment)]
    [InlineData(Models::Action.SmallInvoiceCarryover)]
    public void SerializationRoundtrip_Works(Models::Action rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Models::Action> value = rawValue;

        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ApiEnum<string, Models::Action>>(
            json,
            ModelBase.SerializerOptions
        );
...
{
    [Theory]
    [InlineData(Models::Type.Increment)]
    [InlineData(Models::Type.Decrement)]
    public void Validation_Works(Models::Type rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Models::Type> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, Models::Type>>(
            JsonSerializer.SerializeToElement("invalid value"),
            ModelBase.SerializerOptions
        );
    ...
    [InlineData(Models::Type.Increment)]
    [InlineData(Models::Type.Decrement)]
    public void SerializationRoundtrip_Works(Models::Type rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Models::Type> value = rawValue;

        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ApiEnum<string, Models::Type>>(
            json,
            ModelBase.SerializerOptions
        );
...
{
    [Theory]
    [InlineData(Models::InvoiceSource.Subscription)]
    [InlineData(Models::InvoiceSource.Partial)]
    [InlineData(Models::InvoiceSource.OneOff)]
    public void Validation_Works(Models::InvoiceSource rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Models::InvoiceSource> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, Models::InvoiceSource>>(
            JsonSerializer.SerializeToElement("invalid value"),
            ModelBase.SerializerOptions
        );
    ...
    [InlineData(Models::InvoiceSource.Partial)]
    [InlineData(Models::InvoiceSource.OneOff)]
    public void SerializationRoundtrip_Works(Models::InvoiceSource rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Models::InvoiceSource> value = rawValue;

        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ApiEnum<string, Models::InvoiceSource>>(
            json,
            ModelBase.SerializerOptions
        );
...
public class LineItemTest : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<Models::LineItem>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        Models::LineItem copied = new(model);
...
public class LineItemAdjustmentTest : TestBase
{
    ...
    {
        Models::LineItemAdjustment value = new Models::LineItemAdjustmentTieredPercentageDiscount()
        {
            ID = "id",
            Amount = "amount",
            AppliesToPriceIds = ["string"],
            ...
            [
                new()
                {
                    Field = Models::LineItemAdjustmentTieredPercentageDiscountFilterField.PriceID,
                    Operator =
                        Models::LineItemAdjustmentTieredPercentageDiscountFilterOperator.Includes,
                    Values = ["string"],
                },
            ],
            IsInvoiceLevel = true,
    ...
    public void MonetaryUsageDiscountSerializationRoundtripWorks()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<Models::LineItemAdjustment>(
            element,
            ModelBase.SerializerOptions
        );
...
public class LineItemAdjustmentTieredPercentageDiscountTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new Models::LineItemAdjustmentTieredPercentageDiscount
        {
            ID = "id",
            Amount = "amount",
            AppliesToPriceIds = ["string"],
        ...
        List<Models::LineItemAdjustmentTieredPercentageDiscountFilter> expectedFilters =
        [
            new()
            {
                Field = Models::LineItemAdjustmentTieredPercentageDiscountFilterField.PriceID,
        ...
        List<Models::LineItemAdjustmentTieredPercentageDiscountTier> expectedTiers =
        [
            new()
            {
                LowerBound = 0,
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized =
            JsonSerializer.Deserialize<Models::LineItemAdjustmentTieredPercentageDiscount>(
                json,
                ModelBase.SerializerOptions
            );
    ...
    public void CopyConstructor_Works()
    {
        ...
        Models::LineItemAdjustmentTieredPercentageDiscount copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class LineItemAdjustmentTieredPercentageDiscountFilterTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new Models::LineItemAdjustmentTieredPercentageDiscountFilter
        {
            Field = Models::LineItemAdjustmentTieredPercentageDiscountFilterField.PriceID,
            Operator = Models::LineItemAdjustmentTieredPercentageDiscountFilterOperator.Includes,
            Values = ["string"],
        };

        ApiEnum<
            string,
            Models::LineItemAdjustmentTieredPercentageDiscountFilterField
        > expectedField = Models::LineItemAdjustmentTieredPercentageDiscountFilterField.PriceID;
        ApiEnum<
            string,
            Models::LineItemAdjustmentTieredPercentageDiscountFilterOperator
        > expectedOperator =
            Models::LineItemAdjustmentTieredPercentageDiscountFilterOperator.Includes;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized =
            JsonSerializer.Deserialize<Models::LineItemAdjustmentTieredPercentageDiscountFilter>(
                json,
                ModelBase.SerializerOptions
            );
    ...
    public void CopyConstructor_Works()
    {
        ...
        Models::LineItemAdjustmentTieredPercentageDiscountFilter copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class LineItemAdjustmentTieredPercentageDiscountFilterFieldTest : TestBase
{
    [Theory]
    [InlineData(Models::LineItemAdjustmentTieredPercentageDiscountFilterField.PriceID)]
    [InlineData(Models::LineItemAdjustmentTieredPercentageDiscountFilterField.ItemID)]
    [InlineData(Models::LineItemAdjustmentTieredPercentageDiscountFilterField.PriceType)]
    [InlineData(Models::LineItemAdjustmentTieredPercentageDiscountFilterField.Currency)]
    [InlineData(Models::LineItemAdjustmentTieredPercentageDiscountFilterField.PricingUnitID)]
    public void Validation_Works(
        Models::LineItemAdjustmentTieredPercentageDiscountFilterField rawValue
    )
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Models::LineItemAdjustmentTieredPercentageDiscountFilterField> value =
            rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<
            ApiEnum<string, Models::LineItemAdjustmentTieredPercentageDiscountFilterField>
...
public class LineItemAdjustmentTieredPercentageDiscountFilterOperatorTest : TestBase
{
    [Theory]
    [InlineData(Models::LineItemAdjustmentTieredPercentageDiscountFilterOperator.Includes)]
    [InlineData(Models::LineItemAdjustmentTieredPercentageDiscountFilterOperator.Excludes)]
    public void Validation_Works(
        Models::LineItemAdjustmentTieredPercentageDiscountFilterOperator rawValue
    )
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Models::LineItemAdjustmentTieredPercentageDiscountFilterOperator> value =
            rawValue;
        value.Validate();
    }
    ...
    {
        var value = JsonSerializer.Deserialize<
            ApiEnum<string, Models::LineItemAdjustmentTieredPercentageDiscountFilterOperator>
        >(JsonSerializer.SerializeToElement("invalid value"), ModelBase.SerializerOptions);
...
public class LineItemAdjustmentTieredPercentageDiscountTierTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new Models::LineItemAdjustmentTieredPercentageDiscountTier
        {
            LowerBound = 0,
            Percentage = 0,
            UpperBound = 0,
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized =
            JsonSerializer.Deserialize<Models::LineItemAdjustmentTieredPercentageDiscountTier>(
                json,
                ModelBase.SerializerOptions
            );
    ...
    public void CopyConstructor_Works()
    {
        ...
        Models::LineItemAdjustmentTieredPercentageDiscountTier copied = new(model);
...
public class SubLineItemTest : TestBase
{
    ...
    public void MatrixSerializationRoundtripWorks()
    {
        ...
        string element = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<Models::SubLineItem>(
            element,
            ModelBase.SerializerOptions
        );
...
public class PaymentAttemptTest : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<Models::PaymentAttempt>(
            json,
            ModelBase.SerializerOptions
        );
...
public class PaymentProviderTest : TestBase
{
    ...
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Models::PaymentProvider> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, Models::PaymentProvider>>(
            JsonSerializer.SerializeToElement("invalid value"),
            ModelBase.SerializerOptions
        );
    ...
    public void SerializationRoundtrip_Works(Models::PaymentProvider rawValue)
    {
        ...
        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ApiEnum<string, Models::PaymentProvider>>(
            json,
            ModelBase.SerializerOptions
        );
...
{
    [Theory]
    [InlineData(Models::Status.Issued)]
    [InlineData(Models::Status.Paid)]
    [InlineData(Models::Status.Synced)]
    [InlineData(Models::Status.Void)]
    [InlineData(Models::Status.Draft)]
    public void Validation_Works(Models::Status rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Models::Status> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, Models::Status>>(
            JsonSerializer.SerializeToElement("invalid value"),
            ModelBase.SerializerOptions
        );
    ...
    [InlineData(Models::Status.Void)]
    [InlineData(Models::Status.Draft)]
    public void SerializationRoundtrip_Works(Models::Status rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Models::Status> value = rawValue;

        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ApiEnum<string, Models::Status>>(
            json,
            ModelBase.SerializerOptions
        );
