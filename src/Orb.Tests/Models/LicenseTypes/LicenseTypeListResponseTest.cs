...
public class LicenseTypeListResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new LicenseTypeListResponse
        {
            ID = "id",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<LicenseTypeListResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        LicenseTypeListResponse copied = new(model);
