...
public class NewPlanTieredPackagePriceTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        ...
        {
            Cadence = NewPlanTieredPackagePriceCadence.Annual,
            ItemID = "item_id",
            ModelType = NewPlanTieredPackagePriceModelType.TieredPackage,
            Name = "Annual fee",
        ...
        ApiEnum<string, NewPlanTieredPackagePriceCadence> expectedCadence =
            NewPlanTieredPackagePriceCadence.Annual;
        string expectedItemID = "item_id";
        ApiEnum<string, NewPlanTieredPackagePriceModelType> expectedModelType =
            NewPlanTieredPackagePriceModelType.TieredPackage;
        string expectedName = "Annual fee";
        NewPlanTieredPackagePriceTieredPackageConfig expectedTieredPackageConfig = new()
        {
            PackageSize = "package_size",
            Tiers =
            [
        ...
        NewPlanTieredPackagePriceConversionRateConfig expectedConversionRateConfig =
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<NewPlanTieredPackagePrice>(json);
    ...
    public void FieldRoundtripThroughSerialization_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<NewPlanTieredPackagePrice>(element);
...
public class NewPlanTieredPackagePriceCadenceTest : TestBase
{
    [Theory]
    [InlineData(NewPlanTieredPackagePriceCadence.Annual)]
    [InlineData(NewPlanTieredPackagePriceCadence.SemiAnnual)]
    [InlineData(NewPlanTieredPackagePriceCadence.Monthly)]
    [InlineData(NewPlanTieredPackagePriceCadence.Quarterly)]
    [InlineData(NewPlanTieredPackagePriceCadence.OneTime)]
    [InlineData(NewPlanTieredPackagePriceCadence.Custom)]
    public void Validation_Works(NewPlanTieredPackagePriceCadence rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, NewPlanTieredPackagePriceCadence> value = rawValue;
        value.Validate();
    }
    ...
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, NewPlanTieredPackagePriceCadence>>(
    ...
    [InlineData(NewPlanTieredPackagePriceCadence.OneTime)]
    [InlineData(NewPlanTieredPackagePriceCadence.Custom)]
    public void SerializationRoundtrip_Works(NewPlanTieredPackagePriceCadence rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, NewPlanTieredPackagePriceCadence> value = rawValue;
        ...
        var deserialized = JsonSerializer.Deserialize<
            ApiEnum<string, NewPlanTieredPackagePriceCadence>
...
public class NewPlanTieredPackagePriceModelTypeTest : TestBase
{
    [Theory]
    [InlineData(NewPlanTieredPackagePriceModelType.TieredPackage)]
    public void Validation_Works(NewPlanTieredPackagePriceModelType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, NewPlanTieredPackagePriceModelType> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, NewPlanTieredPackagePriceModelType>>(
            JsonSerializer.SerializeToElement("invalid value"),
            ModelBase.SerializerOptions
        );
    ...
    [Theory]
    [InlineData(NewPlanTieredPackagePriceModelType.TieredPackage)]
    public void SerializationRoundtrip_Works(NewPlanTieredPackagePriceModelType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, NewPlanTieredPackagePriceModelType> value = rawValue;
        ...
        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<
            ApiEnum<string, NewPlanTieredPackagePriceModelType>
        >(json, ModelBase.SerializerOptions);
...
public class NewPlanTieredPackagePriceTieredPackageConfigTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model);
        var deserialized = JsonSerializer.Deserialize<NewPlanTieredPackagePriceTieredPackageConfig>(
            json
        );
...
public class NewPlanTieredPackagePriceTieredPackageConfigTierTest : TestBase
{
    ...
    public void FieldRoundtripThroughSerialization_Works()
    {
        ...
        string element = JsonSerializer.Serialize(model);
        var deserialized =
            JsonSerializer.Deserialize<NewPlanTieredPackagePriceTieredPackageConfigTier>(element);
        Assert.NotNull(deserialized);
...
public class NewPlanTieredPackagePriceConversionRateConfigTest : TestBase
{
    [Fact]
    public void UnitValidationWorks()
    {
        NewPlanTieredPackagePriceConversionRateConfig value = new SharedUnitConversionRateConfig()
        {
            ConversionRateType = SharedUnitConversionRateConfigConversionRateType.Unit,
            UnitConfig = new("unit_amount"),
        };
    ...
    {
        NewPlanTieredPackagePriceConversionRateConfig value = new SharedTieredConversionRateConfig()
        {
    ...
    public void UnitSerializationRoundtripWorks()
    {
        ...
        var deserialized =
            JsonSerializer.Deserialize<NewPlanTieredPackagePriceConversionRateConfig>(element);
