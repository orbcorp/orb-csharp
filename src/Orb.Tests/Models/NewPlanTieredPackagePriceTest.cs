...
public class NewPlanTieredPackagePriceTieredPackageConfigTest : TestBase
{
    ...
    public void CopyConstructor_Works()
    {
        ...
        NewPlanTieredPackagePriceTieredPackageConfig copied = new(model);
...
public class NewPlanTieredPackagePriceTieredPackageConfigTierTest : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized =
            JsonSerializer.Deserialize<NewPlanTieredPackagePriceTieredPackageConfigTier>(
                json,
                ModelBase.SerializerOptions
            );
    ...
    public void CopyConstructor_Works()
    {
        ...
        NewPlanTieredPackagePriceTieredPackageConfigTier copied = new(model);
...
public class NewPlanTieredPackagePriceConversionRateConfigTest : TestBase
{
    ...
    public void UnitSerializationRoundtripWorks()
    {
        ...
        var deserialized =
            JsonSerializer.Deserialize<NewPlanTieredPackagePriceConversionRateConfig>(
                element,
                ModelBase.SerializerOptions
            );
