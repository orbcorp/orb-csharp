...
public class InvoiceIssueSummaryParamsTest : TestBase
{
    [Fact]
    ...
    {
        var parameters = new InvoiceIssueSummaryParams { InvoiceID = "invoice_id" };
    ...
    {
        InvoiceIssueSummaryParams parameters = new() { InvoiceID = "invoice_id" };
    ...
    public void CopyConstructor_Works()
    {
        ...
        InvoiceIssueSummaryParams copied = new(parameters);
