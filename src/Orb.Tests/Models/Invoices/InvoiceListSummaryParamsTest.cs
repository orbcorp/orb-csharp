...
public class InvoiceListSummaryParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        ...
        ApiEnum<string, InvoiceListSummaryParamsDateType> expectedDateType =
            InvoiceListSummaryParamsDateType.DueDate;
    ...
    {
        var parameters = new InvoiceListSummaryParams { Limit = 1 };
    ...
    {
        InvoiceListSummaryParams parameters = new()
        {
            Amount = "amount",
            AmountGt = "amount[gt]",
            AmountLt = "amount[lt]",
        ...
        Assert.Equal(
            new Uri(
                "https://api.withorb.com/v1/invoices/summary?amount=amount&amount%5bgt%5d=amount%5bgt%5d&amount%5blt%5d=amount%5blt%5d&cursor=cursor&customer_id=customer_id&date_type=due_date&due_date=2019-12-27&due_date_window=due_date_window&due_date%5bgt%5d=2019-12-27&due_date%5blt%5d=2019-12-27&external_customer_id=external_customer_id&invoice_date%5bgt%5d=2019-12-27T18%3a11%3a19.117Z&invoice_date%5bgte%5d=2019-12-27T18%3a11%3a19.117Z&invoice_date%5blt%5d=2019-12-27T18%3a11%3a19.117Z&invoice_date%5blte%5d=2019-12-27T18%3a11%3a19.117Z&is_recurring=true&limit=1&status=draft&subscription_id=subscription_id"
            ),
            url
        );
    }
...
public class InvoiceListSummaryParamsDateTypeTest : TestBase
{
    [Theory]
    [InlineData(InvoiceListSummaryParamsDateType.DueDate)]
    [InlineData(InvoiceListSummaryParamsDateType.InvoiceDate)]
    public void Validation_Works(InvoiceListSummaryParamsDateType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, InvoiceListSummaryParamsDateType> value = rawValue;
        value.Validate();
    }
    ...
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, InvoiceListSummaryParamsDateType>>(
    ...
    [InlineData(InvoiceListSummaryParamsDateType.DueDate)]
    [InlineData(InvoiceListSummaryParamsDateType.InvoiceDate)]
    public void SerializationRoundtrip_Works(InvoiceListSummaryParamsDateType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, InvoiceListSummaryParamsDateType> value = rawValue;
...
public class InvoiceListSummaryParamsStatusTest : TestBase
{
    [Theory]
    [InlineData(InvoiceListSummaryParamsStatus.Draft)]
    [InlineData(InvoiceListSummaryParamsStatus.Issued)]
    [InlineData(InvoiceListSummaryParamsStatus.Paid)]
    [InlineData(InvoiceListSummaryParamsStatus.Synced)]
    [InlineData(InvoiceListSummaryParamsStatus.Void)]
    public void Validation_Works(InvoiceListSummaryParamsStatus rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, InvoiceListSummaryParamsStatus> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, InvoiceListSummaryParamsStatus>>(
            JsonSerializer.SerializeToElement("invalid value"),
            ModelBase.SerializerOptions
        );
    ...
    [InlineData(InvoiceListSummaryParamsStatus.Synced)]
    [InlineData(InvoiceListSummaryParamsStatus.Void)]
    public void SerializationRoundtrip_Works(InvoiceListSummaryParamsStatus rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, InvoiceListSummaryParamsStatus> value = rawValue;
