...
public class NewPlanUnitWithProrationPriceTest : TestBase
{
    ...
    public void CopyConstructor_Works()
    {
        ...
        NewPlanUnitWithProrationPrice copied = new(model);
...
public class NewPlanUnitWithProrationPriceUnitWithProrationConfigTest : TestBase
{
    ...
    public void CopyConstructor_Works()
    {
        ...
        NewPlanUnitWithProrationPriceUnitWithProrationConfig copied = new(model);
...
public class NewPlanUnitWithProrationPriceConversionRateConfigTest : TestBase
{
    ...
    public void UnitSerializationRoundtripWorks()
    {
        ...
        var deserialized =
            JsonSerializer.Deserialize<NewPlanUnitWithProrationPriceConversionRateConfig>(
                element,
                ModelBase.SerializerOptions
            );
