...
public class NewPlanMinimumCompositePriceTest : TestBase
{
    ...
    public void CopyConstructor_Works()
    {
        ...
        NewPlanMinimumCompositePrice copied = new(model);
...
public class NewPlanMinimumCompositePriceMinimumCompositeConfigTest : TestBase
{
    ...
    public void CopyConstructor_Works()
    {
        ...
        NewPlanMinimumCompositePriceMinimumCompositeConfig copied = new(model);
...
public class NewPlanMinimumCompositePriceConversionRateConfigTest : TestBase
{
    ...
    public void UnitSerializationRoundtripWorks()
    {
        ...
        var deserialized =
            JsonSerializer.Deserialize<NewPlanMinimumCompositePriceConversionRateConfig>(
                element,
                ModelBase.SerializerOptions
            );
