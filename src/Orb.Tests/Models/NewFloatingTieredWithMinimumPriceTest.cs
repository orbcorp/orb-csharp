...
public class NewFloatingTieredWithMinimumPriceTest : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<NewFloatingTieredWithMinimumPrice>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        NewFloatingTieredWithMinimumPrice copied = new(model);
...
public class TieredWithMinimumConfigTest : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<TieredWithMinimumConfig>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        TieredWithMinimumConfig copied = new(model);
...
public class TieredWithMinimumConfigTierTest : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<TieredWithMinimumConfigTier>(
            json,
            ModelBase.SerializerOptions
        );
