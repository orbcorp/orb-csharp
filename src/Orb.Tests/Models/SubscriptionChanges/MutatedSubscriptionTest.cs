...
public class MutatedSubscriptionTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        ...
        List<Models::AdjustmentInterval> expectedAdjustmentIntervals =
        [
            new()
            {
                ID = "id",
        ...
        List<Models::FixedFeeQuantityScheduleEntry> expectedFixedFeeQuantitySchedule =
        [
            new()
            {
                EndDate = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z"),
        ...
        List<Models::MaximumInterval> expectedMaximumIntervals =
        [
            new()
            {
                AppliesToPriceIntervalIds = ["string"],
        ...
        List<Models::MinimumInterval> expectedMinimumIntervals =
        [
            new()
            {
                AppliesToPriceIntervalIds = ["string"],
        ...
        Models::ChangedSubscriptionResources expectedChangedResources = new()
        {
            CreatedCreditNotes =
            [
                new()
        ...
        Assert.Equal(expectedChangedResources, model.ChangedResources);
    }
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<MutatedSubscription>(
            json,
    ...
    public void FieldRoundtripThroughSerialization_Works()
    {
        ...
        Assert.Equal(expectedChangedResources, deserialized.ChangedResources);
    }
    ...
    public void OptionalNullablePropertiesUnsetAreNotSet_Works()
    {
        ...
        Assert.Null(model.ChangedResources);
        Assert.False(model.RawData.ContainsKey("changed_resources"));
    }
    ...
    public void OptionalNullablePropertiesSetToNullAreSetToNull_Works()
    {
        ...
        Assert.Null(model.ChangedResources);
        Assert.True(model.RawData.ContainsKey("changed_resources"));
    }
