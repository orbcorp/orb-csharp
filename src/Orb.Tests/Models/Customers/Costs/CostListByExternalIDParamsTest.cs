...
public class CostListByExternalIDParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        ...
        ApiEnum<string, CostListByExternalIDParamsViewMode> expectedViewMode =
            CostListByExternalIDParamsViewMode.Periodic;
    ...
    {
        CostListByExternalIDParams parameters = new()
        {
            ExternalCustomerID = "external_customer_id",
            Currency = "currency",
        ...
        Assert.True(
            TestBase.UrisEqual(
                new Uri(
                    "https://api.withorb.com/v1/customers/external_customer_id/external_customer_id/costs?currency=currency&timeframe_end=2022-03-01T05%3a00%3a00.000%2b00%3a00&timeframe_start=2022-02-01T05%3a00%3a00.000%2b00%3a00&view_mode=periodic"
                ),
                url
            )
        );
