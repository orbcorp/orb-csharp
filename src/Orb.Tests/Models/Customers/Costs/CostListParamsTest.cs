...
public class CostListParamsTest : TestBase
{
    ...
    public void Url_Works()
    {
        ...
        Assert.True(
            TestBase.UrisEqual(
                new Uri(
                    "https://api.withorb.com/v1/customers/customer_id/costs?currency=currency&timeframe_end=2022-03-01T05%3a00%3a00.000%2b00%3a00&timeframe_start=2022-02-01T05%3a00%3a00.000%2b00%3a00&view_mode=periodic"
                ),
                url
            )
        );
