...
public class LedgerListByExternalIDResponseTest : TestBase
{
    [Fact]
    public void IncrementLedgerEntryValidationWorks()
    {
        LedgerListByExternalIDResponse value = new IncrementLedgerEntry()
        {
            ID = "id",
            Amount = 0,
    ...
    {
        LedgerListByExternalIDResponse value = new DecrementLedgerEntry()
        {
            ID = "id",
            Amount = 0,
            CreatedAt = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z"),
    ...
    {
        LedgerListByExternalIDResponse value = new ExpirationChangeLedgerEntry()
        {
            ID = "id",
            Amount = 0,
            CreatedAt = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z"),
    ...
    {
        LedgerListByExternalIDResponse value = new CreditBlockExpiryLedgerEntry()
        {
            ID = "id",
            Amount = 0,
            CreatedAt = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z"),
    ...
    {
        LedgerListByExternalIDResponse value = new VoidLedgerEntry()
        {
            ID = "id",
            Amount = 0,
            CreatedAt = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z"),
    ...
    {
        LedgerListByExternalIDResponse value = new VoidInitiatedLedgerEntry()
        {
            ID = "id",
            Amount = 0,
            CreatedAt = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z"),
    ...
    {
        LedgerListByExternalIDResponse value = new AmendmentLedgerEntry()
        {
            ID = "id",
            Amount = 0,
            CreatedAt = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z"),
