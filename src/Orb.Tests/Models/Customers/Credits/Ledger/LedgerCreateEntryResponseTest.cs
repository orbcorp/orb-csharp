...
public class LedgerCreateEntryResponseTest : TestBase
{
    [Fact]
    public void IncrementLedgerEntryValidationWorks()
    {
        LedgerCreateEntryResponse value = new IncrementLedgerEntry()
        {
            ID = "id",
            Amount = 0,
    ...
    {
        LedgerCreateEntryResponse value = new DecrementLedgerEntry()
        {
            ID = "id",
            Amount = 0,
            CreatedAt = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z"),
    ...
    {
        LedgerCreateEntryResponse value = new ExpirationChangeLedgerEntry()
        {
            ID = "id",
            Amount = 0,
            CreatedAt = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z"),
    ...
    {
        LedgerCreateEntryResponse value = new CreditBlockExpiryLedgerEntry()
        {
            ID = "id",
            Amount = 0,
            CreatedAt = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z"),
    ...
    {
        LedgerCreateEntryResponse value = new VoidLedgerEntry()
        {
            ID = "id",
            Amount = 0,
            CreatedAt = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z"),
    ...
    {
        LedgerCreateEntryResponse value = new VoidInitiatedLedgerEntry()
        {
            ID = "id",
            Amount = 0,
            CreatedAt = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z"),
    ...
    {
        LedgerCreateEntryResponse value = new AmendmentLedgerEntry()
        {
            ID = "id",
            Amount = 0,
            CreatedAt = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z"),
    ...
    public void IncrementLedgerEntrySerializationRoundtripWorks()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<LedgerCreateEntryResponse>(element);
