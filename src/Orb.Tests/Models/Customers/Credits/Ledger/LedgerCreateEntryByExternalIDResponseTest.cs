...
public class LedgerCreateEntryByExternalIDResponseTest : TestBase
{
    ...
    {
        LedgerCreateEntryByExternalIDResponse value = new IncrementLedgerEntry()
        {
            ID = "id",
            Amount = 0,
    ...
    {
        LedgerCreateEntryByExternalIDResponse value = new DecrementLedgerEntry()
        {
            ID = "id",
            Amount = 0,
            CreatedAt = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z"),
    ...
    {
        LedgerCreateEntryByExternalIDResponse value = new ExpirationChangeLedgerEntry()
        {
            ID = "id",
            Amount = 0,
            CreatedAt = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z"),
    ...
    {
        LedgerCreateEntryByExternalIDResponse value = new CreditBlockExpiryLedgerEntry()
        {
            ID = "id",
            Amount = 0,
            CreatedAt = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z"),
    ...
    {
        LedgerCreateEntryByExternalIDResponse value = new VoidLedgerEntry()
        {
            ID = "id",
            Amount = 0,
            CreatedAt = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z"),
    ...
    {
        LedgerCreateEntryByExternalIDResponse value = new VoidInitiatedLedgerEntry()
        {
            ID = "id",
            Amount = 0,
            CreatedAt = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z"),
    ...
    {
        LedgerCreateEntryByExternalIDResponse value = new AmendmentLedgerEntry()
        {
            ID = "id",
            Amount = 0,
            CreatedAt = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z"),
