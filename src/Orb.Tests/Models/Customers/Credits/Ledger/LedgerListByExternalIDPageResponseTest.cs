...
public class LedgerListByExternalIDPageResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        ...
        List<LedgerListByExternalIDResponse> expectedData =
        [
            new IncrementLedgerEntry()
            {
                ID = "id",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<LedgerListByExternalIDPageResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        LedgerListByExternalIDPageResponse copied = new(model);
