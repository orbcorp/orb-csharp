...
public class LedgerListPageResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new LedgerListPageResponse
        {
            Data =
            [
        ...
        List<LedgerListResponse> expectedData =
        [
            new IncrementLedgerEntry()
            {
                ID = "id",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<LedgerListPageResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        LedgerListPageResponse copied = new(model);
