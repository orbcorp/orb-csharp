...
public class LedgerListResponseTest : TestBase
{
    [Fact]
    public void IncrementLedgerEntryValidationWorks()
    {
        LedgerListResponse value = new IncrementLedgerEntry()
        {
            ID = "id",
            Amount = 0,
    ...
    {
        LedgerListResponse value = new DecrementLedgerEntry()
        {
            ID = "id",
            Amount = 0,
            CreatedAt = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z"),
    ...
    {
        LedgerListResponse value = new ExpirationChangeLedgerEntry()
        {
            ID = "id",
            Amount = 0,
            CreatedAt = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z"),
    ...
    {
        LedgerListResponse value = new CreditBlockExpiryLedgerEntry()
        {
            ID = "id",
            Amount = 0,
            CreatedAt = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z"),
    ...
    {
        LedgerListResponse value = new VoidLedgerEntry()
        {
            ID = "id",
            Amount = 0,
            CreatedAt = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z"),
    ...
    {
        LedgerListResponse value = new VoidInitiatedLedgerEntry()
        {
            ID = "id",
            Amount = 0,
            CreatedAt = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z"),
    ...
    {
        LedgerListResponse value = new AmendmentLedgerEntry()
        {
            ID = "id",
            Amount = 0,
            CreatedAt = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z"),
    ...
    public void IncrementLedgerEntrySerializationRoundtripWorks()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<LedgerListResponse>(element);
