...
public class TopUpListByExternalIDResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new TopUpListByExternalIDResponse
        {
            ID = "id",
            Amount = "amount",
            Currency = "currency",
        ...
        ApiEnum<string, TopUpListByExternalIDResponseExpiresAfterUnit> expectedExpiresAfterUnit =
            TopUpListByExternalIDResponseExpiresAfterUnit.Day;
    ...
    public void CopyConstructor_Works()
    {
        ...
        TopUpListByExternalIDResponse copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class TopUpListByExternalIDResponseExpiresAfterUnitTest : TestBase
{
    [Theory]
    [InlineData(TopUpListByExternalIDResponseExpiresAfterUnit.Day)]
    [InlineData(TopUpListByExternalIDResponseExpiresAfterUnit.Month)]
    public void Validation_Works(TopUpListByExternalIDResponseExpiresAfterUnit rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, TopUpListByExternalIDResponseExpiresAfterUnit> value = rawValue;
        value.Validate();
    }
    ...
    [InlineData(TopUpListByExternalIDResponseExpiresAfterUnit.Day)]
    [InlineData(TopUpListByExternalIDResponseExpiresAfterUnit.Month)]
    public void SerializationRoundtrip_Works(TopUpListByExternalIDResponseExpiresAfterUnit rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, TopUpListByExternalIDResponseExpiresAfterUnit> value = rawValue;
