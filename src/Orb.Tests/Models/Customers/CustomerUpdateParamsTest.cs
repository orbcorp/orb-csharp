...
public class CustomerUpdateParamsTest : TestBase
{
    ...
    public void Url_Works()
    {
        ...
        Assert.True(
            TestBase.UrisEqual(new Uri("https://api.withorb.com/v1/customers/customer_id"), url)
        );
    }
...
public class CustomerUpdateParamsPaymentProviderTest : TestBase
{
    ...
    [InlineData(CustomerUpdateParamsPaymentProvider.NetsuiteAmpersand)]
...
public class CustomerUpdateParamsTaxConfigurationTest : TestBase
{
    ...
    {
        CustomerUpdateParamsTaxConfiguration value = new NewAvalaraTaxConfiguration()
        {
            TaxExempt = true,
            TaxProvider = TaxProvider.Avalara,
            AutomaticTaxEnabled = true,
    ...
    {
        CustomerUpdateParamsTaxConfiguration value = new NewTaxJarConfiguration()
        {
            TaxExempt = true,
    ...
    {
        CustomerUpdateParamsTaxConfiguration value = new NewSphereConfiguration()
        {
            TaxExempt = true,
    ...
    {
        CustomerUpdateParamsTaxConfiguration value = new CustomerUpdateParamsTaxConfigurationAnrok()
        {
            TaxExempt = true,
            AutomaticTaxEnabled = true,
        };
